    ...
    public partial class Main : Form
    {
        ...
        private void countryToolStripMenuItem_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                var mdiChild = new CrudeLocationCountrySearch();
                CheckForm(mdiChild);
                mdiChild.MdiParent = this;
                mdiChild.Show(Singleton.Instance.UserId);
            } catch ( Exception ex ) {
        ...
        private void cityToolStripMenuItem_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                var mdiChild = new CrudeLocationCitySearch ();
                CheckForm(mdiChild);
                mdiChild.MdiParent = this;
        ...
        private void orderToolStripMenuItem_Click ( Object sender , EventArgs e ) {
            ...
            try {
                ...
                CheckForm ( mdiChild );
                mdiChild.MdiParent = this;
                mdiChild.Show ( string.Empty , Singleton.Instance.UserId , Guid.Empty, Guid.Empty );
            } catch ( Exception ex ) {
                Error ( ex );
            }
            Cursor.Current = Cursors.Default;
        ...
        private void addressToolStripMenuItem_Click ( Object sender , EventArgs e ) {
            ...
            try {
                ...
                var mdiChild = new CrudeLocationAddressSearch ();
                CheckForm ( mdiChild );
                mdiChild.MdiParent = this;
                mdiChild.Show ( String.Empty , Guid.Empty, Singleton.Instance.UserId );
            } catch ( Exception ex ) {

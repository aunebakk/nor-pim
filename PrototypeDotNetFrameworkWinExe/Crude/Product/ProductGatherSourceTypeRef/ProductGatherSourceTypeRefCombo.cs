/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 3/12/2020 12:41:03 PM
    ...
    public partial class ProductGatherSourceTypeRefCombo : UserControl {
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeProductGatherSourceTypeRefServiceClient productGatherSourceTypeRef = null;

                try {
                    productGatherSourceTypeRef = new CrudeProductGatherSourceTypeRefServiceClient();
                    List<CrudeProductGatherSourceTypeRefContract> contracts = productGatherSourceTypeRef.FetchAll();

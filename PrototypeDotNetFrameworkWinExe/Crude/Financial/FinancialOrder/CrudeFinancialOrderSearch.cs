...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeFinancialOrderSearch : Form {
        ...
        private string _financialOrderSourceRcd;
        ...
        public void Show(string financialOrderSourceRcd, System.Guid userId, System.Guid financialCurrencyId, System.Guid clientId) {
            try {
                _financialOrderSourceRcd = financialOrderSourceRcd;
                _userId = userId;
        ...
        public void RefreshCrudeFinancialOrder() {
            ...
            try {
                ...
                bindingSource.DataSource = financialOrder.FetchWithFilter(
                            ...
                            ,Guid.Empty
                            ,Guid.Empty
                            ,financialOrderSourceRefCombo.Text
                            ,Guid.Empty
                            );

/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 10/16/2020 6:03:17 PM
...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class ProductSearchByCategoryType4Data {
        ...
        public void Populate(IDataReader reader, ProductSearchByCategoryType4DataOrdinals ordinals) {
            if (!reader.IsDBNull(ordinals.Hn)) {
                Hn = reader.GetString(ordinals.Hn);
            }
            ...
            if (!reader.IsDBNull(ordinals.Gtin13)) {
                Gtin13 = reader.GetString(ordinals.Gtin13);
            }

            if (!reader.IsDBNull(ordinals.SupplierName)) {
                SupplierName = reader.GetString(ordinals.SupplierName);
            }

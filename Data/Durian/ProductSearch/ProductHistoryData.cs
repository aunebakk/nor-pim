/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 10/16/2020 6:02:30 PM
...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class ProductHistoryData {
        ...
        public void Populate(IDataReader reader, ProductHistoryDataOrdinals ordinals) {
            ...
            if (!reader.IsDBNull(ordinals.StateName)) {
                StateName = reader.GetString(ordinals.StateName);
            }
            ...
            if (!reader.IsDBNull(ordinals.UserName)) {
                UserName = reader.GetString(ordinals.UserName);
            }

            if (!reader.IsDBNull(ordinals.ProductBecameId)) {
                ProductBecameId = reader.GetGuid(ordinals.ProductBecameId);
            }
        }
    }

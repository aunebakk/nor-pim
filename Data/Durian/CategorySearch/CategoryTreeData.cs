/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 10/16/2020 6:02:19 PM
...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CategoryTreeData {
        ...
        public void Populate(IDataReader reader, CategoryTreeDataOrdinals ordinals) {
            if (!reader.IsDBNull(ordinals.ProductCategoryId)) {
                ProductCategoryId = reader.GetGuid(ordinals.ProductCategoryId);
            }

            if (!reader.IsDBNull(ordinals.ProductCategoryParentId)) {
                ProductCategoryParentId = reader.GetGuid(ordinals.ProductCategoryParentId);
            }

            if (!reader.IsDBNull(ordinals.ProductCategoryCode)) {
                ProductCategoryCode = reader.GetString(ordinals.ProductCategoryCode);
            }

            if (!reader.IsDBNull(ordinals.ProductCategoryName)) {

...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class ProductMaintenanceImageIndexWithFilterData {
        ...
        public void Populate(IDataReader reader, ProductMaintenanceImageIndexWithFilterDataOrdinals ordinals) {
            ...
            if (!reader.IsDBNull(ordinals.ImageFileName)) {
                ImageFileName = reader.GetString(ordinals.ImageFileName);
            }
            ...
            if (!reader.IsDBNull(ordinals.ProductImageId)) {
                ProductImageId = reader.GetGuid(ordinals.ProductImageId);
            }
        }
    }

...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class ProductMaintenanceInfoIndexWithFilterData {
        ...
        public void Populate(IDataReader reader, ProductMaintenanceInfoIndexWithFilterDataOrdinals ordinals) {
            ...
            if (!reader.IsDBNull(ordinals.ProductInfoName)) {
                ProductInfoName = reader.GetString(ordinals.ProductInfoName);
            }
            ...
            if (!reader.IsDBNull(ordinals.ProductInfoRcd)) {
                ProductInfoRcd = reader.GetString(ordinals.ProductInfoRcd);
            }
            ...
            if (!reader.IsDBNull(ordinals.ProductInfoId)) {
                ProductInfoId = reader.GetGuid(ordinals.ProductInfoId);
            }
        }
    }

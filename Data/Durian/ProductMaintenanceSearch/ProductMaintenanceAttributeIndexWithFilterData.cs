...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class ProductMaintenanceAttributeIndexWithFilterData {
        ...
        public void Populate(IDataReader reader, ProductMaintenanceAttributeIndexWithFilterDataOrdinals ordinals) {
            ...
            if (!reader.IsDBNull(ordinals.ProductAttributeUnitName)) {
                ProductAttributeUnitName = reader.GetString(ordinals.ProductAttributeUnitName);
            }
            ...
            if (!reader.IsDBNull(ordinals.ProductAttributeUnitRcd)) {
            ...
            if (!reader.IsDBNull(ordinals.ProductAttributeId)) {
                ProductAttributeId = reader.GetGuid(ordinals.ProductAttributeId);
            }
        }
    }

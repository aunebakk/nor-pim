...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class ProductMaintenanceDocumentationIndexWithFilterData {
        ...
        public void Populate(IDataReader reader, ProductMaintenanceDocumentationIndexWithFilterDataOrdinals ordinals) {
            ...
            if (!reader.IsDBNull(ordinals.ProductDocumentationTypeName)) {
                ProductDocumentationTypeName = reader.GetString(ordinals.ProductDocumentationTypeName);
            }
            ...
            if (!reader.IsDBNull(ordinals.ProductDocumentationTypeRcd)) {
                ProductDocumentationTypeRcd = reader.GetString(ordinals.ProductDocumentationTypeRcd);
            }

            if (!reader.IsDBNull(ordinals.Documentation)) {
                Documentation = reader.GetString(ordinals.Documentation);
            }
            ...
            if (!reader.IsDBNull(ordinals.ProductDocumentationId)) {
                ProductDocumentationId = reader.GetGuid(ordinals.ProductDocumentationId);
            }
        }
    }

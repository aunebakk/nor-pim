/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 10/16/2020 6:00:26 PM
...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class GetFinancialOrderData {
        ...
        public void Populate(IDataReader reader, GetFinancialOrderDataOrdinals ordinals) {
            ...
            if (!reader.IsDBNull(ordinals.FinancialOrderComment)) {
                FinancialOrderComment = reader.GetString(ordinals.FinancialOrderComment);
            }
            ...
            if (!reader.IsDBNull(ordinals.FinancialOrderId)) {
                FinancialOrderId = reader.GetGuid(ordinals.FinancialOrderId);
            }
        }
    }

...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class DefaultPerformanceIndicatorsData {
        ...
        public void Populate(IDataReader reader, DefaultPerformanceIndicatorsDataOrdinals ordinals) {
            ...
            if (!reader.IsDBNull(ordinals.HitCount)) {
                HitCount = reader.GetInt64(ordinals.HitCount);
            }

            if (!reader.IsDBNull(ordinals.AverageMilliseconds)) {
                AverageMilliseconds = reader.GetInt32(ordinals.AverageMilliseconds);
            }
        }
    }

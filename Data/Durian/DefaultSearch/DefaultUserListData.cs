/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 10/16/2020 6:01:53 PM
...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class DefaultUserListData {
        ...
        public void Populate(IDataReader reader, DefaultUserListDataOrdinals ordinals) {
            if (!reader.IsDBNull(ordinals.LastActivityDateTime)) {
                LastActivityDateTime = reader.GetDateTime(ordinals.LastActivityDateTime);
            }
            ...
            if (!reader.IsDBNull(ordinals.CreatedDateTime)) {
                CreatedDateTime = reader.GetDateTime(ordinals.CreatedDateTime);
            }

            if (!reader.IsDBNull(ordinals.Email)) {
                Email = reader.GetString(ordinals.Email);
            }

            if (!reader.IsDBNull(ordinals.DefaultStateName)) {
                DefaultStateName = reader.GetString(ordinals.DefaultStateName);
            }

            if (!reader.IsDBNull(ordinals.ActivityCount)) {
                ActivityCount = reader.GetInt32(ordinals.ActivityCount);
            }

            if (!reader.IsDBNull(ordinals.CreatedByDefaultUserCode)) {
                CreatedByDefaultUserCode = reader.GetString(ordinals.CreatedByDefaultUserCode);
            }

            if (!reader.IsDBNull(ordinals.CreatedByDefaultUserName)) {

/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 10/16/2020 6:01:34 PM
...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class DefaultUserActivityRecentData {
        ...
        public void Populate(IDataReader reader, DefaultUserActivityRecentDataOrdinals ordinals) {
            ...
            if (!reader.IsDBNull(ordinals.UserActivityTypeName)) {
                UserActivityTypeName = reader.GetString(ordinals.UserActivityTypeName);
            }

            if (!reader.IsDBNull(ordinals.OriginatingAddress)) {
                OriginatingAddress = reader.GetString(ordinals.OriginatingAddress);
            }

            if (!reader.IsDBNull(ordinals.Referrer)) {
                Referrer = reader.GetString(ordinals.Referrer);
            }

            if (!reader.IsDBNull(ordinals.UserActivityNote)) {
                UserActivityNote = reader.GetString(ordinals.UserActivityNote);
            }
        }
    }

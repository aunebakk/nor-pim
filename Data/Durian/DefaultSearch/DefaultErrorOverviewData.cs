/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 10/16/2020 6:00:57 PM
...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class DefaultErrorOverviewData {
        ...
        public void Populate(IDataReader reader, DefaultErrorOverviewDataOrdinals ordinals) {
            ...
            if (!reader.IsDBNull(ordinals.DefaultErrorLayerName)) {
                DefaultErrorLayerName = reader.GetString(ordinals.DefaultErrorLayerName);
            }

            if (!reader.IsDBNull(ordinals.DefaultErrorTypeName)) {
                DefaultErrorTypeName = reader.GetString(ordinals.DefaultErrorTypeName);
            }

            if (!reader.IsDBNull(ordinals.DomainName)) {
                DomainName = reader.GetString(ordinals.DomainName);
            }

            if (!reader.IsDBNull(ordinals.ClassName)) {
                ClassName = reader.GetString(ordinals.ClassName);
            }
            ...
            if (!reader.IsDBNull(ordinals.ErrorMessage)) {
                ErrorMessage = reader.GetString(ordinals.ErrorMessage);
            }
        }
    }

/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 10/16/2020 6:01:58 PM
    ...
    public partial class DefaultUserListForDashboardData {
        ...
        public void Populate(IDataReader reader, DefaultUserListForDashboardDataOrdinals ordinals) {
            ...
            if (!reader.IsDBNull(ordinals.LastActivityDateTime)) {
                LastActivityDateTime = reader.GetString(ordinals.LastActivityDateTime);
            }

            if (!reader.IsDBNull(ordinals.CreatedDateTime)) {
                CreatedDateTime = reader.GetString(ordinals.CreatedDateTime);
            }

/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 10/16/2020 6:01:15 PM
...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class DefaultStatisticsByMonthData {
        ...
        public void Populate(IDataReader reader, DefaultStatisticsByMonthDataOrdinals ordinals) {
            if (!reader.IsDBNull(ordinals.ActivityDate)) {
                ActivityDate = reader.GetString(ordinals.ActivityDate);
            }

            if (!reader.IsDBNull(ordinals.DayCount)) {
                DayCount = reader.GetInt32(ordinals.DayCount);
            }
        }
    }

...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeFinancialCurrencyData {
        ...
        public static CrudeFinancialCurrencyData GetByFinancialCurrencyId(System.Guid financialCurrencyId) {
            ...
            CrudeFinancialCurrencyData ret = new CrudeFinancialCurrencyData();
        ...
        public static List<CrudeFinancialCurrencyData> FetchByUserId(System.Guid userId) {
            List<CrudeFinancialCurrencyData> dataList = new List<CrudeFinancialCurrencyData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    while (reader.Read()) {
                        CrudeFinancialCurrencyData data = new CrudeFinancialCurrencyData();
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["financial_currency_type_rcd"] != System.DBNull.Value) {
                FinancialCurrencyTypeRcd = (string)reader["financial_currency_type_rcd"];
            }

            if (reader["financial_currency_against_financial_currency_type_rcd"] != System.DBNull.Value) {
                FinancialCurrencyAgainstFinancialCurrencyTypeRcd = (string)reader["financial_currency_against_financial_currency_type_rcd"];
            }
            ...
            if (reader["valid_from_date_time"] != System.DBNull.Value) {
                ValidFromDateTime = (System.DateTime)reader["valid_from_date_time"];
            }

            if (reader["valid_until_date_time"] != System.DBNull.Value) {
                ValidUntilDateTime = (System.DateTime)reader["valid_until_date_time"];
            }
            ...
            if (reader["equals_amount"] != System.DBNull.Value) {
                EqualsAmount = (decimal)reader["equals_amount"];
            }

            if (reader["decimal_count"] != System.DBNull.Value) {
                DecimalCount = (int)reader["decimal_count"];
            }

            if (reader["financial_currency_type_code"] != System.DBNull.Value) {
                FinancialCurrencyTypeCode = (string)reader["financial_currency_type_code"];
            }

            if (reader["financial_currency_type_name"] != System.DBNull.Value) {
                FinancialCurrencyTypeName = (string)reader["financial_currency_type_name"];
            }
        }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@financial_currency_against_financial_currency_type_rcd", SqlDbType.NVarChar).Value = FinancialCurrencyAgainstFinancialCurrencyTypeRcd;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    command.Parameters.Add("@valid_from_date_time", SqlDbType.DateTime).Value = ValidFromDateTime;
                    command.Parameters.Add("@valid_until_date_time", SqlDbType.DateTime).Value = (ValidUntilDateTime == DateTime.MinValue ? (object)DBNull.Value : ValidUntilDateTime);
                    command.Parameters.Add("@amount", SqlDbType.Decimal).Value = Amount;
                    command.Parameters.Add("@equals_amount", SqlDbType.Decimal).Value = EqualsAmount;
                    command.Parameters.Add("@decimal_count", SqlDbType.Int).Value = DecimalCount;
                    command.Parameters.Add("@financial_currency_type_code", SqlDbType.NVarChar).Value = FinancialCurrencyTypeCode;
                    command.Parameters.Add("@financial_currency_type_name", SqlDbType.NVarChar).Value = FinancialCurrencyTypeName;
                    // execute query against financial_currency

...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    // this class start with an identical representation of product_identifier's columns
    ...
    public partial class CrudeProductIdentifierData {
        ...
        public void FetchByProductIdentifierId(System.Guid productIdentifierId) {
            // create query against product_identifier
        ...
        public static CrudeProductIdentifierData GetByProductIdentifierId(System.Guid productIdentifierId) {
            ...
            CrudeProductIdentifierData ret = new CrudeProductIdentifierData();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against product_identifier
        ...
        public static List<CrudeProductIdentifierData> FetchByProductId(System.Guid productId) {
            List<CrudeProductIdentifierData> dataList = new List<CrudeProductIdentifierData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of product_identifier
                    // read all columns from the datareader and 
                    //   populate the List of C# objects with them
                    while (reader.Read()) {
                        CrudeProductIdentifierData data = new CrudeProductIdentifierData();
        ...
        public void Populate(IDataReader reader) {
            if (reader["product_identifier_id"] != System.DBNull.Value) {
                ProductIdentifierId = (System.Guid)reader["product_identifier_id"];
            }
            ...
            if (reader["identifier"] != System.DBNull.Value) {

...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    // this class start with an identical representation of product_attribute_unit_ref's columns
    ...
    public partial class CrudeProductAttributeUnitRefData {
        ...
        public static CrudeProductAttributeUnitRefData GetByProductAttributeUnitRcd(string productAttributeUnitRcd) {
            ...
            CrudeProductAttributeUnitRefData ret = new CrudeProductAttributeUnitRefData();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against product_attribute_unit_ref
        ...
        public static List<CrudeProductAttributeUnitRefData> FetchByUserId(System.Guid userId) {
            List<CrudeProductAttributeUnitRefData> dataList = new List<CrudeProductAttributeUnitRefData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of product_attribute_unit_ref
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["product_attribute_unit_name"] != System.DBNull.Value) {
                ProductAttributeUnitName = (string)reader["product_attribute_unit_name"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_attribute_unit_rcd", SqlDbType.NVarChar).Value = ProductAttributeUnitRcd;
                    command.Parameters.Add("@product_attribute_unit_name", SqlDbType.NVarChar).Value = ProductAttributeUnitName;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against product_attribute_unit_ref

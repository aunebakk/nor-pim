...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    // this class start with an identical representation of product_image_type_ref's columns
    ...
    public partial class CrudeProductImageTypeRefData {
        ...
        public void FetchByProductImageTypeRcd(string productImageTypeRcd) {
            // create query against product_image_type_ref
        ...
        public static CrudeProductImageTypeRefData GetByProductImageTypeRcd(string productImageTypeRcd) {
            ...
            CrudeProductImageTypeRefData ret = new CrudeProductImageTypeRefData();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against product_image_type_ref
        ...
        public static List<CrudeProductImageTypeRefData> FetchByUserId(System.Guid userId) {
            List<CrudeProductImageTypeRefData> dataList = new List<CrudeProductImageTypeRefData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of product_image_type_ref
                    // read all columns from the datareader and 
                    //   populate the List of C# objects with them
                    while (reader.Read()) {
                        CrudeProductImageTypeRefData data = new CrudeProductImageTypeRefData();
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["product_image_type_name"] != System.DBNull.Value) {
                ProductImageTypeName = (string)reader["product_image_type_name"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_image_type_rcd", SqlDbType.NVarChar).Value = ProductImageTypeRcd;
                    command.Parameters.Add("@product_image_type_name", SqlDbType.NVarChar).Value = ProductImageTypeName;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against product_image_type_ref

...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeProductCategoryData {
        ...
        public static CrudeProductCategoryData GetByProductCategoryId(System.Guid productCategoryId) {
            ...
            CrudeProductCategoryData ret = new CrudeProductCategoryData();
        ...
        public void Populate(IDataReader reader) {
            if (reader["product_category_id"] != System.DBNull.Value) {
                ProductCategoryId = (System.Guid)reader["product_category_id"];
            }

            if (reader["product_category_became_id"] != System.DBNull.Value) {
                ProductCategoryBecameId = (System.Guid)reader["product_category_became_id"];
            }

            if (reader["product_category_parent_id"] != System.DBNull.Value) {
                ProductCategoryParentId = (System.Guid)reader["product_category_parent_id"];
            }

            if (reader["product_category_code"] != System.DBNull.Value) {
                ProductCategoryCode = (string)reader["product_category_code"];
            }

            if (reader["product_category_name"] != System.DBNull.Value) {
                ProductCategoryName = (string)reader["product_category_name"];
            }

            if (reader["product_category_position"] != System.DBNull.Value) {
                ProductCategoryPosition = (int)reader["product_category_position"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_category_id", SqlDbType.UniqueIdentifier).Value = ProductCategoryId;
                    command.Parameters.Add("@product_category_became_id", SqlDbType.UniqueIdentifier).Value = (ProductCategoryBecameId == Guid.Empty ? (object)DBNull.Value : ProductCategoryBecameId);
                    command.Parameters.Add("@product_category_parent_id", SqlDbType.UniqueIdentifier).Value = ProductCategoryParentId;
                    command.Parameters.Add("@product_category_code", SqlDbType.NVarChar).Value = ProductCategoryCode;
                    command.Parameters.Add("@product_category_name", SqlDbType.NVarChar).Value = ProductCategoryName;
                    command.Parameters.Add("@product_category_position", SqlDbType.Int).Value = ProductCategoryPosition;

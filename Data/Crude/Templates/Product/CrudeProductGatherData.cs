...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    // this class start with an identical representation of product_gather's columns
    ...
    public partial class CrudeProductGatherData {
        ...
        public static CrudeProductGatherData GetByProductGatherId(System.Guid productGatherId) {
            ...
            CrudeProductGatherData ret = new CrudeProductGatherData();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against product_gather
        ...
        public static List<CrudeProductGatherData> FetchByUserId(System.Guid userId) {
            List<CrudeProductGatherData> dataList = new List<CrudeProductGatherData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of product_gather
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["finish_date_time"] != System.DBNull.Value) {
                FinishDateTime = (System.DateTime)reader["finish_date_time"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_gather_id", SqlDbType.UniqueIdentifier).Value = ProductGatherId;
                    command.Parameters.Add("@start_date_time", SqlDbType.DateTime).Value = StartDateTime;
                    command.Parameters.Add("@finish_date_time", SqlDbType.DateTime).Value = (FinishDateTime == DateTime.MinValue ? (object)DBNull.Value : FinishDateTime);
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against product_gather

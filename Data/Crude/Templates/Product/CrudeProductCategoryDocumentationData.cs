...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    // this class start with an identical representation of product_category_documentation's columns
    ...
    public partial class CrudeProductCategoryDocumentationData {
        ...
        public void FetchByProductCategoryDocumentationId(System.Guid productCategoryDocumentationId) {
            // create query against product_category_documentation
        ...
        public static CrudeProductCategoryDocumentationData GetByProductCategoryDocumentationId(System.Guid productCategoryDocumentationId) {
            ...
            CrudeProductCategoryDocumentationData ret = new CrudeProductCategoryDocumentationData();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against product_category_documentation
        ...
        public static List<CrudeProductCategoryDocumentationData> FetchByProductCategoryId(System.Guid productCategoryId) {
            List<CrudeProductCategoryDocumentationData> dataList = new List<CrudeProductCategoryDocumentationData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of product_category_documentation
                    // read all columns from the datareader and 
                    //   populate the List of C# objects with them
                    while (reader.Read()) {
                        CrudeProductCategoryDocumentationData data = new CrudeProductCategoryDocumentationData();
        ...
        public void Populate(IDataReader reader) {
            if (reader["product_category_documentation_id"] != System.DBNull.Value) {
                ProductCategoryDocumentationId = (System.Guid)reader["product_category_documentation_id"];
            }
            ...
            if (reader["documentation"] != System.DBNull.Value) {
                Documentation = (string)reader["documentation"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_category_id", SqlDbType.UniqueIdentifier).Value = ProductCategoryId;
                    command.Parameters.Add("@documentation", SqlDbType.NVarChar).Value = Documentation;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against product_category_documentation

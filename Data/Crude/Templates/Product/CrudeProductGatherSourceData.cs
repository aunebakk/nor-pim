...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    // this class start with an identical representation of product_gather_source's columns
    ...
    public partial class CrudeProductGatherSourceData {
        ...
        public void FetchByProductGatherSourceId(System.Guid productGatherSourceId) {
            // create query against product_gather_source
        ...
        public static CrudeProductGatherSourceData GetByProductGatherSourceId(System.Guid productGatherSourceId) {
            ...
            CrudeProductGatherSourceData ret = new CrudeProductGatherSourceData();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against product_gather_source
        ...
        public static List<CrudeProductGatherSourceData> FetchByProductGatherId(System.Guid productGatherId) {
            List<CrudeProductGatherSourceData> dataList = new List<CrudeProductGatherSourceData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of product_gather_source
                    // read all columns from the datareader and 
                    //   populate the List of C# objects with them
                    while (reader.Read()) {
                        CrudeProductGatherSourceData data = new CrudeProductGatherSourceData();
        ...
        public void Populate(IDataReader reader) {
            if (reader["product_gather_source_id"] != System.DBNull.Value) {
                ProductGatherSourceId = (System.Guid)reader["product_gather_source_id"];
            }

            if (reader["product_gather_id"] != System.DBNull.Value) {
                ProductGatherId = (System.Guid)reader["product_gather_id"];
            }

            if (reader["product_gather_source_type_rcd"] != System.DBNull.Value) {
                ProductGatherSourceTypeRcd = (string)reader["product_gather_source_type_rcd"];
            }

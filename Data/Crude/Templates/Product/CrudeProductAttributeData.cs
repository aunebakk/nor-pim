...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeProductAttributeData {
        ...
        public static CrudeProductAttributeData GetByProductAttributeId(System.Guid productAttributeId) {
            ...
            CrudeProductAttributeData ret = new CrudeProductAttributeData();
        ...
        public static List<CrudeProductAttributeData> FetchByProductId(System.Guid productId) {
            List<CrudeProductAttributeData> dataList = new List<CrudeProductAttributeData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    while (reader.Read()) {
                        CrudeProductAttributeData data = new CrudeProductAttributeData();
        ...
        public void Populate(IDataReader reader) {
            if (reader["product_attribute_id"] != System.DBNull.Value) {
                ProductAttributeId = (System.Guid)reader["product_attribute_id"];
            }
            ...
            if (reader["product_attribute_unit_rcd"] != System.DBNull.Value) {
                ProductAttributeUnitRcd = (string)reader["product_attribute_unit_rcd"];
            }

            if (reader["value"] != System.DBNull.Value) {
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_attribute_unit_rcd", SqlDbType.NVarChar).Value = (string.IsNullOrEmpty(ProductAttributeUnitRcd)) ? (object)DBNull.Value : ProductAttributeUnitRcd;

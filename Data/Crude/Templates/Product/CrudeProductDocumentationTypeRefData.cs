...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    // this class start with an identical representation of product_documentation_type_ref's columns
    ...
    public partial class CrudeProductDocumentationTypeRefData {
        ...
        public void FetchByProductDocumentationTypeRcd(string productDocumentationTypeRcd) {
            // create query against product_documentation_type_ref
        ...
        public static CrudeProductDocumentationTypeRefData GetByProductDocumentationTypeRcd(string productDocumentationTypeRcd) {
            ...
            CrudeProductDocumentationTypeRefData ret = new CrudeProductDocumentationTypeRefData();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against product_documentation_type_ref
        ...
        public static List<CrudeProductDocumentationTypeRefData> FetchByUserId(System.Guid userId) {
            List<CrudeProductDocumentationTypeRefData> dataList = new List<CrudeProductDocumentationTypeRefData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of product_documentation_type_ref
                    // read all columns from the datareader and 
                    //   populate the List of C# objects with them
                    while (reader.Read()) {
                        CrudeProductDocumentationTypeRefData data = new CrudeProductDocumentationTypeRefData();
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["product_documentation_type_name"] != System.DBNull.Value) {
                ProductDocumentationTypeName = (string)reader["product_documentation_type_name"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_documentation_type_rcd", SqlDbType.NVarChar).Value = ProductDocumentationTypeRcd;
                    command.Parameters.Add("@product_documentation_type_name", SqlDbType.NVarChar).Value = ProductDocumentationTypeName;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against product_documentation_type_ref

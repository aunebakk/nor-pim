...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeProductDocumentationData {
        ...
        public static CrudeProductDocumentationData GetByProductDocumentationId(System.Guid productDocumentationId) {
            ...
            CrudeProductDocumentationData ret = new CrudeProductDocumentationData();
        ...
        public static List<CrudeProductDocumentationData> FetchByProductId(System.Guid productId) {
            List<CrudeProductDocumentationData> dataList = new List<CrudeProductDocumentationData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    while (reader.Read()) {
                        CrudeProductDocumentationData data = new CrudeProductDocumentationData();
        ...
        public void Populate(IDataReader reader) {
            if (reader["product_documentation_id"] != System.DBNull.Value) {
                ProductDocumentationId = (System.Guid)reader["product_documentation_id"];
            }

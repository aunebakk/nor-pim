...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeProductGatherSourceTypeRefData {
        ...
        public static CrudeProductGatherSourceTypeRefData GetByProductGatherSourceTypeRcd(string productGatherSourceTypeRcd) {
            ...
            CrudeProductGatherSourceTypeRefData ret = new CrudeProductGatherSourceTypeRefData();
        ...
        public static List<CrudeProductGatherSourceTypeRefData> FetchByUserId(System.Guid userId) {
            List<CrudeProductGatherSourceTypeRefData> dataList = new List<CrudeProductGatherSourceTypeRefData>();
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["product_gather_source_type_name"] != System.DBNull.Value) {
                ProductGatherSourceTypeName = (string)reader["product_gather_source_type_name"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_gather_source_type_rcd", SqlDbType.NVarChar).Value = ProductGatherSourceTypeRcd;
                    command.Parameters.Add("@product_gather_source_type_name", SqlDbType.NVarChar).Value = ProductGatherSourceTypeName;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against product_gather_source_type_ref

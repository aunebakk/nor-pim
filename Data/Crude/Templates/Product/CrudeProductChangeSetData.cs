...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    // this class start with an identical representation of product_change_set's columns
    ...
    public partial class CrudeProductChangeSetData {
        ...
        public void FetchByProductChangeSetId(System.Guid productChangeSetId) {
            // create query against product_change_set
        ...
        public static CrudeProductChangeSetData GetByProductChangeSetId(System.Guid productChangeSetId) {
            ...
            CrudeProductChangeSetData ret = new CrudeProductChangeSetData();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against product_change_set
        ...
        public static List<CrudeProductChangeSetData> FetchByProductId(System.Guid productId) {
            List<CrudeProductChangeSetData> dataList = new List<CrudeProductChangeSetData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of product_change_set
                    // read all columns from the datareader and 
                    //   populate the List of C# objects with them
                    while (reader.Read()) {
                        CrudeProductChangeSetData data = new CrudeProductChangeSetData();
        ...
        public void Populate(IDataReader reader) {
            if (reader["product_change_set_id"] != System.DBNull.Value) {
                ProductChangeSetId = (System.Guid)reader["product_change_set_id"];
            }

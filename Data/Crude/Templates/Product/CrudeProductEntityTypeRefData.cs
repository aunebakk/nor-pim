...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeProductEntityTypeRefData {
        ...
        public static CrudeProductEntityTypeRefData GetByProductEntityTypeRcd(string productEntityTypeRcd) {
            ...
            CrudeProductEntityTypeRefData ret = new CrudeProductEntityTypeRefData();
        ...
        public static List<CrudeProductEntityTypeRefData> FetchByUserId(System.Guid userId) {
            List<CrudeProductEntityTypeRefData> dataList = new List<CrudeProductEntityTypeRefData>();
        ...
        public void Populate(IDataReader reader) {
            if (reader["product_entity_type_rcd"] != System.DBNull.Value) {
                ProductEntityTypeRcd = (string)reader["product_entity_type_rcd"];
            }

            if (reader["product_entity_type_name"] != System.DBNull.Value) {
                ProductEntityTypeName = (string)reader["product_entity_type_name"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_entity_type_rcd", SqlDbType.NVarChar).Value = ProductEntityTypeRcd;
                    command.Parameters.Add("@product_entity_type_name", SqlDbType.NVarChar).Value = ProductEntityTypeName;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against product_entity_type_ref

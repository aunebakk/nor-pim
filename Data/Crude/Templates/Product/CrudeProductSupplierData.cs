...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    // this class start with an identical representation of product_supplier's columns
    ...
    public partial class CrudeProductSupplierData {
        ...
        public void FetchByProductSupplierId(System.Guid productSupplierId) {
            // create query against product_supplier
        ...
        public static CrudeProductSupplierData GetByProductSupplierId(System.Guid productSupplierId) {
            ...
            CrudeProductSupplierData ret = new CrudeProductSupplierData();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against product_supplier
        ...
        public static List<CrudeProductSupplierData> FetchByProductId(System.Guid productId) {
            List<CrudeProductSupplierData> dataList = new List<CrudeProductSupplierData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of product_supplier
                    // read all columns from the datareader and 
                    //   populate the List of C# objects with them
                    while (reader.Read()) {
                        CrudeProductSupplierData data = new CrudeProductSupplierData();
        ...
        public void Populate(IDataReader reader) {
            if (reader["product_supplier_id"] != System.DBNull.Value) {
                ProductSupplierId = (System.Guid)reader["product_supplier_id"];
            }
            ...
            if (reader["supplier_name"] != System.DBNull.Value) {
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_supplier_id", SqlDbType.UniqueIdentifier).Value = ProductSupplierId;
                    command.Parameters.Add("@product_id", SqlDbType.UniqueIdentifier).Value = ProductId;
                    command.Parameters.Add("@supplier_name", SqlDbType.NVarChar).Value = SupplierName;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against product_supplier

...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    // this class start with an identical representation of product_info_ref's columns
    ...
    public partial class CrudeProductInfoRefData {
        ...
        public void FetchByProductInfoRcd(string productInfoRcd) {
            // create query against product_info_ref
        ...
        public static CrudeProductInfoRefData GetByProductInfoRcd(string productInfoRcd) {
            ...
            CrudeProductInfoRefData ret = new CrudeProductInfoRefData();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against product_info_ref
        ...
        public static List<CrudeProductInfoRefData> FetchByUserId(System.Guid userId) {
            List<CrudeProductInfoRefData> dataList = new List<CrudeProductInfoRefData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of product_info_ref
                    // read all columns from the datareader and 
                    //   populate the List of C# objects with them
                    while (reader.Read()) {
                        CrudeProductInfoRefData data = new CrudeProductInfoRefData();
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["product_info_name"] != System.DBNull.Value) {
                ProductInfoName = (string)reader["product_info_name"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_info_rcd", SqlDbType.NVarChar).Value = ProductInfoRcd;
                    command.Parameters.Add("@product_info_name", SqlDbType.NVarChar).Value = ProductInfoName;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against product_info_ref

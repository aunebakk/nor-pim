...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeProductCategoryImageData {
        ...
        public static CrudeProductCategoryImageData GetByProductCategoryImageId(System.Guid productCategoryImageId) {
            ...
            CrudeProductCategoryImageData ret = new CrudeProductCategoryImageData();
        ...
        public static List<CrudeProductCategoryImageData> FetchByProductCategoryId(System.Guid productCategoryId) {
            List<CrudeProductCategoryImageData> dataList = new List<CrudeProductCategoryImageData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    while (reader.Read()) {
                        CrudeProductCategoryImageData data = new CrudeProductCategoryImageData();
        ...
        public void Populate(IDataReader reader) {
            if (reader["product_category_image_id"] != System.DBNull.Value) {
                ProductCategoryImageId = (System.Guid)reader["product_category_image_id"];
            }

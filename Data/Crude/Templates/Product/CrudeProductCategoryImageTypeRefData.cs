...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeProductCategoryImageTypeRefData {
        ...
        public static CrudeProductCategoryImageTypeRefData GetByProductCategoryImageTypeRcd(string productCategoryImageTypeRcd) {
            ...
            CrudeProductCategoryImageTypeRefData ret = new CrudeProductCategoryImageTypeRefData();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against product_category_image_type_ref
        ...
        public static List<CrudeProductCategoryImageTypeRefData> FetchByUserId(System.Guid userId) {
            List<CrudeProductCategoryImageTypeRefData> dataList = new List<CrudeProductCategoryImageTypeRefData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of product_category_image_type_ref
                    // read all columns from the datareader and 
                    //   populate the List of C# objects with them
                    while (reader.Read()) {
                        CrudeProductCategoryImageTypeRefData data = new CrudeProductCategoryImageTypeRefData();
        ...
        public void Populate(IDataReader reader) {
            if (reader["product_category_image_type_rcd"] != System.DBNull.Value) {
                ProductCategoryImageTypeRcd = (string)reader["product_category_image_type_rcd"];
            }

            if (reader["product_category_image_type_name"] != System.DBNull.Value) {
                ProductCategoryImageTypeName = (string)reader["product_category_image_type_name"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_category_image_type_rcd", SqlDbType.NVarChar).Value = ProductCategoryImageTypeRcd;
                    command.Parameters.Add("@product_category_image_type_name", SqlDbType.NVarChar).Value = ProductCategoryImageTypeName;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against product_category_image_type_ref

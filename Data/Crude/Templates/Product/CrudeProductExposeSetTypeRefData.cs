...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeProductExposeSetTypeRefData {
        ...
        public static CrudeProductExposeSetTypeRefData GetByProductExposeSetTypeRcd(string productExposeSetTypeRcd) {
            ...
            CrudeProductExposeSetTypeRefData ret = new CrudeProductExposeSetTypeRefData();
        ...
        public static List<CrudeProductExposeSetTypeRefData> FetchByUserId(System.Guid userId) {
            List<CrudeProductExposeSetTypeRefData> dataList = new List<CrudeProductExposeSetTypeRefData>();
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["product_expose_set_type_name"] != System.DBNull.Value) {
                ProductExposeSetTypeName = (string)reader["product_expose_set_type_name"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_expose_set_type_rcd", SqlDbType.NVarChar).Value = ProductExposeSetTypeRcd;
                    command.Parameters.Add("@product_expose_set_type_name", SqlDbType.NVarChar).Value = ProductExposeSetTypeName;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against product_expose_set_type_ref

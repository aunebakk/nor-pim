...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    // this class start with an identical representation of product_expose_set's columns
    ...
    public partial class CrudeProductExposeSetData {
        ...
        public void FetchByProductExposeSetId(System.Guid productExposeSetId) {
            // create query against product_expose_set
        ...
        public static CrudeProductExposeSetData GetByProductExposeSetId(System.Guid productExposeSetId) {
            ...
            CrudeProductExposeSetData ret = new CrudeProductExposeSetData();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against product_expose_set
        ...
        public static List<CrudeProductExposeSetData> FetchByUserId(System.Guid userId) {
            List<CrudeProductExposeSetData> dataList = new List<CrudeProductExposeSetData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of product_expose_set
                    // read all columns from the datareader and 
                    //   populate the List of C# objects with them
                    while (reader.Read()) {
                        CrudeProductExposeSetData data = new CrudeProductExposeSetData();
        ...
        public void Populate(IDataReader reader) {
            if (reader["product_expose_set_id"] != System.DBNull.Value) {
                ProductExposeSetId = (System.Guid)reader["product_expose_set_id"];
            }

            if (reader["product_expose_set_type_rcd"] != System.DBNull.Value) {
                ProductExposeSetTypeRcd = (string)reader["product_expose_set_type_rcd"];
            }

            if (reader["product_expose_set_name"] != System.DBNull.Value) {
                ProductExposeSetName = (string)reader["product_expose_set_name"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_expose_set_name", SqlDbType.NVarChar).Value = ProductExposeSetName;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against product_expose_set

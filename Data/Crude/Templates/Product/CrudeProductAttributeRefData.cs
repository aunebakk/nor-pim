...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    // this class start with an identical representation of product_attribute_ref's columns
    ...
    public partial class CrudeProductAttributeRefData {
        ...
        public void FetchByProductAttributeRcd(string productAttributeRcd) {
            // create query against product_attribute_ref
        ...
        public static CrudeProductAttributeRefData GetByProductAttributeRcd(string productAttributeRcd) {
            ...
            CrudeProductAttributeRefData ret = new CrudeProductAttributeRefData();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against product_attribute_ref
        ...
        public static List<CrudeProductAttributeRefData> FetchByUserId(System.Guid userId) {
            List<CrudeProductAttributeRefData> dataList = new List<CrudeProductAttributeRefData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of product_attribute_ref
                    // read all columns from the datareader and 
                    //   populate the List of C# objects with them
                    while (reader.Read()) {
                        CrudeProductAttributeRefData data = new CrudeProductAttributeRefData();
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["product_attribute_name"] != System.DBNull.Value) {
                ProductAttributeName = (string)reader["product_attribute_name"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_attribute_rcd", SqlDbType.NVarChar).Value = ProductAttributeRcd;
                    command.Parameters.Add("@product_attribute_name", SqlDbType.NVarChar).Value = ProductAttributeName;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against product_attribute_ref

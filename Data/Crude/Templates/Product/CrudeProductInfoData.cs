...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    // this class start with an identical representation of product_info's columns
    ...
    public partial class CrudeProductInfoData {
        ...
        public void FetchByProductInfoId(System.Guid productInfoId) {
            // create query against product_info
        ...
        public static CrudeProductInfoData GetByProductInfoId(System.Guid productInfoId) {
            ...
            CrudeProductInfoData ret = new CrudeProductInfoData();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against product_info
        ...
        public static List<CrudeProductInfoData> FetchByProductId(System.Guid productId) {
            List<CrudeProductInfoData> dataList = new List<CrudeProductInfoData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of product_info
                    // read all columns from the datareader and 
                    //   populate the List of C# objects with them
                    while (reader.Read()) {
                        CrudeProductInfoData data = new CrudeProductInfoData();
        ...
        public void Populate(IDataReader reader) {
            if (reader["product_info_id"] != System.DBNull.Value) {
                ProductInfoId = (System.Guid)reader["product_info_id"];
            }
            ...
            if (reader["product_info_value"] != System.DBNull.Value) {
                ProductInfoValue = (string)reader["product_info_value"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_info_value", SqlDbType.NVarChar).Value = ProductInfoValue;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against product_info

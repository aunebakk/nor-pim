...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeClientLinkData {
        ...
        public static CrudeClientLinkData GetByClientLinkId(System.Guid clientLinkId) {
            ...
            CrudeClientLinkData ret = new CrudeClientLinkData();
        ...
        public static List<CrudeClientLinkData> FetchByClientId(System.Guid clientId) {
            List<CrudeClientLinkData> dataList = new List<CrudeClientLinkData>();
        ...
        public void Populate(IDataReader reader) {
            if (reader["client_link_id"] != System.DBNull.Value) {
                ClientLinkId = (System.Guid)reader["client_link_id"];
            }
            ...
            if (reader["link_name"] != System.DBNull.Value) {
                LinkName = (string)reader["link_name"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@link_name", SqlDbType.NVarChar).Value = (string.IsNullOrEmpty(LinkName)) ? (object)DBNull.Value : LinkName;
                    command.Parameters.Add("@link", SqlDbType.NVarChar).Value = Link;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against client_link

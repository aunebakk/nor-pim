...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeClientEventTypeRefData {
        ...
        public static CrudeClientEventTypeRefData GetByClientEventTypeRcd(string clientEventTypeRcd) {
            ...
            CrudeClientEventTypeRefData ret = new CrudeClientEventTypeRefData();
        ...
        public static List<CrudeClientEventTypeRefData> FetchByUserId(System.Guid userId) {
            List<CrudeClientEventTypeRefData> dataList = new List<CrudeClientEventTypeRefData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    while (reader.Read()) {
                        CrudeClientEventTypeRefData data = new CrudeClientEventTypeRefData();
        ...
        public void Populate(IDataReader reader) {
            if (reader["client_event_type_rcd"] != System.DBNull.Value) {
                ClientEventTypeRcd = (string)reader["client_event_type_rcd"];
            }

            if (reader["client_event_type_name"] != System.DBNull.Value) {
                ClientEventTypeName = (string)reader["client_event_type_name"];
            }

            if (reader["client_event_type_description"] != System.DBNull.Value) {
                ClientEventTypeDescription = (string)reader["client_event_type_description"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@client_event_type_rcd", SqlDbType.NVarChar).Value = ClientEventTypeRcd;
                    command.Parameters.Add("@client_event_type_name", SqlDbType.NVarChar).Value = ClientEventTypeName;
                    command.Parameters.Add("@client_event_type_description", SqlDbType.NVarChar).Value = (string.IsNullOrEmpty(ClientEventTypeDescription)) ? (object)DBNull.Value : ClientEventTypeDescription;
                    command.Parameters.Add("@active_flag", SqlDbType.Bit).Value = ActiveFlag;
                    command.Parameters.Add("@sort_order", SqlDbType.Int).Value = SortOrder;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;

...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    // this class start with an identical representation of client_document_type_ref's columns
    ...
    public partial class CrudeClientDocumentTypeRefData {
        ...
        public static CrudeClientDocumentTypeRefData GetByClientDocumentTypeRcd(string clientDocumentTypeRcd) {
            ...
            CrudeClientDocumentTypeRefData ret = new CrudeClientDocumentTypeRefData();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against client_document_type_ref
        ...
        public static List<CrudeClientDocumentTypeRefData> FetchByUserId(System.Guid userId) {
            List<CrudeClientDocumentTypeRefData> dataList = new List<CrudeClientDocumentTypeRefData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of client_document_type_ref
        ...
        public void Populate(IDataReader reader) {
            if (reader["client_document_type_rcd"] != System.DBNull.Value) {
                ClientDocumentTypeRcd = (string)reader["client_document_type_rcd"];
            }

            if (reader["client_document_type_name"] != System.DBNull.Value) {
                ClientDocumentTypeName = (string)reader["client_document_type_name"];
            }

            if (reader["client_document_type_description"] != System.DBNull.Value) {
                ClientDocumentTypeDescription = (string)reader["client_document_type_description"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@client_document_type_rcd", SqlDbType.NVarChar).Value = ClientDocumentTypeRcd;
                    command.Parameters.Add("@client_document_type_name", SqlDbType.NVarChar).Value = ClientDocumentTypeName;
                    command.Parameters.Add("@client_document_type_description", SqlDbType.NVarChar).Value = (string.IsNullOrEmpty(ClientDocumentTypeDescription)) ? (object)DBNull.Value : ClientDocumentTypeDescription;
                    command.Parameters.Add("@active_flag", SqlDbType.Bit).Value = ActiveFlag;
                    command.Parameters.Add("@sort_order", SqlDbType.Int).Value = SortOrder;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;

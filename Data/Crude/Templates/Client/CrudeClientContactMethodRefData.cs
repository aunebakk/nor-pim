...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    // this class start with an identical representation of client_contact_method_ref's columns
    ...
    public partial class CrudeClientContactMethodRefData {
        ...
        public static CrudeClientContactMethodRefData GetByClientContactMethodRcd(string clientContactMethodRcd) {
            ...
            CrudeClientContactMethodRefData ret = new CrudeClientContactMethodRefData();
        ...
        public static List<CrudeClientContactMethodRefData> FetchByUserId(System.Guid userId) {
            List<CrudeClientContactMethodRefData> dataList = new List<CrudeClientContactMethodRefData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    while (reader.Read()) {
                        CrudeClientContactMethodRefData data = new CrudeClientContactMethodRefData();
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["client_contact_method_name"] != System.DBNull.Value) {
                ClientContactMethodName = (string)reader["client_contact_method_name"];
            }

            if (reader["client_contact_method_description"] != System.DBNull.Value) {
                ClientContactMethodDescription = (string)reader["client_contact_method_description"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@client_contact_method_rcd", SqlDbType.NVarChar).Value = ClientContactMethodRcd;
                    command.Parameters.Add("@client_contact_method_name", SqlDbType.NVarChar).Value = ClientContactMethodName;
                    command.Parameters.Add("@client_contact_method_description", SqlDbType.NVarChar).Value = (string.IsNullOrEmpty(ClientContactMethodDescription)) ? (object)DBNull.Value : ClientContactMethodDescription;
                    command.Parameters.Add("@active_flag", SqlDbType.Bit).Value = ActiveFlag;
                    command.Parameters.Add("@sort_order", SqlDbType.Int).Value = SortOrder;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;

...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeClientTypeRefData {
        ...
        public static CrudeClientTypeRefData GetByClientTypeRcd(string clientTypeRcd) {
            ...
            CrudeClientTypeRefData ret = new CrudeClientTypeRefData();
        ...
        public static List<CrudeClientTypeRefData> FetchByUserId(System.Guid userId) {
            List<CrudeClientTypeRefData> dataList = new List<CrudeClientTypeRefData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    while (reader.Read()) {
                        CrudeClientTypeRefData data = new CrudeClientTypeRefData();
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["client_type_name"] != System.DBNull.Value) {
                ClientTypeName = (string)reader["client_type_name"];
            }

            if (reader["client_type_description"] != System.DBNull.Value) {
                ClientTypeDescription = (string)reader["client_type_description"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@client_type_rcd", SqlDbType.NVarChar).Value = ClientTypeRcd;
                    command.Parameters.Add("@client_type_name", SqlDbType.NVarChar).Value = ClientTypeName;
                    command.Parameters.Add("@client_type_description", SqlDbType.NVarChar).Value = (string.IsNullOrEmpty(ClientTypeDescription)) ? (object)DBNull.Value : ClientTypeDescription;
                    command.Parameters.Add("@active_flag", SqlDbType.Bit).Value = ActiveFlag;
                    command.Parameters.Add("@sort_order", SqlDbType.Int).Value = SortOrder;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;

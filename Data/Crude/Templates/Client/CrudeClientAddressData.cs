...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeClientAddressData {
        ...
        public static CrudeClientAddressData GetByClientAddressId(System.Guid clientAddressId) {
            ...
            CrudeClientAddressData ret = new CrudeClientAddressData();
        ...
        public static List<CrudeClientAddressData> FetchByClientId(System.Guid clientId) {
            List<CrudeClientAddressData> dataList = new List<CrudeClientAddressData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    while (reader.Read()) {
                        CrudeClientAddressData data = new CrudeClientAddressData();
        ...
        public void Populate(IDataReader reader) {
            if (reader["client_address_id"] != System.DBNull.Value) {
                ClientAddressId = (System.Guid)reader["client_address_id"];
            }
            ...
            if (reader["client_address_type_rcd"] != System.DBNull.Value) {
                ClientAddressTypeRcd = (string)reader["client_address_type_rcd"];
            }

            if (reader["address_line_one_name"] != System.DBNull.Value) {
                AddressLineOneName = (string)reader["address_line_one_name"];
            }

            if (reader["address_line_two_name"] != System.DBNull.Value) {
                AddressLineTwoName = (string)reader["address_line_two_name"];
            }

            if (reader["address_line_three_name"] != System.DBNull.Value) {
                AddressLineThreeName = (string)reader["address_line_three_name"];
            }

            if (reader["city_name"] != System.DBNull.Value) {
                CityName = (string)reader["city_name"];
            }

            if (reader["street_name"] != System.DBNull.Value) {
                StreetName = (string)reader["street_name"];
            }

            if (reader["state_name"] != System.DBNull.Value) {
                StateName = (string)reader["state_name"];
            }

            if (reader["district_name"] != System.DBNull.Value) {
                DistrictName = (string)reader["district_name"];
            }

            if (reader["province_name"] != System.DBNull.Value) {
                ProvinceName = (string)reader["province_name"];
            }

            if (reader["zip_code"] != System.DBNull.Value) {
                ZipCode = (string)reader["zip_code"];
            }

            if (reader["po_box"] != System.DBNull.Value) {
                PoBox = (string)reader["po_box"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@address_line_one_name", SqlDbType.NVarChar).Value = AddressLineOneName;
                    command.Parameters.Add("@address_line_two_name", SqlDbType.NVarChar).Value = AddressLineTwoName;
                    command.Parameters.Add("@address_line_three_name", SqlDbType.NVarChar).Value = AddressLineThreeName;
                    command.Parameters.Add("@city_name", SqlDbType.NVarChar).Value = CityName;
                    command.Parameters.Add("@street_name", SqlDbType.NVarChar).Value = StreetName;
                    command.Parameters.Add("@state_name", SqlDbType.NVarChar).Value = StateName;
                    command.Parameters.Add("@district_name", SqlDbType.NVarChar).Value = DistrictName;
                    command.Parameters.Add("@province_name", SqlDbType.NVarChar).Value = ProvinceName;
                    command.Parameters.Add("@zip_code", SqlDbType.NVarChar).Value = ZipCode;
                    command.Parameters.Add("@po_box", SqlDbType.NVarChar).Value = PoBox;

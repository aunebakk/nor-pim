...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeClientIdentifierTypeRefData {
        ...
        public static CrudeClientIdentifierTypeRefData GetByClientIdentifierTypeRcd(string clientIdentifierTypeRcd) {
            ...
            CrudeClientIdentifierTypeRefData ret = new CrudeClientIdentifierTypeRefData();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against client_identifier_type_ref
        ...
        public static List<CrudeClientIdentifierTypeRefData> FetchByUserId(System.Guid userId) {
            List<CrudeClientIdentifierTypeRefData> dataList = new List<CrudeClientIdentifierTypeRefData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of client_identifier_type_ref
                    // read all columns from the datareader and 
                    //   populate the List of C# objects with them
                    while (reader.Read()) {
                        CrudeClientIdentifierTypeRefData data = new CrudeClientIdentifierTypeRefData();
        ...
        public void Populate(IDataReader reader) {
            if (reader["client_identifier_type_rcd"] != System.DBNull.Value) {
                ClientIdentifierTypeRcd = (string)reader["client_identifier_type_rcd"];
            }

            if (reader["client_identifier_type_name"] != System.DBNull.Value) {
                ClientIdentifierTypeName = (string)reader["client_identifier_type_name"];
            }

            if (reader["client_identifier_type_description"] != System.DBNull.Value) {
                ClientIdentifierTypeDescription = (string)reader["client_identifier_type_description"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@client_identifier_type_rcd", SqlDbType.NVarChar).Value = ClientIdentifierTypeRcd;
                    command.Parameters.Add("@client_identifier_type_name", SqlDbType.NVarChar).Value = ClientIdentifierTypeName;
                    command.Parameters.Add("@client_identifier_type_description", SqlDbType.NVarChar).Value = (string.IsNullOrEmpty(ClientIdentifierTypeDescription)) ? (object)DBNull.Value : ClientIdentifierTypeDescription;
                    command.Parameters.Add("@active_flag", SqlDbType.Bit).Value = ActiveFlag;
                    command.Parameters.Add("@sort_order", SqlDbType.Int).Value = SortOrder;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;

...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeClientNationalityRefData {
        ...
        public static CrudeClientNationalityRefData GetByClientNationalityRcd(string clientNationalityRcd) {
            ...
            CrudeClientNationalityRefData ret = new CrudeClientNationalityRefData();
        ...
        public static List<CrudeClientNationalityRefData> FetchByUserId(System.Guid userId) {
            List<CrudeClientNationalityRefData> dataList = new List<CrudeClientNationalityRefData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    while (reader.Read()) {
                        CrudeClientNationalityRefData data = new CrudeClientNationalityRefData();
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["client_nationality_name"] != System.DBNull.Value) {
                ClientNationalityName = (string)reader["client_nationality_name"];
            }

            if (reader["client_nationality_description"] != System.DBNull.Value) {
                ClientNationalityDescription = (string)reader["client_nationality_description"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@client_nationality_rcd", SqlDbType.NVarChar).Value = ClientNationalityRcd;
                    command.Parameters.Add("@client_nationality_name", SqlDbType.NVarChar).Value = ClientNationalityName;
                    command.Parameters.Add("@client_nationality_description", SqlDbType.NVarChar).Value = (string.IsNullOrEmpty(ClientNationalityDescription)) ? (object)DBNull.Value : ClientNationalityDescription;
                    command.Parameters.Add("@active_flag", SqlDbType.Bit).Value = ActiveFlag;
                    command.Parameters.Add("@sort_order", SqlDbType.Int).Value = SortOrder;
                    command.Parameters.Add("@user_id", SqlDbType.UniqueIdentifier).Value = UserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;

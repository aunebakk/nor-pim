...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeDefaultStateRefData {
        ...
        public static CrudeDefaultStateRefData GetByDefaultStateRcd(string defaultStateRcd) {
            ...
            CrudeDefaultStateRefData ret = new CrudeDefaultStateRefData();
        ...
        public static List<CrudeDefaultStateRefData> FetchByDefaultUserId(System.Guid defaultUserId) {
            List<CrudeDefaultStateRefData> dataList = new List<CrudeDefaultStateRefData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    while (reader.Read()) {
                        CrudeDefaultStateRefData data = new CrudeDefaultStateRefData();
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["default_state_name"] != System.DBNull.Value) {
                DefaultStateName = (string)reader["default_state_name"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@default_state_rcd", SqlDbType.NVarChar).Value = DefaultStateRcd;
                    command.Parameters.Add("@default_state_name", SqlDbType.NVarChar).Value = DefaultStateName;

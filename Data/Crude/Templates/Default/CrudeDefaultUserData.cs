...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeDefaultUserData {
        ...
        public static CrudeDefaultUserData GetByDefaultUserId(System.Guid defaultUserId) {
            ...
            CrudeDefaultUserData ret = new CrudeDefaultUserData();
        ...
        public static List<CrudeDefaultUserData> FetchByCreatedByDefaultUserId(System.Guid createdByDefaultUserId) {
            List<CrudeDefaultUserData> dataList = new List<CrudeDefaultUserData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    while (reader.Read()) {
                        CrudeDefaultUserData data = new CrudeDefaultUserData();
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["default_user_code"] != System.DBNull.Value) {
                DefaultUserCode = (string)reader["default_user_code"];
            }

            if (reader["default_user_name"] != System.DBNull.Value) {
                DefaultUserName = (string)reader["default_user_name"];
            }
            ...
            if (reader["default_state_rcd"] != System.DBNull.Value) {
                DefaultStateRcd = (string)reader["default_state_rcd"];
            }

            if (reader["created_by_default_user_id"] != System.DBNull.Value) {
                CreatedByDefaultUserId = (System.Guid)reader["created_by_default_user_id"];
            }
            ...
            if (reader["last_activity_date_time"] != System.DBNull.Value) {
                LastActivityDateTime = (System.DateTime)reader["last_activity_date_time"];
            }
        }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@default_user_id", SqlDbType.UniqueIdentifier).Value = DefaultUserId;
                    command.Parameters.Add("@default_user_code", SqlDbType.NVarChar).Value = DefaultUserCode;
                    command.Parameters.Add("@default_user_name", SqlDbType.NVarChar).Value = DefaultUserName;
                    command.Parameters.Add("@email", SqlDbType.NVarChar).Value = (string.IsNullOrEmpty(Email)) ? (object)DBNull.Value : Email;
                    command.Parameters.Add("@password", SqlDbType.NVarChar).Value = (string.IsNullOrEmpty(Password)) ? (object)DBNull.Value : Password;
                    command.Parameters.Add("@default_state_rcd", SqlDbType.NVarChar).Value = DefaultStateRcd;
                    command.Parameters.Add("@created_by_default_user_id", SqlDbType.UniqueIdentifier).Value = (CreatedByDefaultUserId == Guid.Empty ? (object)DBNull.Value : CreatedByDefaultUserId);
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    command.Parameters.Add("@last_activity_date_time", SqlDbType.DateTime).Value = (LastActivityDateTime == DateTime.MinValue ? (object)DBNull.Value : LastActivityDateTime);
                    // execute query against default_user

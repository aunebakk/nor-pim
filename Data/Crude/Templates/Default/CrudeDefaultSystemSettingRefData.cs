...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeDefaultSystemSettingRefData {
        ...
        public static CrudeDefaultSystemSettingRefData GetByDefaultSystemSettingRcd(string defaultSystemSettingRcd) {
            ...
            CrudeDefaultSystemSettingRefData ret = new CrudeDefaultSystemSettingRefData();
        ...
        public static List<CrudeDefaultSystemSettingRefData> FetchByDefaultUserId(System.Guid defaultUserId) {
            List<CrudeDefaultSystemSettingRefData> dataList = new List<CrudeDefaultSystemSettingRefData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    while (reader.Read()) {
                        CrudeDefaultSystemSettingRefData data = new CrudeDefaultSystemSettingRefData();
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["default_system_setting_name"] != System.DBNull.Value) {
                DefaultSystemSettingName = (string)reader["default_system_setting_name"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@default_system_setting_rcd", SqlDbType.NVarChar).Value = DefaultSystemSettingRcd;
                    command.Parameters.Add("@default_system_setting_name", SqlDbType.NVarChar).Value = DefaultSystemSettingName;
                    command.Parameters.Add("@default_user_id", SqlDbType.UniqueIdentifier).Value = DefaultUserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against default_system_setting_ref

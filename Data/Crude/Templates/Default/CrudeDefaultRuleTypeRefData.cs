...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeDefaultRuleTypeRefData {
        ...
        public static CrudeDefaultRuleTypeRefData GetByDefaultRuleTypeRcd(string defaultRuleTypeRcd) {
            ...
            CrudeDefaultRuleTypeRefData ret = new CrudeDefaultRuleTypeRefData();
        ...
        public static List<CrudeDefaultRuleTypeRefData> FetchByDefaultUserId(System.Guid defaultUserId) {
            List<CrudeDefaultRuleTypeRefData> dataList = new List<CrudeDefaultRuleTypeRefData>();
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["default_rule_type_name"] != System.DBNull.Value) {
                DefaultRuleTypeName = (string)reader["default_rule_type_name"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@default_rule_type_rcd", SqlDbType.NVarChar).Value = DefaultRuleTypeRcd;
                    command.Parameters.Add("@default_rule_type_name", SqlDbType.NVarChar).Value = DefaultRuleTypeName;
                    command.Parameters.Add("@default_user_id", SqlDbType.UniqueIdentifier).Value = DefaultUserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against default_rule_type_ref

...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeDefaultIssueStatusRefData {
        ...
        public static CrudeDefaultIssueStatusRefData GetByDefaultIssueStatusRcd(string defaultIssueStatusRcd) {
            ...
            CrudeDefaultIssueStatusRefData ret = new CrudeDefaultIssueStatusRefData();
        ...
        public static List<CrudeDefaultIssueStatusRefData> FetchByDefaultUserId(System.Guid defaultUserId) {
            List<CrudeDefaultIssueStatusRefData> dataList = new List<CrudeDefaultIssueStatusRefData>();
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["default_issue_status_name"] != System.DBNull.Value) {
                DefaultIssueStatusName = (string)reader["default_issue_status_name"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@default_issue_status_rcd", SqlDbType.NVarChar).Value = DefaultIssueStatusRcd;
                    command.Parameters.Add("@default_issue_status_name", SqlDbType.NVarChar).Value = DefaultIssueStatusName;
                    command.Parameters.Add("@default_user_id", SqlDbType.UniqueIdentifier).Value = DefaultUserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against default_issue_status_ref

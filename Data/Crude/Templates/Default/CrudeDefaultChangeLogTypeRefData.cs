...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeDefaultChangeLogTypeRefData {
        ...
        public static CrudeDefaultChangeLogTypeRefData GetByDefaultChangeLogTypeRcd(string defaultChangeLogTypeRcd) {
            ...
            CrudeDefaultChangeLogTypeRefData ret = new CrudeDefaultChangeLogTypeRefData();
        ...
        public static List<CrudeDefaultChangeLogTypeRefData> FetchByDefaultUserId(System.Guid defaultUserId) {
            List<CrudeDefaultChangeLogTypeRefData> dataList = new List<CrudeDefaultChangeLogTypeRefData>();
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["default_change_log_type_name"] != System.DBNull.Value) {
                DefaultChangeLogTypeName = (string)reader["default_change_log_type_name"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@default_change_log_type_rcd", SqlDbType.NVarChar).Value = DefaultChangeLogTypeRcd;
                    command.Parameters.Add("@default_change_log_type_name", SqlDbType.NVarChar).Value = DefaultChangeLogTypeName;
                    command.Parameters.Add("@default_user_id", SqlDbType.UniqueIdentifier).Value = DefaultUserId;
                    command.Parameters.Add("@date_time", SqlDbType.DateTime).Value = DateTime;
                    // execute query against default_change_log_type_ref

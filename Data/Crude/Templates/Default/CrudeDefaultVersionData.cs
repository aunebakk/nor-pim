...
namespace SolutionNorSolutionPim.DataAccessLayer {
    ...
    public partial class CrudeDefaultVersionData {
        ...
        public static CrudeDefaultVersionData GetByDefaultVersionId(System.Guid defaultVersionId) {
            ...
            CrudeDefaultVersionData ret = new CrudeDefaultVersionData();
        ...
        public static List<CrudeDefaultVersionData> FetchByDefaultUserId(System.Guid defaultUserId) {
            List<CrudeDefaultVersionData> dataList = new List<CrudeDefaultVersionData>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, conn)) {
                    ...
                    while (reader.Read()) {
                        CrudeDefaultVersionData data = new CrudeDefaultVersionData();
        ...
        public void Populate(IDataReader reader) {
            if (reader["default_version_id"] != System.DBNull.Value) {
                DefaultVersionId = (System.Guid)reader["default_version_id"];
            }

            if (reader["fun_version"] != System.DBNull.Value) {
                FunVersion = (string)reader["fun_version"];
            }
            ...
            if (reader["major_number"] != System.DBNull.Value) {
                MajorNumber = (int)reader["major_number"];
            }

            if (reader["minor_number"] != System.DBNull.Value) {
                MinorNumber = (int)reader["minor_number"];
            }

            if (reader["sequence_number"] != System.DBNull.Value) {
                SequenceNumber = (int)reader["sequence_number"];
            }
        ...
        public void Insert() {
            ...
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (SqlCommand command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@default_version_id", SqlDbType.UniqueIdentifier).Value = DefaultVersionId;
                    command.Parameters.Add("@fun_version", SqlDbType.NVarChar).Value = FunVersion;

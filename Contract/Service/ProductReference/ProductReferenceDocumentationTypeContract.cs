/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/30/2020 12:16:23 PM
...
namespace SolutionNorSolutionPim.BusinessLogicLayer {
    ...
    public partial class ProductReferenceDocumentationTypeContract {
        ...
        // this class is a DataMember for WCF between business and client proxy for parent class ProductDocumentationTypeRef
        // data class is serializable in order to speed up processing between the data access and business layers
        // this class start with an identical representation of a ansi sql select statement in 's columns
        //  formatted to follow C# casing guidelines ( Pascal casing )
        // links:

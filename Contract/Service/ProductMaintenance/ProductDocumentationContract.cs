...
namespace SolutionNorSolutionPim.BusinessLogicLayer {
    ...
    // this class start with an identical representation of a ansi sql select statement in ProductDocumentation's columns
    ...
    public partial class ProductDocumentationContract {
        ...
        // this class is a DataMember for WCF between business and client proxy for parent class ProductDocumentation
        // data class is serializable in order to speed up processing between the data access and business layers
        // this class start with an identical representation of a ansi sql select statement in ProductDocumentation's columns
        //  formatted to follow C# casing guidelines ( Pascal casing )
        // links:

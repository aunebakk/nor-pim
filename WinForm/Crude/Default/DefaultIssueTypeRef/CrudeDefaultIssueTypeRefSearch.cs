...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeDefaultIssueTypeRefSearch : Form {
        ...
        public CrudeDefaultIssueTypeRefSearch() {
            ...
            AcceptButton = buttonCrudeDefaultIssueTypeRefSearch;
        ...
        private void buttonCrudeDefaultIssueTypeRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeDefaultIssueTypeRefEdit editForm = new CrudeDefaultIssueTypeRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeDefaultIssueTypeRef.CurrentRow.Cells["DefaultIssueTypeRcd"].Value, _defaultUserId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeDefaultIssueTypeRef() {
            CrudeDefaultIssueTypeRefServiceClient defaultIssueTypeRef = new CrudeDefaultIssueTypeRefServiceClient();

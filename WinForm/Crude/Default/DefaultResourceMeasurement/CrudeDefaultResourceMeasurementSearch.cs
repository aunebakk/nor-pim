...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeDefaultResourceMeasurementSearch : Form {
        ...
        public CrudeDefaultResourceMeasurementSearch() {
            ...
            AcceptButton = buttonCrudeDefaultResourceMeasurementSearch;
        ...
        private void buttonCrudeDefaultResourceMeasurementEdit_Click(object sender, EventArgs e) {
            try {
                CrudeDefaultResourceMeasurementEdit editForm = new CrudeDefaultResourceMeasurementEdit();
        ...
        public void RefreshCrudeDefaultResourceMeasurement() {
            CrudeDefaultResourceMeasurementServiceClient defaultResourceMeasurement = new CrudeDefaultResourceMeasurementServiceClient();

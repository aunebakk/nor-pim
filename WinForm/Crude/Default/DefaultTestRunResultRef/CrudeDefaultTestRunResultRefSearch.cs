...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeDefaultTestRunResultRefSearch : Form {
        ...
        public CrudeDefaultTestRunResultRefSearch() {
            ...
            AcceptButton = buttonCrudeDefaultTestRunResultRefSearch;
        ...
        private void buttonCrudeDefaultTestRunResultRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeDefaultTestRunResultRefEdit editForm = new CrudeDefaultTestRunResultRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeDefaultTestRunResultRef.CurrentRow.Cells["DefaultTestRunResultRcd"].Value);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeDefaultTestRunResultRef() {
            CrudeDefaultTestRunResultRefServiceClient defaultTestRunResultRef = new CrudeDefaultTestRunResultRefServiceClient();

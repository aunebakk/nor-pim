...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeDefaultSystemSettingSearch : Form {
        ...
        public CrudeDefaultSystemSettingSearch() {
            ...
            AcceptButton = buttonCrudeDefaultSystemSettingSearch;
        ...
        private void buttonCrudeDefaultSystemSettingEdit_Click(object sender, EventArgs e) {
            try {
                CrudeDefaultSystemSettingEdit editForm = new CrudeDefaultSystemSettingEdit();
        ...
        public void RefreshCrudeDefaultSystemSetting() {
            CrudeDefaultSystemSettingServiceClient defaultSystemSetting = new CrudeDefaultSystemSettingServiceClient();

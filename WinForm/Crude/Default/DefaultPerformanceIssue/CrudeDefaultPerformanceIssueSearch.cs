...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeDefaultPerformanceIssueSearch : Form {
        ...
        public CrudeDefaultPerformanceIssueSearch() {
            ...
            AcceptButton = buttonCrudeDefaultPerformanceIssueSearch;
        ...
        private void buttonCrudeDefaultPerformanceIssueEdit_Click(object sender, EventArgs e) {
            try {
                CrudeDefaultPerformanceIssueEdit editForm = new CrudeDefaultPerformanceIssueEdit();
        ...
        public void RefreshCrudeDefaultPerformanceIssue() {
            CrudeDefaultPerformanceIssueServiceClient defaultPerformanceIssue = new CrudeDefaultPerformanceIssueServiceClient();

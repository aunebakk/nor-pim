...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeDefaultPerformanceTimeSearch : Form {
        ...
        public CrudeDefaultPerformanceTimeSearch() {
            ...
            AcceptButton = buttonCrudeDefaultPerformanceTimeSearch;
        ...
        private void buttonCrudeDefaultPerformanceTimeEdit_Click(object sender, EventArgs e) {
            try {
                CrudeDefaultPerformanceTimeEdit editForm = new CrudeDefaultPerformanceTimeEdit();
        ...
        public void RefreshCrudeDefaultPerformanceTime() {
            CrudeDefaultPerformanceTimeServiceClient defaultPerformanceTime = new CrudeDefaultPerformanceTimeServiceClient();

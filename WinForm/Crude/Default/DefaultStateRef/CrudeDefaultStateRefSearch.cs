...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeDefaultStateRefSearch : Form {
        ...
        public CrudeDefaultStateRefSearch() {
            ...
            AcceptButton = buttonCrudeDefaultStateRefSearch;
        ...
        private void buttonCrudeDefaultStateRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeDefaultStateRefEdit editForm = new CrudeDefaultStateRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeDefaultStateRef.CurrentRow.Cells["DefaultStateRcd"].Value, _defaultUserId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeDefaultStateRef() {
            CrudeDefaultStateRefServiceClient defaultStateRef = new CrudeDefaultStateRefServiceClient();

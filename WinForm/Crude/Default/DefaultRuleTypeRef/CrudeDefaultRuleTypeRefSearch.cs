...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeDefaultRuleTypeRefSearch : Form {
        ...
        public CrudeDefaultRuleTypeRefSearch() {
            ...
            AcceptButton = buttonCrudeDefaultRuleTypeRefSearch;
        ...
        private void buttonCrudeDefaultRuleTypeRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeDefaultRuleTypeRefEdit editForm = new CrudeDefaultRuleTypeRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeDefaultRuleTypeRef.CurrentRow.Cells["DefaultRuleTypeRcd"].Value, _defaultUserId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeDefaultRuleTypeRef() {
            CrudeDefaultRuleTypeRefServiceClient defaultRuleTypeRef = new CrudeDefaultRuleTypeRefServiceClient();

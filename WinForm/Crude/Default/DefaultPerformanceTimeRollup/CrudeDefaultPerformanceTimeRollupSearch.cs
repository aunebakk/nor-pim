...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeDefaultPerformanceTimeRollupSearch : Form {
        ...
        public CrudeDefaultPerformanceTimeRollupSearch() {
            ...
            AcceptButton = buttonCrudeDefaultPerformanceTimeRollupSearch;
        ...
        private void buttonCrudeDefaultPerformanceTimeRollupEdit_Click(object sender, EventArgs e) {
            try {
                CrudeDefaultPerformanceTimeRollupEdit editForm = new CrudeDefaultPerformanceTimeRollupEdit();
        ...
        public void RefreshCrudeDefaultPerformanceTimeRollup() {
            CrudeDefaultPerformanceTimeRollupServiceClient defaultPerformanceTimeRollup = new CrudeDefaultPerformanceTimeRollupServiceClient();

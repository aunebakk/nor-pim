...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeDefaultSystemSettingRefSearch : Form {
        ...
        public CrudeDefaultSystemSettingRefSearch() {
            ...
            AcceptButton = buttonCrudeDefaultSystemSettingRefSearch;
        ...
        private void buttonCrudeDefaultSystemSettingRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeDefaultSystemSettingRefEdit editForm = new CrudeDefaultSystemSettingRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeDefaultSystemSettingRef.CurrentRow.Cells["DefaultSystemSettingRcd"].Value, _defaultUserId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeDefaultSystemSettingRef() {
            CrudeDefaultSystemSettingRefServiceClient defaultSystemSettingRef = new CrudeDefaultSystemSettingRefServiceClient();

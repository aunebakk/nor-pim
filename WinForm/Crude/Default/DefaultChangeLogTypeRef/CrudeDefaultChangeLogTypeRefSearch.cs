...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeDefaultChangeLogTypeRefSearch : Form {
        ...
        public CrudeDefaultChangeLogTypeRefSearch() {
            ...
            AcceptButton = buttonCrudeDefaultChangeLogTypeRefSearch;
        ...
        private void buttonCrudeDefaultChangeLogTypeRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeDefaultChangeLogTypeRefEdit editForm = new CrudeDefaultChangeLogTypeRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeDefaultChangeLogTypeRef.CurrentRow.Cells["DefaultChangeLogTypeRcd"].Value, _defaultUserId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeDefaultChangeLogTypeRef() {
            CrudeDefaultChangeLogTypeRefServiceClient defaultChangeLogTypeRef = new CrudeDefaultChangeLogTypeRefServiceClient();

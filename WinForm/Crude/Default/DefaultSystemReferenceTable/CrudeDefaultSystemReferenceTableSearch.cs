...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeDefaultSystemReferenceTableSearch : Form {
        ...
        public CrudeDefaultSystemReferenceTableSearch() {
            ...
            AcceptButton = buttonCrudeDefaultSystemReferenceTableSearch;
        ...
        private void buttonCrudeDefaultSystemReferenceTableEdit_Click(object sender, EventArgs e) {
            try {
                CrudeDefaultSystemReferenceTableEdit editForm = new CrudeDefaultSystemReferenceTableEdit();
        ...
        public void RefreshCrudeDefaultSystemReferenceTable() {
            CrudeDefaultSystemReferenceTableServiceClient defaultSystemReferenceTable = new CrudeDefaultSystemReferenceTableServiceClient();

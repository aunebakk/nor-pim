/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 10/30/2020 11:00:39 AM
...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductFieldSetEdit : Form {
        ...
        // shows the form with default values for comboboxes and pickers
        public void ShowAsAdd(string productFieldSetName, System.Guid userId) {
            try {
                _contract = new CrudeProductFieldSetContract();
                _isNew = true;
                _contract.ProductFieldSetName = productFieldSetName;
        ...
        public void ShowAsEdit(System.Guid productFieldSetId) {
            var service = new CrudeProductFieldSetServiceClient();
            _isNew = false;
            try {

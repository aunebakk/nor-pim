    ...
    public partial class CrudeProductCategoryMappingEdit : Form {
        ...
        public void ShowAsAdd() {
            try {
                ...
                _isNew = true;
                Text += " - Not Savable (ProductCategory,Product,User Missing)";
                Show();
            } catch (Exception ex) {
                if (ex == null) { } else {
        ...
        // shows the form with default values for comboboxes and pickers
        public void ShowAsAdd(System.Guid productCategoryId, System.Guid productId, System.Guid userId) {
            try {
                _contract = new CrudeProductCategoryMappingContract();
                _isNew = true;
                _contract.ProductCategoryId = productCategoryId;
        ...
        public void ShowAsEdit(System.Guid productCategoryMappingId) {
            CrudeProductCategoryMappingServiceClient service = new CrudeProductCategoryMappingServiceClient();
            _isNew = false;
            try {

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductCategoryMappingSearch : Form {
        ...
        public CrudeProductCategoryMappingSearch() {
            ...
            AcceptButton = buttonCrudeProductCategoryMappingSearch;
        ...
        private void buttonCrudeProductCategoryMappingEdit_Click(object sender, EventArgs e) {
            try {
                CrudeProductCategoryMappingEdit editForm = new CrudeProductCategoryMappingEdit();
        ...
        public void RefreshCrudeProductCategoryMapping() {
            CrudeProductCategoryMappingServiceClient productCategoryMapping = new CrudeProductCategoryMappingServiceClient();

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductGatherSourceSearch : Form {
        ...
        public CrudeProductGatherSourceSearch() {
            ...
            AcceptButton = buttonCrudeProductGatherSourceSearch;
        ...
        private void buttonCrudeProductGatherSourceEdit_Click(object sender, EventArgs e) {
            try {
                CrudeProductGatherSourceEdit editForm = new CrudeProductGatherSourceEdit();
        ...
        public void RefreshCrudeProductGatherSource() {
            CrudeProductGatherSourceServiceClient productGatherSource = new CrudeProductGatherSourceServiceClient();

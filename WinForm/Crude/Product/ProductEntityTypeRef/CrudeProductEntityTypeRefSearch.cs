...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductEntityTypeRefSearch : Form {
        ...
        public CrudeProductEntityTypeRefSearch() {
            ...
            AcceptButton = buttonCrudeProductEntityTypeRefSearch;
        ...
        private void buttonCrudeProductEntityTypeRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeProductEntityTypeRefEdit editForm = new CrudeProductEntityTypeRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeProductEntityTypeRef.CurrentRow.Cells["ProductEntityTypeRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeProductEntityTypeRef() {
            CrudeProductEntityTypeRefServiceClient productEntityTypeRef = new CrudeProductEntityTypeRefServiceClient();

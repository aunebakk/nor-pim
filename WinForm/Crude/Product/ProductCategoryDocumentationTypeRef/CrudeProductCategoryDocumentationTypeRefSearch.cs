...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductCategoryDocumentationTypeRefSearch : Form {
        ...
        public CrudeProductCategoryDocumentationTypeRefSearch() {
            ...
            AcceptButton = buttonCrudeProductCategoryDocumentationTypeRefSearch;
        ...
        private void buttonCrudeProductCategoryDocumentationTypeRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeProductCategoryDocumentationTypeRefEdit editForm = new CrudeProductCategoryDocumentationTypeRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeProductCategoryDocumentationTypeRef.CurrentRow.Cells["ProductCategoryDocumentationTypeRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeProductCategoryDocumentationTypeRef() {
            CrudeProductCategoryDocumentationTypeRefServiceClient productCategoryDocumentationTypeRef = new CrudeProductCategoryDocumentationTypeRefServiceClient();

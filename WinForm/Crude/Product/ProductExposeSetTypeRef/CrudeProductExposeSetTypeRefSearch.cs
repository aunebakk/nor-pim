...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductExposeSetTypeRefSearch : Form {
        ...
        public CrudeProductExposeSetTypeRefSearch() {
            ...
            AcceptButton = buttonCrudeProductExposeSetTypeRefSearch;
        ...
        private void buttonCrudeProductExposeSetTypeRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeProductExposeSetTypeRefEdit editForm = new CrudeProductExposeSetTypeRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeProductExposeSetTypeRef.CurrentRow.Cells["ProductExposeSetTypeRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeProductExposeSetTypeRef() {
            CrudeProductExposeSetTypeRefServiceClient productExposeSetTypeRef = new CrudeProductExposeSetTypeRefServiceClient();

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductDocumentationTypeRefSearch : Form {
        ...
        public CrudeProductDocumentationTypeRefSearch() {
            ...
            AcceptButton = buttonCrudeProductDocumentationTypeRefSearch;
        ...
        private void buttonCrudeProductDocumentationTypeRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeProductDocumentationTypeRefEdit editForm = new CrudeProductDocumentationTypeRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeProductDocumentationTypeRef.CurrentRow.Cells["ProductDocumentationTypeRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeProductDocumentationTypeRef() {
            CrudeProductDocumentationTypeRefServiceClient productDocumentationTypeRef = new CrudeProductDocumentationTypeRefServiceClient();

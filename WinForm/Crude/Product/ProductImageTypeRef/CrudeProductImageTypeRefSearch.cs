...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductImageTypeRefSearch : Form {
        ...
        public CrudeProductImageTypeRefSearch() {
            ...
            AcceptButton = buttonCrudeProductImageTypeRefSearch;
        ...
        private void buttonCrudeProductImageTypeRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeProductImageTypeRefEdit editForm = new CrudeProductImageTypeRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeProductImageTypeRef.CurrentRow.Cells["ProductImageTypeRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeProductImageTypeRef() {
            CrudeProductImageTypeRefServiceClient productImageTypeRef = new CrudeProductImageTypeRefServiceClient();

    ...
    public partial class CrudeProductExposeEdit : Form {
        ...
        public void ShowAsAdd() {
            try {
                ...
                _isNew = true;
                Text += " - Not Savable (ExposeProduct,ExposeBasedOnProduct,ProductExposeSet,User Missing)";
                Show();
            } catch (Exception ex) {
                if (ex == null) { } else {
        ...
        public void ShowAsEdit(System.Guid productExposeId) {
            CrudeProductExposeServiceClient service = new CrudeProductExposeServiceClient();
            _isNew = false;
            try {

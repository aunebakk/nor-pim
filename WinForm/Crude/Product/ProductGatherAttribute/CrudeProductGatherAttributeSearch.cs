...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductGatherAttributeSearch : Form {
        ...
        public CrudeProductGatherAttributeSearch() {
            ...
            AcceptButton = buttonCrudeProductGatherAttributeSearch;
        ...
        private void buttonCrudeProductGatherAttributeEdit_Click(object sender, EventArgs e) {
            try {
                CrudeProductGatherAttributeEdit editForm = new CrudeProductGatherAttributeEdit();
        ...
        public void RefreshCrudeProductGatherAttribute() {
            CrudeProductGatherAttributeServiceClient productGatherAttribute = new CrudeProductGatherAttributeServiceClient();

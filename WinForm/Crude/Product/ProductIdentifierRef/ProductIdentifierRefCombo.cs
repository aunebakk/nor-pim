    ...
    public partial class ProductIdentifierRefCombo : UserControl {
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeProductIdentifierRefServiceClient productIdentifierRef = null;

                try {
                    productIdentifierRef = new CrudeProductIdentifierRefServiceClient();
                    List<CrudeProductIdentifierRefContract> contracts = productIdentifierRef.FetchAll();

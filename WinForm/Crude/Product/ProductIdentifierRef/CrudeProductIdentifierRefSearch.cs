...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductIdentifierRefSearch : Form {
        ...
        public CrudeProductIdentifierRefSearch() {
            ...
            AcceptButton = buttonCrudeProductIdentifierRefSearch;
        ...
        private void buttonCrudeProductIdentifierRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeProductIdentifierRefEdit editForm = new CrudeProductIdentifierRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeProductIdentifierRef.CurrentRow.Cells["ProductIdentifierRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeProductIdentifierRef() {
            CrudeProductIdentifierRefServiceClient productIdentifierRef = new CrudeProductIdentifierRefServiceClient();

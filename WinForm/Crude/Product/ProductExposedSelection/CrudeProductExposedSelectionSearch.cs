...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductExposedSelectionSearch : Form {
        ...
        public CrudeProductExposedSelectionSearch() {
            ...
            AcceptButton = buttonCrudeProductExposedSelectionSearch;
        ...
        private void buttonCrudeProductExposedSelectionEdit_Click(object sender, EventArgs e) {
            try {
                CrudeProductExposedSelectionEdit editForm = new CrudeProductExposedSelectionEdit();
        ...
        public void RefreshCrudeProductExposedSelection() {
            CrudeProductExposedSelectionServiceClient productExposedSelection = new CrudeProductExposedSelectionServiceClient();

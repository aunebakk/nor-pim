/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 10/15/2020 12:15:38 PM
...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductAttributeRefEdit : Form {
        ...
        // shows the form with default values for comboboxes and pickers
        public void ShowAsAdd(string productAttributeRcd, string productAttributeName, System.Guid userId) {
            try {
                _contract = new CrudeProductAttributeRefContract();
                _isNew = true;
                _contract.ProductAttributeRcd = productAttributeRcd;
                textBoxProductAttribute.Text = _contract.ProductAttributeRcd;
                _contract.ProductAttributeName = productAttributeName;
        ...
        public void ShowAsEdit(string productAttributeRcd, System.Guid userId) {
            var service = new CrudeProductAttributeRefServiceClient();
            _isNew = false;
            try {
        ...
        private void buttonSave_Click(object sender, EventArgs e) {
            var service = new CrudeProductAttributeRefServiceClient();
            try {
                _contract.ProductAttributeRcd = textBoxProductAttribute.Text;

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductAttributeRefSearch : Form {
        ...
        public CrudeProductAttributeRefSearch() {
            ...
            AcceptButton = buttonCrudeProductAttributeRefSearch;
        ...
        private void buttonCrudeProductAttributeRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeProductAttributeRefEdit editForm = new CrudeProductAttributeRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeProductAttributeRef.CurrentRow.Cells["ProductAttributeRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeProductAttributeRef() {
            CrudeProductAttributeRefServiceClient productAttributeRef = new CrudeProductAttributeRefServiceClient();

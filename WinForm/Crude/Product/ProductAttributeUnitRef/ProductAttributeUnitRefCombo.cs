    ...
    public partial class ProductAttributeUnitRefCombo : UserControl {
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeProductAttributeUnitRefServiceClient productAttributeUnitRef = null;

                try {
                    productAttributeUnitRef = new CrudeProductAttributeUnitRefServiceClient();
                    List<CrudeProductAttributeUnitRefContract> contracts = productAttributeUnitRef.FetchAll();
                    ...
                    if (productAttributeUnitRef != null) {

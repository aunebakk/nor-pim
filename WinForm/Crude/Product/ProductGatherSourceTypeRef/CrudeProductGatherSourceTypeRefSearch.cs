...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductGatherSourceTypeRefSearch : Form {
        ...
        public CrudeProductGatherSourceTypeRefSearch() {
            ...
            AcceptButton = buttonCrudeProductGatherSourceTypeRefSearch;
        ...
        private void buttonCrudeProductGatherSourceTypeRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeProductGatherSourceTypeRefEdit editForm = new CrudeProductGatherSourceTypeRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeProductGatherSourceTypeRef.CurrentRow.Cells["ProductGatherSourceTypeRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeProductGatherSourceTypeRef() {
            CrudeProductGatherSourceTypeRefServiceClient productGatherSourceTypeRef = new CrudeProductGatherSourceTypeRefServiceClient();

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductExposePlanSearch : Form {
        ...
        public CrudeProductExposePlanSearch() {
            ...
            AcceptButton = buttonCrudeProductExposePlanSearch;
        ...
        private void buttonCrudeProductExposePlanEdit_Click(object sender, EventArgs e) {
            try {
                CrudeProductExposePlanEdit editForm = new CrudeProductExposePlanEdit();
        ...
        public void RefreshCrudeProductExposePlan() {
            CrudeProductExposePlanServiceClient productExposePlan = new CrudeProductExposePlanServiceClient();

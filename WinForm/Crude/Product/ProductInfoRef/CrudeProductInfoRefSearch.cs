...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductInfoRefSearch : Form {
        ...
        public CrudeProductInfoRefSearch() {
            ...
            AcceptButton = buttonCrudeProductInfoRefSearch;
        ...
        private void buttonCrudeProductInfoRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeProductInfoRefEdit editForm = new CrudeProductInfoRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeProductInfoRef.CurrentRow.Cells["ProductInfoRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeProductInfoRef() {
            CrudeProductInfoRefServiceClient productInfoRef = new CrudeProductInfoRefServiceClient();

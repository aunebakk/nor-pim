...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductFieldSetMappingSearch : Form {
        ...
        public CrudeProductFieldSetMappingSearch() {
            ...
            AcceptButton = buttonCrudeProductFieldSetMappingSearch;
        ...
        private void buttonCrudeProductFieldSetMappingEdit_Click(object sender, EventArgs e) {
            try {
                CrudeProductFieldSetMappingEdit editForm = new CrudeProductFieldSetMappingEdit();
        ...
        public void RefreshCrudeProductFieldSetMapping() {
            CrudeProductFieldSetMappingServiceClient productFieldSetMapping = new CrudeProductFieldSetMappingServiceClient();

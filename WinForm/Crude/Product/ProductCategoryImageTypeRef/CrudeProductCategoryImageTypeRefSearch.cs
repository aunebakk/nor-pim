...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeProductCategoryImageTypeRefSearch : Form {
        ...
        public CrudeProductCategoryImageTypeRefSearch() {
            ...
            AcceptButton = buttonCrudeProductCategoryImageTypeRefSearch;
        ...
        private void buttonCrudeProductCategoryImageTypeRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeProductCategoryImageTypeRefEdit editForm = new CrudeProductCategoryImageTypeRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeProductCategoryImageTypeRef.CurrentRow.Cells["ProductCategoryImageTypeRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeProductCategoryImageTypeRef() {
            CrudeProductCategoryImageTypeRefServiceClient productCategoryImageTypeRef = new CrudeProductCategoryImageTypeRefServiceClient();

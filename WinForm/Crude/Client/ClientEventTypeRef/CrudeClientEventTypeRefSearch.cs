...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeClientEventTypeRefSearch : Form {
        ...
        public CrudeClientEventTypeRefSearch() {
            ...
            AcceptButton = buttonCrudeClientEventTypeRefSearch;
        ...
        private void buttonCrudeClientEventTypeRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeClientEventTypeRefEdit editForm = new CrudeClientEventTypeRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeClientEventTypeRef.CurrentRow.Cells["ClientEventTypeRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeClientEventTypeRef() {
            CrudeClientEventTypeRefServiceClient clientEventTypeRef = new CrudeClientEventTypeRefServiceClient();

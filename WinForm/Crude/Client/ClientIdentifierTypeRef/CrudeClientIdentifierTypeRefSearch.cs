...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeClientIdentifierTypeRefSearch : Form {
        ...
        public CrudeClientIdentifierTypeRefSearch() {
            ...
            AcceptButton = buttonCrudeClientIdentifierTypeRefSearch;
        ...
        private void buttonCrudeClientIdentifierTypeRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeClientIdentifierTypeRefEdit editForm = new CrudeClientIdentifierTypeRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeClientIdentifierTypeRef.CurrentRow.Cells["ClientIdentifierTypeRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeClientIdentifierTypeRef() {
            CrudeClientIdentifierTypeRefServiceClient clientIdentifierTypeRef = new CrudeClientIdentifierTypeRefServiceClient();

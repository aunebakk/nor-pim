...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeClientLinkTypeRefSearch : Form {
        ...
        public CrudeClientLinkTypeRefSearch() {
            ...
            AcceptButton = buttonCrudeClientLinkTypeRefSearch;
        ...
        private void buttonCrudeClientLinkTypeRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeClientLinkTypeRefEdit editForm = new CrudeClientLinkTypeRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeClientLinkTypeRef.CurrentRow.Cells["ClientLinkTypeRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeClientLinkTypeRef() {
            CrudeClientLinkTypeRefServiceClient clientLinkTypeRef = new CrudeClientLinkTypeRefServiceClient();

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeClientGenderRefSearch : Form {
        ...
        public CrudeClientGenderRefSearch() {
            ...
            AcceptButton = buttonCrudeClientGenderRefSearch;
        ...
        private void buttonCrudeClientGenderRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeClientGenderRefEdit editForm = new CrudeClientGenderRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeClientGenderRef.CurrentRow.Cells["ClientGenderRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeClientGenderRef() {
            CrudeClientGenderRefServiceClient clientGenderRef = new CrudeClientGenderRefServiceClient();

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeClientAddressTypeRefSearch : Form {
        ...
        public CrudeClientAddressTypeRefSearch() {
            ...
            AcceptButton = buttonCrudeClientAddressTypeRefSearch;
        ...
        private void buttonCrudeClientAddressTypeRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeClientAddressTypeRefEdit editForm = new CrudeClientAddressTypeRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeClientAddressTypeRef.CurrentRow.Cells["ClientAddressTypeRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeClientAddressTypeRef() {
            CrudeClientAddressTypeRefServiceClient clientAddressTypeRef = new CrudeClientAddressTypeRefServiceClient();

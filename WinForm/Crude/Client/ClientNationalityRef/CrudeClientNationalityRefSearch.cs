...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeClientNationalityRefSearch : Form {
        ...
        public CrudeClientNationalityRefSearch() {
            ...
            AcceptButton = buttonCrudeClientNationalityRefSearch;
        ...
        private void buttonCrudeClientNationalityRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeClientNationalityRefEdit editForm = new CrudeClientNationalityRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeClientNationalityRef.CurrentRow.Cells["ClientNationalityRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeClientNationalityRef() {
            CrudeClientNationalityRefServiceClient clientNationalityRef = new CrudeClientNationalityRefServiceClient();

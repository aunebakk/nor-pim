...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeClientTypeRefSearch : Form {
        ...
        public CrudeClientTypeRefSearch() {
            ...
            AcceptButton = buttonCrudeClientTypeRefSearch;
        ...
        private void buttonCrudeClientTypeRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeClientTypeRefEdit editForm = new CrudeClientTypeRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeClientTypeRef.CurrentRow.Cells["ClientTypeRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeClientTypeRef() {
            CrudeClientTypeRefServiceClient clientTypeRef = new CrudeClientTypeRefServiceClient();

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeClientContactMethodRefSearch : Form {
        ...
        public CrudeClientContactMethodRefSearch() {
            ...
            AcceptButton = buttonCrudeClientContactMethodRefSearch;
        ...
        private void buttonCrudeClientContactMethodRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeClientContactMethodRefEdit editForm = new CrudeClientContactMethodRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeClientContactMethodRef.CurrentRow.Cells["ClientContactMethodRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeClientContactMethodRef() {
            CrudeClientContactMethodRefServiceClient clientContactMethodRef = new CrudeClientContactMethodRefServiceClient();

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeClientContactMethodSearch : Form {
        ...
        public CrudeClientContactMethodSearch() {
            ...
            AcceptButton = buttonCrudeClientContactMethodSearch;
        ...
        private void buttonCrudeClientContactMethodEdit_Click(object sender, EventArgs e) {
            try {
                CrudeClientContactMethodEdit editForm = new CrudeClientContactMethodEdit();
        ...
        public void RefreshCrudeClientContactMethod() {
            CrudeClientContactMethodServiceClient clientContactMethod = new CrudeClientContactMethodServiceClient();

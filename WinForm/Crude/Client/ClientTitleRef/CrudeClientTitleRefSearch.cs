...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeClientTitleRefSearch : Form {
        ...
        public CrudeClientTitleRefSearch() {
            ...
            AcceptButton = buttonCrudeClientTitleRefSearch;
        ...
        private void buttonCrudeClientTitleRefEdit_Click(object sender, EventArgs e) {
            try {
                CrudeClientTitleRefEdit editForm = new CrudeClientTitleRefEdit();
                editForm.MdiParent = MdiParent;
                editForm.ShowAsEdit((string)dataGridViewCrudeClientTitleRef.CurrentRow.Cells["ClientTitleRcd"].Value, _userId);
            } catch (Exception ex) {
                if (ex == null) { } else {
                    System.Diagnostics.Debugger.Break();
                }
        ...
        public void RefreshCrudeClientTitleRef() {
            CrudeClientTitleRefServiceClient clientTitleRef = new CrudeClientTitleRefServiceClient();

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class CrudeFinancialCurrencySearch : Form {
        ...
        public CrudeFinancialCurrencySearch() {
            ...
            AcceptButton = buttonCrudeFinancialCurrencySearch;
        ...
        private void buttonCrudeFinancialCurrencyEdit_Click(object sender, EventArgs e) {
            try {
                CrudeFinancialCurrencyEdit editForm = new CrudeFinancialCurrencyEdit();
        ...
        public void RefreshCrudeFinancialCurrency() {
            CrudeFinancialCurrencyServiceClient financialCurrency = new CrudeFinancialCurrencyServiceClient();

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class ProductSearchByNameDurian : UserControl {
        ...
        public virtual System.Guid ProductId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewProductSearchByName.CurrentRow.Cells["ProductId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public new virtual string ProductName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductSearchByName.CurrentRow.Cells["ProductName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string Identifier {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductSearchByName.CurrentRow.Cells["Identifier"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string Value {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductSearchByName.CurrentRow.Cells["Value"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ProductInfoValue {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductSearchByName.CurrentRow.Cells["ProductInfoValue"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ProductImageTypeRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductSearchByName.CurrentRow.Cells["ProductImageTypeRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ProductImageTypeName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductSearchByName.CurrentRow.Cells["ProductImageTypeName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual byte[] Image {
            get {
                if (!DesignMode) {
                    return (byte[])dataGridViewProductSearchByName.CurrentRow.Cells["Image"].Value;
                } else {
                    return null;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewProductSearchByName.Rows.Count;
                } else {
                    return 0;
                };
            }

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class ProductSearchByCategoryType2Durian : UserControl {
        ...
        public virtual System.Guid ProductId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewProductSearchByCategoryType2.CurrentRow.Cells["ProductId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public new virtual string ProductName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductSearchByCategoryType2.CurrentRow.Cells["ProductName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string Gtin13 {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductSearchByCategoryType2.CurrentRow.Cells["Gtin13"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string Hn {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductSearchByCategoryType2.CurrentRow.Cells["Hn"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string Color {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductSearchByCategoryType2.CurrentRow.Cells["Color"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewProductSearchByCategoryType2.Rows.Count;
                } else {
                    return 0;
                };
            }

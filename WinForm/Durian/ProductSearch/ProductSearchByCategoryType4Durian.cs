...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class ProductSearchByCategoryType4Durian : UserControl {
        ...
        public virtual string Hn {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductSearchByCategoryType4.CurrentRow.Cells["Hn"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public new virtual string ProductName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductSearchByCategoryType4.CurrentRow.Cells["ProductName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string Gtin13 {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductSearchByCategoryType4.CurrentRow.Cells["Gtin13"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string SupplierName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductSearchByCategoryType4.CurrentRow.Cells["SupplierName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.Guid ProductId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewProductSearchByCategoryType4.CurrentRow.Cells["ProductId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewProductSearchByCategoryType4.Rows.Count;
                } else {
                    return 0;
                };
            }

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class ProductMaintenanceDocumentationIndexWithFilterDurian : UserControl {
        ...
        public new virtual string ProductName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceDocumentationIndexWithFilter.CurrentRow.Cells["ProductName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string StateRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceDocumentationIndexWithFilter.CurrentRow.Cells["StateRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ProductDocumentationTypeName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceDocumentationIndexWithFilter.CurrentRow.Cells["ProductDocumentationTypeName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string DefaultUserName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceDocumentationIndexWithFilter.CurrentRow.Cells["DefaultUserName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.Guid ProductId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewProductMaintenanceDocumentationIndexWithFilter.CurrentRow.Cells["ProductId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public virtual string ProductDocumentationTypeRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceDocumentationIndexWithFilter.CurrentRow.Cells["ProductDocumentationTypeRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string Documentation {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceDocumentationIndexWithFilter.CurrentRow.Cells["Documentation"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.Guid UserId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewProductMaintenanceDocumentationIndexWithFilter.CurrentRow.Cells["UserId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public virtual System.DateTime DateTime {
            get {
                if (!DesignMode) {
                    return (System.DateTime)dataGridViewProductMaintenanceDocumentationIndexWithFilter.CurrentRow.Cells["DateTime"].Value;
                } else {
        ...
        public virtual System.Guid ProductDocumentationId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewProductMaintenanceDocumentationIndexWithFilter.CurrentRow.Cells["ProductDocumentationId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewProductMaintenanceDocumentationIndexWithFilter.Rows.Count;
                } else {
                    return 0;
                };
            }

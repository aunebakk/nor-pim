...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class ProductMaintenanceInfoIndexWithFilterDurian : UserControl {
        ...
        public new virtual string ProductName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceInfoIndexWithFilter.CurrentRow.Cells["ProductName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string StateRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceInfoIndexWithFilter.CurrentRow.Cells["StateRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ProductInfoName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceInfoIndexWithFilter.CurrentRow.Cells["ProductInfoName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string DefaultUserName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceInfoIndexWithFilter.CurrentRow.Cells["DefaultUserName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.Guid ProductId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewProductMaintenanceInfoIndexWithFilter.CurrentRow.Cells["ProductId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public virtual string ProductInfoRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceInfoIndexWithFilter.CurrentRow.Cells["ProductInfoRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ProductInfoValue {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceInfoIndexWithFilter.CurrentRow.Cells["ProductInfoValue"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.Guid UserId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewProductMaintenanceInfoIndexWithFilter.CurrentRow.Cells["UserId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public virtual System.DateTime DateTime {
            get {
                if (!DesignMode) {
                    return (System.DateTime)dataGridViewProductMaintenanceInfoIndexWithFilter.CurrentRow.Cells["DateTime"].Value;
                } else {
        ...
        public virtual System.Guid ProductInfoId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewProductMaintenanceInfoIndexWithFilter.CurrentRow.Cells["ProductInfoId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewProductMaintenanceInfoIndexWithFilter.Rows.Count;
                } else {
                    return 0;
                };
            }
        ...
        public void RefreshProductMaintenanceInfoIndexWithFilter(System.Guid productId) {
            try {
                ...
                bindingSource.DataSource = new ProductMaintenanceSearchService().ProductMaintenanceInfoIndexWithFilter(productId);

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class ProductMaintenanceIdentifierIndexWithFilterDurian : UserControl {
        ...
        public new virtual string ProductName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceIdentifierIndexWithFilter.CurrentRow.Cells["ProductName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string StateRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceIdentifierIndexWithFilter.CurrentRow.Cells["StateRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ProductIdentifierName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceIdentifierIndexWithFilter.CurrentRow.Cells["ProductIdentifierName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string DefaultUserName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceIdentifierIndexWithFilter.CurrentRow.Cells["DefaultUserName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.Guid ProductId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewProductMaintenanceIdentifierIndexWithFilter.CurrentRow.Cells["ProductId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public virtual string ProductIdentifierRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceIdentifierIndexWithFilter.CurrentRow.Cells["ProductIdentifierRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string Identifier {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceIdentifierIndexWithFilter.CurrentRow.Cells["Identifier"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.Guid UserId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewProductMaintenanceIdentifierIndexWithFilter.CurrentRow.Cells["UserId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public virtual System.DateTime DateTime {
            get {
                if (!DesignMode) {
                    return (System.DateTime)dataGridViewProductMaintenanceIdentifierIndexWithFilter.CurrentRow.Cells["DateTime"].Value;
                } else {
        ...
        public virtual System.Guid ProductIdentifierId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewProductMaintenanceIdentifierIndexWithFilter.CurrentRow.Cells["ProductIdentifierId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewProductMaintenanceIdentifierIndexWithFilter.Rows.Count;
                } else {
                    return 0;
                };
            }

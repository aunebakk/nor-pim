...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class ProductMaintenanceImageIndexWithFilterDurian : UserControl {
        ...
        public new virtual string ProductName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceImageIndexWithFilter.CurrentRow.Cells["ProductName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string StateRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceImageIndexWithFilter.CurrentRow.Cells["StateRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ProductImageTypeName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceImageIndexWithFilter.CurrentRow.Cells["ProductImageTypeName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ImageFileName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceImageIndexWithFilter.CurrentRow.Cells["ImageFileName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string DefaultUserName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceImageIndexWithFilter.CurrentRow.Cells["DefaultUserName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.Guid ProductId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewProductMaintenanceImageIndexWithFilter.CurrentRow.Cells["ProductId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public virtual string ProductImageTypeRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewProductMaintenanceImageIndexWithFilter.CurrentRow.Cells["ProductImageTypeRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual byte[] Image {
            get {
                if (!DesignMode) {
                    return (byte[])dataGridViewProductMaintenanceImageIndexWithFilter.CurrentRow.Cells["Image"].Value;
                } else {
                    return null;
                };
            }
        ...
        public virtual System.Guid UserId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewProductMaintenanceImageIndexWithFilter.CurrentRow.Cells["UserId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public virtual System.DateTime DateTime {
            get {
                if (!DesignMode) {
                    return (System.DateTime)dataGridViewProductMaintenanceImageIndexWithFilter.CurrentRow.Cells["DateTime"].Value;
                } else {
        ...
        public virtual System.Guid ProductImageId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewProductMaintenanceImageIndexWithFilter.CurrentRow.Cells["ProductImageId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewProductMaintenanceImageIndexWithFilter.Rows.Count;
                } else {
                    return 0;
                };
            }
        ...
        public void RefreshProductMaintenanceImageIndexWithFilter(System.Guid productId) {
            try {
                ...
                bindingSource.DataSource = new ProductMaintenanceSearchService().ProductMaintenanceImageIndexWithFilter(productId);

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class DefaultUserListForDashboardDurian : UserControl {
        ...
        public virtual string DefaultUserCode {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserListForDashboard.CurrentRow.Cells["DefaultUserCode"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string DefaultUserName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserListForDashboard.CurrentRow.Cells["DefaultUserName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string Email {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserListForDashboard.CurrentRow.Cells["Email"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string DefaultStateName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserListForDashboard.CurrentRow.Cells["DefaultStateName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual int ActivityCount {
            get {
                if (!DesignMode) {
                    return (int)dataGridViewDefaultUserListForDashboard.CurrentRow.Cells["ActivityCount"].Value;
                } else {
                    return 0;
                };
            }
        ...
        public virtual string LastActivityDateTime {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserListForDashboard.CurrentRow.Cells["LastActivityDateTime"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string CreatedDateTime {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserListForDashboard.CurrentRow.Cells["CreatedDateTime"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string CreatedByDefaultUserCode {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserListForDashboard.CurrentRow.Cells["CreatedByDefaultUserCode"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string CreatedByDefaultUserName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserListForDashboard.CurrentRow.Cells["CreatedByDefaultUserName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.Guid DefaultUserId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewDefaultUserListForDashboard.CurrentRow.Cells["DefaultUserId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewDefaultUserListForDashboard.Rows.Count;
                } else {
                    return 0;
                };
            }

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class DefaultStatisticsTop5Durian : UserControl {
        ...
        public virtual string Measurement {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultStatisticsTop5.CurrentRow.Cells["Measurement"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string Value {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultStatisticsTop5.CurrentRow.Cells["Value"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewDefaultStatisticsTop5.Rows.Count;
                } else {
                    return 0;
                };
            }

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class DefaultUserActivityGroupedByAddressDurian : UserControl {
        ...
        public virtual string OriginatingAddress {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserActivityGroupedByAddress.CurrentRow.Cells["OriginatingAddress"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual int Occurrences {
            get {
                if (!DesignMode) {
                    return (int)dataGridViewDefaultUserActivityGroupedByAddress.CurrentRow.Cells["Occurrences"].Value;
                } else {
                    return 0;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewDefaultUserActivityGroupedByAddress.Rows.Count;
                } else {
                    return 0;
                };
            }

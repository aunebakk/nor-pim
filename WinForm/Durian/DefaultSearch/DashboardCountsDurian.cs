...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class DashboardCountsDurian : UserControl {
        ...
        public virtual string DashboardItemRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDashboardCounts.CurrentRow.Cells["DashboardItemRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string DashboardItemName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDashboardCounts.CurrentRow.Cells["DashboardItemName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ImageSource {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDashboardCounts.CurrentRow.Cells["ImageSource"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string Value {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDashboardCounts.CurrentRow.Cells["Value"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual int Last24HoursCount {
            get {
                if (!DesignMode) {
                    return (int)dataGridViewDashboardCounts.CurrentRow.Cells["Last24HoursCount"].Value;
                } else {
                    return 0;
                };
            }
        ...
        public virtual string LastDateTime {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDashboardCounts.CurrentRow.Cells["LastDateTime"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string LastUserName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDashboardCounts.CurrentRow.Cells["LastUserName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string Url {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDashboardCounts.CurrentRow.Cells["Url"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual int PositionLeft {
            get {
                if (!DesignMode) {
                    return (int)dataGridViewDashboardCounts.CurrentRow.Cells["PositionLeft"].Value;
                } else {
                    return 0;
                };
            }
        ...
        public virtual int PositionTop {
            get {
                if (!DesignMode) {
                    return (int)dataGridViewDashboardCounts.CurrentRow.Cells["PositionTop"].Value;
                } else {
                    return 0;
                };
            }
        ...
        public virtual int PositionOffset {
            get {
                if (!DesignMode) {
                    return (int)dataGridViewDashboardCounts.CurrentRow.Cells["PositionOffset"].Value;
                } else {
                    return 0;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewDashboardCounts.Rows.Count;
                } else {
                    return 0;
                };
            }

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class GetDefaultChangeLogDurian : UserControl {
        ...
        public virtual string DefaultChangeName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetDefaultChangeLog.CurrentRow.Cells["DefaultChangeName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string DefaultChangeDescription {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetDefaultChangeLog.CurrentRow.Cells["DefaultChangeDescription"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.DateTime DateTime {
            get {
                if (!DesignMode) {
                    return (System.DateTime)dataGridViewGetDefaultChangeLog.CurrentRow.Cells["DateTime"].Value;
                } else {
        ...
        public virtual string DefaultChangeLogTypeRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetDefaultChangeLog.CurrentRow.Cells["DefaultChangeLogTypeRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string DefaultChangeLogTypeName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetDefaultChangeLog.CurrentRow.Cells["DefaultChangeLogTypeName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.Guid DefaultIssueId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewGetDefaultChangeLog.CurrentRow.Cells["DefaultIssueId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public virtual string IssueName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetDefaultChangeLog.CurrentRow.Cells["IssueName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.Guid DefaultChangeLogId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewGetDefaultChangeLog.CurrentRow.Cells["DefaultChangeLogId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewGetDefaultChangeLog.Rows.Count;
                } else {
                    return 0;
                };
            }

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class DefaultIssueWithFilterDurian : UserControl {
        ...
        public virtual string DefaultIssueTypeRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultIssueWithFilter.CurrentRow.Cells["DefaultIssueTypeRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string DefaultIssueTypeName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultIssueWithFilter.CurrentRow.Cells["DefaultIssueTypeName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string DefaultIssueStatusRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultIssueWithFilter.CurrentRow.Cells["DefaultIssueStatusRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string DefaultIssueStatusName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultIssueWithFilter.CurrentRow.Cells["DefaultIssueStatusName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.Guid DefaultErrorId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewDefaultIssueWithFilter.CurrentRow.Cells["DefaultErrorId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public virtual string MethodName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultIssueWithFilter.CurrentRow.Cells["MethodName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string IssueName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultIssueWithFilter.CurrentRow.Cells["IssueName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string IssueDescription {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultIssueWithFilter.CurrentRow.Cells["IssueDescription"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string StepsToReproduce {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultIssueWithFilter.CurrentRow.Cells["StepsToReproduce"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string Link {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultIssueWithFilter.CurrentRow.Cells["Link"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.DateTime DateTime {
            get {
                if (!DesignMode) {
                    return (System.DateTime)dataGridViewDefaultIssueWithFilter.CurrentRow.Cells["DateTime"].Value;
                } else {
        ...
        public virtual System.Guid DefaultIssueId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewDefaultIssueWithFilter.CurrentRow.Cells["DefaultIssueId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewDefaultIssueWithFilter.Rows.Count;
                } else {
                    return 0;
                };
            }

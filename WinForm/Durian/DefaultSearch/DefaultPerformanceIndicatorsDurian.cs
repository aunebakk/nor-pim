...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class DefaultPerformanceIndicatorsDurian : UserControl {
        ...
        public virtual string CommandName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultPerformanceIndicators.CurrentRow.Cells["CommandName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual long HitCount {
            get {
                if (!DesignMode) {
                    return (long)dataGridViewDefaultPerformanceIndicators.CurrentRow.Cells["HitCount"].Value;
                } else {
                    return 0;
                };
            }
        ...
        public virtual int AverageMilliseconds {
            get {
                if (!DesignMode) {
                    return (int)dataGridViewDefaultPerformanceIndicators.CurrentRow.Cells["AverageMilliseconds"].Value;
                } else {
                    return 0;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewDefaultPerformanceIndicators.Rows.Count;
                } else {
                    return 0;
                };
            }

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class DefaultUserActivityGroupedDurian : UserControl {
        ...
        public virtual string OriginatingAddress {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserActivityGrouped.CurrentRow.Cells["OriginatingAddress"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string UserActivityTypeName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserActivityGrouped.CurrentRow.Cells["UserActivityTypeName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string UserActivityNote {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserActivityGrouped.CurrentRow.Cells["UserActivityNote"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual int Occurrences {
            get {
                if (!DesignMode) {
                    return (int)dataGridViewDefaultUserActivityGrouped.CurrentRow.Cells["Occurrences"].Value;
                } else {
                    return 0;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewDefaultUserActivityGrouped.Rows.Count;
                } else {
                    return 0;
                };
            }

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class DefaultResourceStatisticsDurian : UserControl {
        ...
        public virtual string HourNumber {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultResourceStatistics.CurrentRow.Cells["HourNumber"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual int ClientWorkingsetBytes {
            get {
                if (!DesignMode) {
                    return (int)dataGridViewDefaultResourceStatistics.CurrentRow.Cells["ClientWorkingsetBytes"].Value;
                } else {
                    return 0;
                };
            }
        ...
        public virtual int BusinessWorkingsetBytes {
            get {
                if (!DesignMode) {
                    return (int)dataGridViewDefaultResourceStatistics.CurrentRow.Cells["BusinessWorkingsetBytes"].Value;
                } else {
                    return 0;
                };
            }
        ...
        public virtual int DatabaseSizeBytes {
            get {
                if (!DesignMode) {
                    return (int)dataGridViewDefaultResourceStatistics.CurrentRow.Cells["DatabaseSizeBytes"].Value;
                } else {
                    return 0;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewDefaultResourceStatistics.Rows.Count;
                } else {
                    return 0;
                };
            }

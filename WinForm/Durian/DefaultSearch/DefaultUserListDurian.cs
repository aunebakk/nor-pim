...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class DefaultUserListDurian : UserControl {
        ...
        public virtual System.DateTime LastActivityDateTime {
            get {
                if (!DesignMode) {
                    return (System.DateTime)dataGridViewDefaultUserList.CurrentRow.Cells["LastActivityDateTime"].Value;
                } else {
        ...
        public virtual string DefaultUserName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserList.CurrentRow.Cells["DefaultUserName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string DefaultUserCode {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserList.CurrentRow.Cells["DefaultUserCode"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.DateTime CreatedDateTime {
            get {
                if (!DesignMode) {
                    return (System.DateTime)dataGridViewDefaultUserList.CurrentRow.Cells["CreatedDateTime"].Value;
                } else {
                    return DateTime.MinValue;
                };
            }
        ...
        public virtual string Email {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserList.CurrentRow.Cells["Email"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string DefaultStateName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserList.CurrentRow.Cells["DefaultStateName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual int ActivityCount {
            get {
                if (!DesignMode) {
                    return (int)dataGridViewDefaultUserList.CurrentRow.Cells["ActivityCount"].Value;
                } else {
                    return 0;
                };
            }
        ...
        public virtual string CreatedByDefaultUserCode {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserList.CurrentRow.Cells["CreatedByDefaultUserCode"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string CreatedByDefaultUserName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewDefaultUserList.CurrentRow.Cells["CreatedByDefaultUserName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.Guid DefaultUserId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewDefaultUserList.CurrentRow.Cells["DefaultUserId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewDefaultUserList.Rows.Count;
                } else {
                    return 0;
                };
            }

...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class GetClientWithFilterDurian : UserControl {
        ...
        public virtual string FirstName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetClientWithFilter.CurrentRow.Cells["FirstName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string MiddleName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetClientWithFilter.CurrentRow.Cells["MiddleName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string LastName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetClientWithFilter.CurrentRow.Cells["LastName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ClientTypeRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetClientWithFilter.CurrentRow.Cells["ClientTypeRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ClientTypeName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetClientWithFilter.CurrentRow.Cells["ClientTypeName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ClientNationalityRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetClientWithFilter.CurrentRow.Cells["ClientNationalityRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ClientNationalityName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetClientWithFilter.CurrentRow.Cells["ClientNationalityName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ClientGenderRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetClientWithFilter.CurrentRow.Cells["ClientGenderRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ClientGenderName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetClientWithFilter.CurrentRow.Cells["ClientGenderName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ClientTitleRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetClientWithFilter.CurrentRow.Cells["ClientTitleRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ClientTitleName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetClientWithFilter.CurrentRow.Cells["ClientTitleName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.Guid UserId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewGetClientWithFilter.CurrentRow.Cells["UserId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public virtual string DefaultUserName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetClientWithFilter.CurrentRow.Cells["DefaultUserName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.DateTime DateTime {
            get {
                if (!DesignMode) {
                    return (System.DateTime)dataGridViewGetClientWithFilter.CurrentRow.Cells["DateTime"].Value;
                } else {
        ...
        public virtual System.Guid ClientId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewGetClientWithFilter.CurrentRow.Cells["ClientId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public virtual System.Guid ClientUserId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewGetClientWithFilter.CurrentRow.Cells["ClientUserId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewGetClientWithFilter.Rows.Count;
                } else {
                    return 0;
                };
            }

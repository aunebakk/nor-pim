...
namespace SolutionNorSolutionPim.UserInterface {
    ...
    public partial class GetFinancialOrderDurian : UserControl {
        ...
        public virtual string FirstName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetFinancialOrder.CurrentRow.Cells["FirstName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string MiddleName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetFinancialOrder.CurrentRow.Cells["MiddleName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string LastName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetFinancialOrder.CurrentRow.Cells["LastName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ClientNationalityRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetFinancialOrder.CurrentRow.Cells["ClientNationalityRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ClientGenderRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetFinancialOrder.CurrentRow.Cells["ClientGenderRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ClientTitleRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetFinancialOrder.CurrentRow.Cells["ClientTitleRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string ClientTypeRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetFinancialOrder.CurrentRow.Cells["ClientTypeRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.Guid ClientId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewGetFinancialOrder.CurrentRow.Cells["ClientId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public virtual string FinancialCurrencyTypeRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetFinancialOrder.CurrentRow.Cells["FinancialCurrencyTypeRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string FinancialCurrencyAgainstFinancialCurrencyTypeRcd {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetFinancialOrder.CurrentRow.Cells["FinancialCurrencyAgainstFinancialCurrencyTypeRcd"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string FinancialCurrencyTypeCode {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetFinancialOrder.CurrentRow.Cells["FinancialCurrencyTypeCode"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string FinancialCurrencyTypeName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetFinancialOrder.CurrentRow.Cells["FinancialCurrencyTypeName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.Guid FinancialCurrencyId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewGetFinancialOrder.CurrentRow.Cells["FinancialCurrencyId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public virtual string ImageBlobFilename {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetFinancialOrder.CurrentRow.Cells["ImageBlobFilename"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string Comment {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetFinancialOrder.CurrentRow.Cells["Comment"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual string FinancialOrderComment {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetFinancialOrder.CurrentRow.Cells["FinancialOrderComment"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.Guid UserId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewGetFinancialOrder.CurrentRow.Cells["UserId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public virtual string DefaultUserName {
            get {
                if (!DesignMode) {
                    return (string)dataGridViewGetFinancialOrder.CurrentRow.Cells["DefaultUserName"].Value;
                } else {
                    return string.Empty;
                };
            }
        ...
        public virtual System.DateTime DateTime {
            get {
                if (!DesignMode) {
                    return (System.DateTime)dataGridViewGetFinancialOrder.CurrentRow.Cells["DateTime"].Value;
                } else {
        ...
        public virtual System.Guid FinancialOrderId {
            get {
                if (!DesignMode) {
                    return (System.Guid)dataGridViewGetFinancialOrder.CurrentRow.Cells["FinancialOrderId"].Value;
                } else {
                    return Guid.Empty;
                };
            }
        ...
        public int Count {
            get {
                if (!DesignMode) {
                    return dataGridViewGetFinancialOrder.Rows.Count;
                } else {
                    return 0;
                };
            }

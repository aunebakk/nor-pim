...
namespace SolutionNorSolutionPim.BusinessLogicLayer {
    ...
    public class ProductCategoryService : IProductCategoryService {
        public void CleanSlate(Guid userId
            ...
            CrudeProductCategoryData crudeProductCategoryData = new CrudeProductCategoryData();
        ...
        public Guid ProductCategoryAdd(string productCategoryCode,
            ...
            CrudeProductCategoryService bll = new CrudeProductCategoryService();
            bll.Insert(contract);
        ...
        public ProductCategoryContract ProductCategoryGetCompleteById(Guid productCategoryId) {
            ProductCategoryContract contract = new ProductCategoryContract();
            Category data = new Category(productCategoryId);
        ...
        public long PositionDown(Guid productCategoryId) {
            ...
            CrudeProductCategoryData currentCategoryData = new CrudeProductCategoryData();
            currentCategoryData.FetchByProductCategoryId(productCategoryId);

            // get next category according to position
            CrudeProductCategoryData nextCategoryData = new CrudeProductCategoryData();
        ...
        public long PositionUp(Guid productCategoryId) {
            ...
            CrudeProductCategoryData previousCategoryData = new CrudeProductCategoryData();

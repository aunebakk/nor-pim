    ...
    public class CrudeProductExposeController : Controller {
        ...
        public string CrudeProductExposeCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductExpose/CrudeProductExposeCreate/", content).Result;
        ...
        public string CrudeProductExposeUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductExpose/CrudeProductExposeUpdate/", content).Result;

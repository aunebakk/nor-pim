    ...
    public class CrudeProductAttributeUnitRefController : Controller {
        ...
        public string CrudeProductAttributeUnitRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductAttributeUnitRef/CrudeProductAttributeUnitRefCreate/", content).Result;
        ...
        public string CrudeProductAttributeUnitRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductAttributeUnitRef/CrudeProductAttributeUnitRefUpdate/", content).Result;

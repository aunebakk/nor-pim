    ...
    public class CrudeProductController : Controller {
        ...
        public string CrudeProductCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProduct/CrudeProductCreate/", content).Result;
        ...
        public string CrudeProductUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProduct/CrudeProductUpdate/", content).Result;

    ...
    public class CrudeProductInfoRefController : Controller {
        ...
        public string CrudeProductInfoRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductInfoRef/CrudeProductInfoRefCreate/", content).Result;
        ...
        public string CrudeProductInfoRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductInfoRef/CrudeProductInfoRefUpdate/", content).Result;

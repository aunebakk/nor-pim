    ...
    public class CrudeProductIdentifierRefController : Controller {
        ...
        public string CrudeProductIdentifierRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/13/2020 5:44:49 PM" ) );
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductIdentifierRef/CrudeProductIdentifierRefCreate/", content).Result;
        ...
        public string CrudeProductIdentifierRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductIdentifierRef/CrudeProductIdentifierRefUpdate/", content).Result;

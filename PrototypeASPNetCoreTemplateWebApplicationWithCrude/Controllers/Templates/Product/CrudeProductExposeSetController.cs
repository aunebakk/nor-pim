    ...
    public class CrudeProductExposeSetController : Controller {
        ...
        public string CrudeProductExposeSetCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductExposeSet/CrudeProductExposeSetCreate/", content).Result;
        ...
        public string CrudeProductExposeSetUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductExposeSet/CrudeProductExposeSetUpdate/", content).Result;

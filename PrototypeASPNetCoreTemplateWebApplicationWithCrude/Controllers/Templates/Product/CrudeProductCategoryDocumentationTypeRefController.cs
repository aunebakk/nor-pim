    ...
    public class CrudeProductCategoryDocumentationTypeRefController : Controller {
        ...
        public string CrudeProductCategoryDocumentationTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/13/2020 5:44:45 PM" ) );
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductCategoryDocumentationTypeRef/CrudeProductCategoryDocumentationTypeRefCreate/", content).Result;
        ...
        public string CrudeProductCategoryDocumentationTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductCategoryDocumentationTypeRef/CrudeProductCategoryDocumentationTypeRefUpdate/", content).Result;

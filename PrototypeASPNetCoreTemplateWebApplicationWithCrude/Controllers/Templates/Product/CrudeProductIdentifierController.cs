    ...
    public class CrudeProductIdentifierController : Controller {
        ...
        public string CrudeProductIdentifierCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductIdentifier/CrudeProductIdentifierCreate/", content).Result;
        ...
        public string CrudeProductIdentifierUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductIdentifier/CrudeProductIdentifierUpdate/", content).Result;

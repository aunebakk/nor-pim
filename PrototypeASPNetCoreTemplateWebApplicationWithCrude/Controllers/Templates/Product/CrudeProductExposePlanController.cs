    ...
    public class CrudeProductExposePlanController : Controller {
        ...
        public string CrudeProductExposePlanCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductExposePlan/CrudeProductExposePlanCreate/", content).Result;
        ...
        public string CrudeProductExposePlanUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductExposePlan/CrudeProductExposePlanUpdate/", content).Result;

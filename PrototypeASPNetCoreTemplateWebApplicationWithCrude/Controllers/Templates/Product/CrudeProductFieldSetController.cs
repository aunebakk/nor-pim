    ...
    public class CrudeProductFieldSetController : Controller {
        ...
        public string CrudeProductFieldSetCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductFieldSet/CrudeProductFieldSetCreate/", content).Result;
        ...
        public string CrudeProductFieldSetUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductFieldSet/CrudeProductFieldSetUpdate/", content).Result;

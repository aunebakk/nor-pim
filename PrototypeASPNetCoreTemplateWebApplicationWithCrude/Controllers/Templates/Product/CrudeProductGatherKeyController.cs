    ...
    public class CrudeProductGatherKeyController : Controller {
        ...
        public string CrudeProductGatherKeyCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductGatherKey/CrudeProductGatherKeyCreate/", content).Result;
        ...
        public string CrudeProductGatherKeyUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductGatherKey/CrudeProductGatherKeyUpdate/", content).Result;

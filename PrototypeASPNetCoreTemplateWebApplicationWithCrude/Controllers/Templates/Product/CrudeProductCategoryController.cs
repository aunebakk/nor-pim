    ...
    public class CrudeProductCategoryController : Controller {
        ...
        public string CrudeProductCategoryCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductCategory/CrudeProductCategoryCreate/", content).Result;
        ...
        public string CrudeProductCategoryUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductCategory/CrudeProductCategoryUpdate/", content).Result;

    ...
    public class CrudeProductCategoryImageController : Controller {
        ...
        public string CrudeProductCategoryImageCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductCategoryImage/CrudeProductCategoryImageCreate/", content).Result;
        ...
        public string CrudeProductCategoryImageUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductCategoryImage/CrudeProductCategoryImageUpdate/", content).Result;

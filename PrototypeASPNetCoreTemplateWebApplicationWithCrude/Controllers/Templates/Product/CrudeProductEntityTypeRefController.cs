    ...
    public class CrudeProductEntityTypeRefController : Controller {
        ...
        public string CrudeProductEntityTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductEntityTypeRef/CrudeProductEntityTypeRefCreate/", content).Result;
        ...
        public string CrudeProductEntityTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductEntityTypeRef/CrudeProductEntityTypeRefUpdate/", content).Result;

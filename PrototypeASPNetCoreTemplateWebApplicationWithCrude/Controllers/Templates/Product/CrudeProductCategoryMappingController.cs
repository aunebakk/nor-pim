    ...
    public class CrudeProductCategoryMappingController : Controller {
        ...
        public string CrudeProductCategoryMappingCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductCategoryMapping/CrudeProductCategoryMappingCreate/", content).Result;
        ...
        public string CrudeProductCategoryMappingUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductCategoryMapping/CrudeProductCategoryMappingUpdate/", content).Result;

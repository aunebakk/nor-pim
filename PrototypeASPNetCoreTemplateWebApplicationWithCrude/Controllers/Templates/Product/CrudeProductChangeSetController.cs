    ...
    public class CrudeProductChangeSetController : Controller {
        ...
        public string CrudeProductChangeSetCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductChangeSet/CrudeProductChangeSetCreate/", content).Result;
        ...
        public string CrudeProductChangeSetUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductChangeSet/CrudeProductChangeSetUpdate/", content).Result;

    ...
    public class CrudeProductDocumentationController : Controller {
        ...
        public string CrudeProductDocumentationCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductDocumentation/CrudeProductDocumentationCreate/", content).Result;
        ...
        public string CrudeProductDocumentationUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductDocumentation/CrudeProductDocumentationUpdate/", content).Result;

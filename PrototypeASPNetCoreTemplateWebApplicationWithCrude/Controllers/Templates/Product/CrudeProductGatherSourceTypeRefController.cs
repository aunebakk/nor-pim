    ...
    public class CrudeProductGatherSourceTypeRefController : Controller {
        ...
        public string CrudeProductGatherSourceTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductGatherSourceTypeRef/CrudeProductGatherSourceTypeRefCreate/", content).Result;
        ...
        public string CrudeProductGatherSourceTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductGatherSourceTypeRef/CrudeProductGatherSourceTypeRefUpdate/", content).Result;

    ...
    public class CrudeProductExposedSelectionController : Controller {
        ...
        public string CrudeProductExposedSelectionCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductExposedSelection/CrudeProductExposedSelectionCreate/", content).Result;
        ...
        public string CrudeProductExposedSelectionUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductExposedSelection/CrudeProductExposedSelectionUpdate/", content).Result;

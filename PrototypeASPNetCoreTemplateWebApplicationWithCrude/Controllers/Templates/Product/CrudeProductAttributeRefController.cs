    ...
    public class CrudeProductAttributeRefController : Controller {
        ...
        public string CrudeProductAttributeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductAttributeRef/CrudeProductAttributeRefCreate/", content).Result;
        ...
        public string CrudeProductAttributeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductAttributeRef/CrudeProductAttributeRefUpdate/", content).Result;

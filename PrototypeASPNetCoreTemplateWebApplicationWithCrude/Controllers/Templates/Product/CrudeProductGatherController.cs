    ...
    public class CrudeProductGatherController : Controller {
        ...
        public string CrudeProductGatherCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "StartDateTime" , "4/16/2020 8:35:21 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "FinishDateTime" , "4/16/2020 8:35:21 PM" ) );

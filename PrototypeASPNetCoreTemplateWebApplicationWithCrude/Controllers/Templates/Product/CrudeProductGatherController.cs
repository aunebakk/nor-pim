    ...
    public class CrudeProductGatherController : Controller {
        ...
        public string CrudeProductGatherCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "StartDateTime" , "3/12/2020 12:44:11 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "FinishDateTime" , "3/12/2020 12:44:11 PM" ) );

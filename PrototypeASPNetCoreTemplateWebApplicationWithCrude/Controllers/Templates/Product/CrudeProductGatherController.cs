    ...
    public class CrudeProductGatherController : Controller {
        ...
        public string CrudeProductGatherCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "StartDateTime" , "1/14/2020 8:23:00 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "FinishDateTime" , "1/14/2020 8:23:00 PM" ) );

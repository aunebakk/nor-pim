    ...
    public class CrudeProductGatherController : Controller {
        ...
        public string CrudeProductGatherCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "StartDateTime" , "4/22/2020 7:01:25 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "FinishDateTime" , "4/22/2020 7:01:25 AM" ) );

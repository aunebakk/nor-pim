    ...
    public class CrudeProductGatherController : Controller {
        ...
        public string CrudeProductGatherCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "StartDateTime" , "3/13/2020 10:45:52 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "FinishDateTime" , "3/13/2020 10:45:52 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "3/13/2020 10:45:52 AM" ) );

    ...
    public class CrudeProductGatherController : Controller {
        ...
        public string CrudeProductGatherCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "StartDateTime" , "4/23/2020 11:50:18 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "FinishDateTime" , "4/23/2020 11:50:18 AM" ) );

    ...
    public class CrudeProductGatherController : Controller {
        ...
        public string CrudeProductGatherCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "StartDateTime" , "1/14/2020 10:47:59 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "FinishDateTime" , "1/14/2020 10:47:59 AM" ) );

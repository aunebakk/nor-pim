/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 3/11/2020 9:37:48 PM
    ...
    public class CrudeProductGatherController : Controller {
        ...
        public string CrudeProductGatherCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "StartDateTime" , "3/11/2020 9:37:48 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "FinishDateTime" , "3/11/2020 9:37:48 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "3/11/2020 9:37:48 PM" ) );

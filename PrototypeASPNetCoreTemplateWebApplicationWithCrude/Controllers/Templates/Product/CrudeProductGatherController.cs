    ...
    public class CrudeProductGatherController : Controller {
        ...
        public string CrudeProductGatherCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "StartDateTime" , "3/11/2020 1:39:39 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "FinishDateTime" , "3/11/2020 1:39:39 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "3/11/2020 1:39:39 PM" ) );

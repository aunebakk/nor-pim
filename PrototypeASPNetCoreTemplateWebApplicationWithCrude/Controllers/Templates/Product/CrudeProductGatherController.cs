    ...
    public class CrudeProductGatherController : Controller {
        ...
        public string CrudeProductGatherCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "StartDateTime" , "2/15/2020 3:45:27 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "FinishDateTime" , "2/15/2020 3:45:27 AM" ) );

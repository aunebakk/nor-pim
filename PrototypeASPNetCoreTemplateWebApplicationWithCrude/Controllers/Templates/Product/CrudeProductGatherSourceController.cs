    ...
    public class CrudeProductGatherSourceController : Controller {
        ...
        public string CrudeProductGatherSourceCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductGatherSource/CrudeProductGatherSourceCreate/", content).Result;
        ...
        public string CrudeProductGatherSourceUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductGatherSource/CrudeProductGatherSourceUpdate/", content).Result;

    ...
    public class CrudeProductImageController : Controller {
        ...
        public string CrudeProductImageCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductImage/CrudeProductImageCreate/", content).Result;
        ...
        public string CrudeProductImageUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductImage/CrudeProductImageUpdate/", content).Result;

/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 3/12/2020 12:44:11 PM
    ...
    public class CrudeProductGatherAttributeTypeRefController : Controller {
        ...
        public string CrudeProductGatherAttributeTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "3/12/2020 12:44:11 PM" ) );
                ...
                // todo var response = client.PostAsync("http://NorSolutionPimCore.azurewebsites.net/api/1/CrudeProductGatherAttributeTypeRef/CrudeProductGatherAttributeTypeRefCreate/", content).Result;
        ...
        public string CrudeProductGatherAttributeTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://NorSolutionPimCore.azurewebsites.net/api/1/CrudeProductGatherAttributeTypeRef/CrudeProductGatherAttributeTypeRefUpdate/", content).Result;

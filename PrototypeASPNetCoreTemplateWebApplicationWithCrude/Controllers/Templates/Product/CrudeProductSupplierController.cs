    ...
    public class CrudeProductSupplierController : Controller {
        ...
        public string CrudeProductSupplierCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductSupplier/CrudeProductSupplierCreate/", content).Result;
        ...
        public string CrudeProductSupplierUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductSupplier/CrudeProductSupplierUpdate/", content).Result;

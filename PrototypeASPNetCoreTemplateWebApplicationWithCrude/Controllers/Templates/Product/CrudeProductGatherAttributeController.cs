    ...
    public class CrudeProductGatherAttributeController : Controller {
        ...
        public string CrudeProductGatherAttributeCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductGatherAttribute/CrudeProductGatherAttributeCreate/", content).Result;
        ...
        public string CrudeProductGatherAttributeUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductGatherAttribute/CrudeProductGatherAttributeUpdate/", content).Result;

    ...
    public class CrudeProductDocumentationTypeRefController : Controller {
        ...
        public string CrudeProductDocumentationTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductDocumentationTypeRef/CrudeProductDocumentationTypeRefCreate/", content).Result;
        ...
        public string CrudeProductDocumentationTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductDocumentationTypeRef/CrudeProductDocumentationTypeRefUpdate/", content).Result;

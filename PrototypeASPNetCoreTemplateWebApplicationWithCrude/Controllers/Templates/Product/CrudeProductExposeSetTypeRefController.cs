/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 1/13/2020 5:44:47 PM
    ...
    public class CrudeProductExposeSetTypeRefController : Controller {
        ...
        public string CrudeProductExposeSetTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/13/2020 5:44:47 PM" ) );
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductExposeSetTypeRef/CrudeProductExposeSetTypeRefCreate/", content).Result;
        ...
        public string CrudeProductExposeSetTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductExposeSetTypeRef/CrudeProductExposeSetTypeRefUpdate/", content).Result;

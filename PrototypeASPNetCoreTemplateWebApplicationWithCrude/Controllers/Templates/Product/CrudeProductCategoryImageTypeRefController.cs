/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 1/13/2020 5:44:46 PM
    ...
    public class CrudeProductCategoryImageTypeRefController : Controller {
        ...
        public string CrudeProductCategoryImageTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/13/2020 5:44:46 PM" ) );
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductCategoryImageTypeRef/CrudeProductCategoryImageTypeRefCreate/", content).Result;
        ...
        public string CrudeProductCategoryImageTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductCategoryImageTypeRef/CrudeProductCategoryImageTypeRefUpdate/", content).Result;

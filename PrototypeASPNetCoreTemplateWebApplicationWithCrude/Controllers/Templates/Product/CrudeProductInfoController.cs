    ...
    public class CrudeProductInfoController : Controller {
        ...
        public string CrudeProductInfoCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductInfo/CrudeProductInfoCreate/", content).Result;
        ...
        public string CrudeProductInfoUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductInfo/CrudeProductInfoUpdate/", content).Result;

    ...
    public class CrudeProductCategoryDocumentationController : Controller {
        ...
        public string CrudeProductCategoryDocumentationCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeProductCategoryDocumentation/CrudeProductCategoryDocumentationCreate/", content).Result;
        ...
        public string CrudeProductCategoryDocumentationUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeProductCategoryDocumentation/CrudeProductCategoryDocumentationUpdate/", content).Result;

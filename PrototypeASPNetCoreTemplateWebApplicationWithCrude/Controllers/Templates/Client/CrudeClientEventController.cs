    ...
    public class CrudeClientEventController : Controller {
        ...
        public string CrudeClientEventCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeClientEvent/CrudeClientEventCreate/", content).Result;
        ...
        public string CrudeClientEventUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeClientEvent/CrudeClientEventUpdate/", content).Result;

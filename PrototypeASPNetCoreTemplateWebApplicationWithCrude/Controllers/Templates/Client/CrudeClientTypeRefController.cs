    ...
    public class CrudeClientTypeRefController : Controller {
        ...
        public string CrudeClientTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeClientTypeRef/CrudeClientTypeRefCreate/", content).Result;
        ...
        public string CrudeClientTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeClientTypeRef/CrudeClientTypeRefUpdate/", content).Result;

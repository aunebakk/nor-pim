    ...
    public class CrudeClientContactMethodRefController : Controller {
        ...
        public string CrudeClientContactMethodRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeClientContactMethodRef/CrudeClientContactMethodRefCreate/", content).Result;
        ...
        public string CrudeClientContactMethodRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeClientContactMethodRef/CrudeClientContactMethodRefUpdate/", content).Result;

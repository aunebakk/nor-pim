    ...
    public class CrudeClientDocumentTypeRefController : Controller {
        ...
        public string CrudeClientDocumentTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeClientDocumentTypeRef/CrudeClientDocumentTypeRefCreate/", content).Result;
        ...
        public string CrudeClientDocumentTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeClientDocumentTypeRef/CrudeClientDocumentTypeRefUpdate/", content).Result;

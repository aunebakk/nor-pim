    ...
    public class CrudeClientIdentifierController : Controller {
        ...
        public string CrudeClientIdentifierCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/13/2020 5:44:31 PM" ) );
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeClientIdentifier/CrudeClientIdentifierCreate/", content).Result;
        ...
        public string CrudeClientIdentifierUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeClientIdentifier/CrudeClientIdentifierUpdate/", content).Result;

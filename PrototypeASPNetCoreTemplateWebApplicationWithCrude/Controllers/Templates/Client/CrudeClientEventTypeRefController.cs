    ...
    public class CrudeClientEventTypeRefController : Controller {
        ...
        public string CrudeClientEventTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeClientEventTypeRef/CrudeClientEventTypeRefCreate/", content).Result;
        ...
        public string CrudeClientEventTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeClientEventTypeRef/CrudeClientEventTypeRefUpdate/", content).Result;

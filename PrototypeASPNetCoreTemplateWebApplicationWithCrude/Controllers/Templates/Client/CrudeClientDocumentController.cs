    ...
    public class CrudeClientDocumentController : Controller {
        ...
        public string CrudeClientDocumentCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DocumentDateTime" , "4/25/2020 8:22:58 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ExpiryDateTime" , "4/25/2020 8:22:58 AM" ) );

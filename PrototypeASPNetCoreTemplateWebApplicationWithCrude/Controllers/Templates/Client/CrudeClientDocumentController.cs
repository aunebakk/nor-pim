    ...
    public class CrudeClientDocumentController : Controller {
        ...
        public string CrudeClientDocumentCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DocumentDateTime" , "4/6/2020 12:33:28 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ExpiryDateTime" , "4/6/2020 12:33:28 PM" ) );

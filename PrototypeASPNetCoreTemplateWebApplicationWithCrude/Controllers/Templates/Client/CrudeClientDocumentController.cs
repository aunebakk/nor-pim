/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 3/11/2020 9:18:44 PM
    ...
    public class CrudeClientDocumentController : Controller {
        ...
        public string CrudeClientDocumentCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DocumentDateTime" , "3/11/2020 9:18:44 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ExpiryDateTime" , "3/11/2020 9:18:44 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "3/11/2020 9:18:44 PM" ) );

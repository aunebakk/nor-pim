    ...
    public class CrudeClientDocumentController : Controller {
        ...
        public string CrudeClientDocumentCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DocumentDateTime" , "4/9/2020 5:38:51 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ExpiryDateTime" , "4/9/2020 5:38:51 PM" ) );

    ...
    public class CrudeClientDocumentController : Controller {
        ...
        public string CrudeClientDocumentCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DocumentDateTime" , "1/14/2020 8:22:52 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ExpiryDateTime" , "1/14/2020 8:22:52 PM" ) );

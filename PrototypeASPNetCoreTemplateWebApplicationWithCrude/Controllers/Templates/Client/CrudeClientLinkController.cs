    ...
    public class CrudeClientLinkController : Controller {
        ...
        public string CrudeClientLinkCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeClientLink/CrudeClientLinkCreate/", content).Result;
        ...
        public string CrudeClientLinkUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeClientLink/CrudeClientLinkUpdate/", content).Result;

/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 1/13/2020 5:44:33 PM
    ...
    public class CrudeClientNationalityRefController : Controller {
        ...
        public string CrudeClientNationalityRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/13/2020 5:44:33 PM" ) );
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeClientNationalityRef/CrudeClientNationalityRefCreate/", content).Result;
        ...
        public string CrudeClientNationalityRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeClientNationalityRef/CrudeClientNationalityRefUpdate/", content).Result;

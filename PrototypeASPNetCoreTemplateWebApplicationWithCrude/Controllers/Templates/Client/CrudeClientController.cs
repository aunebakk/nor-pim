    ...
    public class CrudeClientController : Controller {
        ...
        public string CrudeClientCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeClient/CrudeClientCreate/", content).Result;
        ...
        public string CrudeClientUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeClient/CrudeClientUpdate/", content).Result;

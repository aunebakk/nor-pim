    ...
    public class CrudeClientLinkTypeRefController : Controller {
        ...
        public string CrudeClientLinkTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeClientLinkTypeRef/CrudeClientLinkTypeRefCreate/", content).Result;
        ...
        public string CrudeClientLinkTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeClientLinkTypeRef/CrudeClientLinkTypeRefUpdate/", content).Result;

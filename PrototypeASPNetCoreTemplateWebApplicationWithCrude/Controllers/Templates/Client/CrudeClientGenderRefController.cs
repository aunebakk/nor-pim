    ...
    public class CrudeClientGenderRefController : Controller {
        ...
        public string CrudeClientGenderRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeClientGenderRef/CrudeClientGenderRefCreate/", content).Result;
        ...
        public string CrudeClientGenderRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeClientGenderRef/CrudeClientGenderRefUpdate/", content).Result;

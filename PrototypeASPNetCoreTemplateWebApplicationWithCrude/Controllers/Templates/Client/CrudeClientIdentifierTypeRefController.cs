/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 1/13/2020 5:44:32 PM
    ...
    public class CrudeClientIdentifierTypeRefController : Controller {
        ...
        public string CrudeClientIdentifierTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/13/2020 5:44:32 PM" ) );
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeClientIdentifierTypeRef/CrudeClientIdentifierTypeRefCreate/", content).Result;
        ...
        public string CrudeClientIdentifierTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeClientIdentifierTypeRef/CrudeClientIdentifierTypeRefUpdate/", content).Result;

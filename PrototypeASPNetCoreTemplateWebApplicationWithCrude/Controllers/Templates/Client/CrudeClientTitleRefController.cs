    ...
    public class CrudeClientTitleRefController : Controller {
        ...
        public string CrudeClientTitleRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeClientTitleRef/CrudeClientTitleRefCreate/", content).Result;
        ...
        public string CrudeClientTitleRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeClientTitleRef/CrudeClientTitleRefUpdate/", content).Result;

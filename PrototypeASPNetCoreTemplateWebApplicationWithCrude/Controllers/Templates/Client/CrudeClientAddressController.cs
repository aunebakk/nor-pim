/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 1/13/2020 5:44:28 PM
    ...
    public class CrudeClientAddressController : Controller {
        ...
        public string CrudeClientAddressCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/13/2020 5:44:28 PM" ) );
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeClientAddress/CrudeClientAddressCreate/", content).Result;
        ...
        public string CrudeClientAddressUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeClientAddress/CrudeClientAddressUpdate/", content).Result;

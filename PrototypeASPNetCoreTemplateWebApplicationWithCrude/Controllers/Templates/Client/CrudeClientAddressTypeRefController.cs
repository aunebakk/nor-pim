    ...
    public class CrudeClientAddressTypeRefController : Controller {
        ...
        public string CrudeClientAddressTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeClientAddressTypeRef/CrudeClientAddressTypeRefCreate/", content).Result;
        ...
        public string CrudeClientAddressTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeClientAddressTypeRef/CrudeClientAddressTypeRefUpdate/", content).Result;

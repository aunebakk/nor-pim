/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 1/13/2020 5:44:27 PM
    ...
    public class CrudeCartProductPriceController : Controller {
        ...
        public string CrudeCartProductPriceCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/13/2020 5:44:27 PM" ) );
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeCartProductPrice/CrudeCartProductPriceCreate/", content).Result;
        ...
        public string CrudeCartProductPriceUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeCartProductPrice/CrudeCartProductPriceUpdate/", content).Result;

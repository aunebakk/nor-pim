    ...
    public class CrudeDefaultVersionController : Controller {
        ...
        public string CrudeDefaultVersionCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultVersion/CrudeDefaultVersionCreate/", content).Result;
        ...
        public string CrudeDefaultVersionUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultVersion/CrudeDefaultVersionUpdate/", content).Result;

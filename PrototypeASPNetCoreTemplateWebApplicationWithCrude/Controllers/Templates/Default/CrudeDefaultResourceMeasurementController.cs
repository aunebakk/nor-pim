/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 1/13/2020 5:44:37 PM
    ...
    public class CrudeDefaultResourceMeasurementController : Controller {
        ...
        public string CrudeDefaultResourceMeasurementCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/13/2020 5:44:37 PM" ) );
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultResourceMeasurement/CrudeDefaultResourceMeasurementCreate/", content).Result;
        ...
        public string CrudeDefaultResourceMeasurementUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultResourceMeasurement/CrudeDefaultResourceMeasurementUpdate/", content).Result;

    ...
    public class CrudeDefaultErrorTypeRefController : Controller {
        ...
        public string CrudeDefaultErrorTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultErrorTypeRef/CrudeDefaultErrorTypeRefCreate/", content).Result;
        ...
        public string CrudeDefaultErrorTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultErrorTypeRef/CrudeDefaultErrorTypeRefUpdate/", content).Result;

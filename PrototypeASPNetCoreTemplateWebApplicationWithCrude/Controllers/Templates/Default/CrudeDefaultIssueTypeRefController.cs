    ...
    public class CrudeDefaultIssueTypeRefController : Controller {
        ...
        public string CrudeDefaultIssueTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultIssueTypeRef/CrudeDefaultIssueTypeRefCreate/", content).Result;
        ...
        public string CrudeDefaultIssueTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultIssueTypeRef/CrudeDefaultIssueTypeRefUpdate/", content).Result;

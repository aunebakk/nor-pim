    ...
    public class CrudeDefaultErrorLayerRefController : Controller {
        ...
        public string CrudeDefaultErrorLayerRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultErrorLayerRef/CrudeDefaultErrorLayerRefCreate/", content).Result;
        ...
        public string CrudeDefaultErrorLayerRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultErrorLayerRef/CrudeDefaultErrorLayerRefUpdate/", content).Result;

/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 1/13/2020 5:44:34 PM
    ...
    public class CrudeDefaultChangeLogTypeRefController : Controller {
        ...
        public string CrudeDefaultChangeLogTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/13/2020 5:44:34 PM" ) );
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultChangeLogTypeRef/CrudeDefaultChangeLogTypeRefCreate/", content).Result;
        ...
        public string CrudeDefaultChangeLogTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultChangeLogTypeRef/CrudeDefaultChangeLogTypeRefUpdate/", content).Result;

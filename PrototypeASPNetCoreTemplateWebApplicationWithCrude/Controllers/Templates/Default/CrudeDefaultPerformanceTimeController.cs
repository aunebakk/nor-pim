    ...
    public class CrudeDefaultPerformanceTimeController : Controller {
        ...
        public string CrudeDefaultPerformanceTimeCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultPerformanceTime/CrudeDefaultPerformanceTimeCreate/", content).Result;
        ...
        public string CrudeDefaultPerformanceTimeUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultPerformanceTime/CrudeDefaultPerformanceTimeUpdate/", content).Result;

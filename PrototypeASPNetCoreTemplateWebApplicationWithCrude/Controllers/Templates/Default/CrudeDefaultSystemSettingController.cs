    ...
    public class CrudeDefaultSystemSettingController : Controller {
        ...
        public string CrudeDefaultSystemSettingCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultSystemSetting/CrudeDefaultSystemSettingCreate/", content).Result;
        ...
        public string CrudeDefaultSystemSettingUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultSystemSetting/CrudeDefaultSystemSettingUpdate/", content).Result;

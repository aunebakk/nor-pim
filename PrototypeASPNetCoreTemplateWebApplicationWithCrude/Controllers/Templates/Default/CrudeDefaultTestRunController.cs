/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 2/15/2020 3:45:20 AM
    ...
    public class CrudeDefaultTestRunController : Controller {
        ...
        public string CrudeDefaultTestRunCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "StartDateTime" , "2/15/2020 3:45:20 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "EndDateTime" , "2/15/2020 3:45:20 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ElapsedMilliseconds" , "1" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "2/15/2020 3:45:20 AM" ) );

/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 3/13/2020 10:45:47 AM
    ...
    public class CrudeDefaultTestRunController : Controller {
        ...
        public string CrudeDefaultTestRunCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "StartDateTime" , "3/13/2020 10:45:47 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "EndDateTime" , "3/13/2020 10:45:47 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ElapsedMilliseconds" , "1" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "3/13/2020 10:45:47 AM" ) );

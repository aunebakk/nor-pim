/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 1/13/2020 5:44:36 PM
    ...
    public class CrudeDefaultPerformanceTimeRollupController : Controller {
        ...
        public string CrudeDefaultPerformanceTimeRollupCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/13/2020 5:44:36 PM" ) );
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultPerformanceTimeRollup/CrudeDefaultPerformanceTimeRollupCreate/", content).Result;
        ...
        public string CrudeDefaultPerformanceTimeRollupUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultPerformanceTimeRollup/CrudeDefaultPerformanceTimeRollupUpdate/", content).Result;

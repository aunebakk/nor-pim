    ...
    public class CrudeDefaultStateRefController : Controller {
        ...
        public string CrudeDefaultStateRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultStateRef/CrudeDefaultStateRefCreate/", content).Result;
        ...
        public string CrudeDefaultStateRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultStateRef/CrudeDefaultStateRefUpdate/", content).Result;

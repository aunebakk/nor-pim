    ...
    public class CrudeDefaultChangeLogController : Controller {
        ...
        public string CrudeDefaultChangeLogCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultChangeLog/CrudeDefaultChangeLogCreate/", content).Result;
        ...
        public string CrudeDefaultChangeLogUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultChangeLog/CrudeDefaultChangeLogUpdate/", content).Result;

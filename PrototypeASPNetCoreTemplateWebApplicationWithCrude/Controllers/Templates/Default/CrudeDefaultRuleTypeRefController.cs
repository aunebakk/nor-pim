    ...
    public class CrudeDefaultRuleTypeRefController : Controller {
        ...
        public string CrudeDefaultRuleTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultRuleTypeRef/CrudeDefaultRuleTypeRefCreate/", content).Result;
        ...
        public string CrudeDefaultRuleTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultRuleTypeRef/CrudeDefaultRuleTypeRefUpdate/", content).Result;

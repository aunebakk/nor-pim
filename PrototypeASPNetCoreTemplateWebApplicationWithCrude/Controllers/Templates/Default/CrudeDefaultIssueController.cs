    ...
    public class CrudeDefaultIssueController : Controller {
        ...
        public string CrudeDefaultIssueCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultIssue/CrudeDefaultIssueCreate/", content).Result;
        ...
        public string CrudeDefaultIssueUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultIssue/CrudeDefaultIssueUpdate/", content).Result;

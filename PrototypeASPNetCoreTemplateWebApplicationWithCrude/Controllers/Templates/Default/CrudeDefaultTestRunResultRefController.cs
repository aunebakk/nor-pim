    ...
    public class CrudeDefaultTestRunResultRefController : Controller {
        ...
        public string CrudeDefaultTestRunResultRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultTestRunResultRef/CrudeDefaultTestRunResultRefCreate/", content).Result;
        ...
        public string CrudeDefaultTestRunResultRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultTestRunResultRef/CrudeDefaultTestRunResultRefUpdate/", content).Result;

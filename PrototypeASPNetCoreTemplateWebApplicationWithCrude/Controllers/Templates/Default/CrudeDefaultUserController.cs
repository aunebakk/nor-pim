/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 3/11/2020 9:25:03 PM
    ...
    public class CrudeDefaultUserController : Controller {
        ...
        public string CrudeDefaultUserCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "3/11/2020 9:25:03 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "LastActivityDateTime" , "3/11/2020 9:25:03 PM" ) );

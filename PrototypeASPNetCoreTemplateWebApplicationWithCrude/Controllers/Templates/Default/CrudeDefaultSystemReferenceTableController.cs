    ...
    public class CrudeDefaultSystemReferenceTableController : Controller {
        ...
        public string CrudeDefaultSystemReferenceTableCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultSystemReferenceTable/CrudeDefaultSystemReferenceTableCreate/", content).Result;
        ...
        public string CrudeDefaultSystemReferenceTableUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultSystemReferenceTable/CrudeDefaultSystemReferenceTableUpdate/", content).Result;

    ...
    public class CrudeDefaultUserActivityTypeRefController : Controller {
        ...
        public string CrudeDefaultUserActivityTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultUserActivityTypeRef/CrudeDefaultUserActivityTypeRefCreate/", content).Result;
        ...
        public string CrudeDefaultUserActivityTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultUserActivityTypeRef/CrudeDefaultUserActivityTypeRefUpdate/", content).Result;

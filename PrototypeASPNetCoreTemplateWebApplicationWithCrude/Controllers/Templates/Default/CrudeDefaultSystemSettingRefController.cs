    ...
    public class CrudeDefaultSystemSettingRefController : Controller {
        ...
        public string CrudeDefaultSystemSettingRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultSystemSettingRef/CrudeDefaultSystemSettingRefCreate/", content).Result;
        ...
        public string CrudeDefaultSystemSettingRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultSystemSettingRef/CrudeDefaultSystemSettingRefUpdate/", content).Result;

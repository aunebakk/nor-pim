/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 1/13/2020 5:44:35 PM
    ...
    public class CrudeDefaultIssueStatusRefController : Controller {
        ...
        public string CrudeDefaultIssueStatusRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/13/2020 5:44:35 PM" ) );
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultIssueStatusRef/CrudeDefaultIssueStatusRefCreate/", content).Result;
        ...
        public string CrudeDefaultIssueStatusRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultIssueStatusRef/CrudeDefaultIssueStatusRefUpdate/", content).Result;

    ...
    public class CrudeDefaultRuleController : Controller {
        ...
        public string CrudeDefaultRuleCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultRule/CrudeDefaultRuleCreate/", content).Result;
        ...
        public string CrudeDefaultRuleUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultRule/CrudeDefaultRuleUpdate/", content).Result;

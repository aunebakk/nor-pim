    ...
    public class CrudeDefaultTestController : Controller {
        ...
        public string CrudeDefaultTestCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeDefaultTest/CrudeDefaultTestCreate/", content).Result;
        ...
        public string CrudeDefaultTestUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeDefaultTest/CrudeDefaultTestUpdate/", content).Result;

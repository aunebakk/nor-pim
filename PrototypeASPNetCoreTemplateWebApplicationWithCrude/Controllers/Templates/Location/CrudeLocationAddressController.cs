    ...
    public class CrudeLocationAddressController : Controller {
        ...
        public string CrudeLocationAddressCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeLocationAddress/CrudeLocationAddressCreate/", content).Result;
        ...
        public string CrudeLocationAddressUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeLocationAddress/CrudeLocationAddressUpdate/", content).Result;

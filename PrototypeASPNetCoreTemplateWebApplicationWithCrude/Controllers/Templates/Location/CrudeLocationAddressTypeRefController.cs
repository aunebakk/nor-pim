    ...
    public class CrudeLocationAddressTypeRefController : Controller {
        ...
        public string CrudeLocationAddressTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeLocationAddressTypeRef/CrudeLocationAddressTypeRefCreate/", content).Result;
        ...
        public string CrudeLocationAddressTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeLocationAddressTypeRef/CrudeLocationAddressTypeRefUpdate/", content).Result;

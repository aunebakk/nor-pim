    ...
    public class CrudeLocationCountryController : Controller {
        ...
        public string CrudeLocationCountryCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeLocationCountry/CrudeLocationCountryCreate/", content).Result;
        ...
        public string CrudeLocationCountryUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeLocationCountry/CrudeLocationCountryUpdate/", content).Result;

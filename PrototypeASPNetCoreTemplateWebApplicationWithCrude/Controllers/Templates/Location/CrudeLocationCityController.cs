/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 3/11/2020 1:38:26 PM
    ...
    public class CrudeLocationCityController : Controller {
        ...
        public string CrudeLocationCityCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "3/11/2020 1:38:26 PM" ) );
                ...
                // todo var response = client.PostAsync("http://NorSolutionPimCore.azurewebsites.net/api/1/CrudeLocationCity/CrudeLocationCityCreate/", content).Result;
        ...
        public string CrudeLocationCityUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://NorSolutionPimCore.azurewebsites.net/api/1/CrudeLocationCity/CrudeLocationCityUpdate/", content).Result;

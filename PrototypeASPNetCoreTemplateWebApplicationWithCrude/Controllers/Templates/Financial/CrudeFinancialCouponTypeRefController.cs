    ...
    public class CrudeFinancialCouponTypeRefController : Controller {
        ...
        public string CrudeFinancialCouponTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialCouponTypeRef/CrudeFinancialCouponTypeRefCreate/", content).Result;
        ...
        public string CrudeFinancialCouponTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialCouponTypeRef/CrudeFinancialCouponTypeRefUpdate/", content).Result;

    ...
    public class CrudeFinancialUnitOfMeasurementRefController : Controller {
        ...
        public string CrudeFinancialUnitOfMeasurementRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialUnitOfMeasurementRef/CrudeFinancialUnitOfMeasurementRefCreate/", content).Result;
        ...
        public string CrudeFinancialUnitOfMeasurementRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialUnitOfMeasurementRef/CrudeFinancialUnitOfMeasurementRefUpdate/", content).Result;

    ...
    public class CrudeFinancialCurrencyTypeRefController : Controller {
        ...
        public string CrudeFinancialCurrencyTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialCurrencyTypeRef/CrudeFinancialCurrencyTypeRefCreate/", content).Result;
        ...
        public string CrudeFinancialCurrencyTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialCurrencyTypeRef/CrudeFinancialCurrencyTypeRefUpdate/", content).Result;

/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 1/13/2020 5:44:42 PM
    ...
    public class CrudeFinancialPaymentTypeRefController : Controller {
        ...
        public string CrudeFinancialPaymentTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/13/2020 5:44:42 PM" ) );
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialPaymentTypeRef/CrudeFinancialPaymentTypeRefCreate/", content).Result;
        ...
        public string CrudeFinancialPaymentTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialPaymentTypeRef/CrudeFinancialPaymentTypeRefUpdate/", content).Result;

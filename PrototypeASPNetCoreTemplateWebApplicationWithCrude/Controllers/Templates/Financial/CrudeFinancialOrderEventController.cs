    ...
    public class CrudeFinancialOrderEventController : Controller {
        ...
        public string CrudeFinancialOrderEventCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialOrderEvent/CrudeFinancialOrderEventCreate/", content).Result;
        ...
        public string CrudeFinancialOrderEventUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialOrderEvent/CrudeFinancialOrderEventUpdate/", content).Result;

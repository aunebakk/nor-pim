    ...
    public class CrudeFinancialOrderIdentifierController : Controller {
        ...
        public string CrudeFinancialOrderIdentifierCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialOrderIdentifier/CrudeFinancialOrderIdentifierCreate/", content).Result;
        ...
        public string CrudeFinancialOrderIdentifierUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialOrderIdentifier/CrudeFinancialOrderIdentifierUpdate/", content).Result;

    ...
    public class CrudeFinancialBankAccountNumberTypeRefController : Controller {
        ...
        public string CrudeFinancialBankAccountNumberTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialBankAccountNumberTypeRef/CrudeFinancialBankAccountNumberTypeRefCreate/", content).Result;
        ...
        public string CrudeFinancialBankAccountNumberTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialBankAccountNumberTypeRef/CrudeFinancialBankAccountNumberTypeRefUpdate/", content).Result;

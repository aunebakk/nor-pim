    ...
    public class CrudeFinancialTaxTypeRefController : Controller {
        ...
        public string CrudeFinancialTaxTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialTaxTypeRef/CrudeFinancialTaxTypeRefCreate/", content).Result;
        ...
        public string CrudeFinancialTaxTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialTaxTypeRef/CrudeFinancialTaxTypeRefUpdate/", content).Result;

    ...
    public class CrudeFinancialOrderSourceRefController : Controller {
        ...
        public string CrudeFinancialOrderSourceRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialOrderSourceRef/CrudeFinancialOrderSourceRefCreate/", content).Result;
        ...
        public string CrudeFinancialOrderSourceRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialOrderSourceRef/CrudeFinancialOrderSourceRefUpdate/", content).Result;

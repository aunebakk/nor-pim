    ...
    public class CrudeFinancialOrderController : Controller {
        ...
        public string CrudeFinancialOrderCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialOrder/CrudeFinancialOrderCreate/", content).Result;
        ...
        public string CrudeFinancialOrderUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialOrder/CrudeFinancialOrderUpdate/", content).Result;

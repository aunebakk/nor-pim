    ...
    public class CrudeFinancialPaymentCashController : Controller {
        ...
        public string CrudeFinancialPaymentCashCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialPaymentCash/CrudeFinancialPaymentCashCreate/", content).Result;
        ...
        public string CrudeFinancialPaymentCashUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialPaymentCash/CrudeFinancialPaymentCashUpdate/", content).Result;

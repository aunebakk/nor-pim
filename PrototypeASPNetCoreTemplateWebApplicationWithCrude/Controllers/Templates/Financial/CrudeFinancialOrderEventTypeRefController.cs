    ...
    public class CrudeFinancialOrderEventTypeRefController : Controller {
        ...
        public string CrudeFinancialOrderEventTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialOrderEventTypeRef/CrudeFinancialOrderEventTypeRefCreate/", content).Result;
        ...
        public string CrudeFinancialOrderEventTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialOrderEventTypeRef/CrudeFinancialOrderEventTypeRefUpdate/", content).Result;

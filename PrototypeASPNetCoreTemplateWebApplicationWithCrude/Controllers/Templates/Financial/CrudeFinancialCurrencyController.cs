    ...
    public class CrudeFinancialCurrencyController : Controller {
        ...
        public string CrudeFinancialCurrencyCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ValidFromDateTime" , "4/22/2020 7:01:23 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidUntilDateTime" , "4/22/2020 7:01:23 AM" ) );

    ...
    public class CrudeFinancialCurrencyController : Controller {
        ...
        public string CrudeFinancialCurrencyCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ValidFromDateTime" , "1/14/2020 10:47:51 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidUntilDateTime" , "1/14/2020 10:47:51 AM" ) );

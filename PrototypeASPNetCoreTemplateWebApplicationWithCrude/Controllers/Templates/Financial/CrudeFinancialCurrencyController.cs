    ...
    public class CrudeFinancialCurrencyController : Controller {
        ...
        public string CrudeFinancialCurrencyCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/14/2020 8:22:57 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidFromDateTime" , "1/14/2020 8:22:57 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidUntilDateTime" , "1/14/2020 8:22:57 PM" ) );

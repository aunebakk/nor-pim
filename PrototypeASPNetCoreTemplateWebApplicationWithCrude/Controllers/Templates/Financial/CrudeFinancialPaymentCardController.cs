    ...
    public class CrudeFinancialPaymentCardController : Controller {
        ...
        public string CrudeFinancialPaymentCardCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialPaymentCard/CrudeFinancialPaymentCardCreate/", content).Result;
        ...
        public string CrudeFinancialPaymentCardUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialPaymentCard/CrudeFinancialPaymentCardUpdate/", content).Result;

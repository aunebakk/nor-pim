    ...
    public class CrudeFinancialCouponController : Controller {
        ...
        public string CrudeFinancialCouponCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ValidFromDateTime" , "2/15/2020 3:45:21 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidUntilDateTime" , "2/15/2020 3:45:21 AM" ) );

    ...
    public class CrudeFinancialCouponController : Controller {
        ...
        public string CrudeFinancialCouponCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ValidFromDateTime" , "4/9/2020 7:26:49 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidUntilDateTime" , "4/9/2020 7:26:49 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "CouponDescription" , "create" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "4/9/2020 7:26:49 AM" ) );

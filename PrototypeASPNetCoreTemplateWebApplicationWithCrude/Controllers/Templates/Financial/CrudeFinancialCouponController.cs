    ...
    public class CrudeFinancialCouponController : Controller {
        ...
        public string CrudeFinancialCouponCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ValidFromDateTime" , "4/22/2020 5:37:58 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidUntilDateTime" , "4/22/2020 5:37:58 AM" ) );

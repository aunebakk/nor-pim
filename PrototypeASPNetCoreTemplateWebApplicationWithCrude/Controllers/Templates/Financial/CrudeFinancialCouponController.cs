    ...
    public class CrudeFinancialCouponController : Controller {
        ...
        public string CrudeFinancialCouponCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ValidFromDateTime" , "1/13/2020 5:44:39 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidUntilDateTime" , "1/13/2020 5:44:39 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "CouponDescription" , "create" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/13/2020 5:44:39 PM" ) );
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialCoupon/CrudeFinancialCouponCreate/", content).Result;
        ...
        public string CrudeFinancialCouponUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialCoupon/CrudeFinancialCouponUpdate/", content).Result;

    ...
    public class CrudeFinancialPaymentCouponController : Controller {
        ...
        public string CrudeFinancialPaymentCouponCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialPaymentCoupon/CrudeFinancialPaymentCouponCreate/", content).Result;
        ...
        public string CrudeFinancialPaymentCouponUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialPaymentCoupon/CrudeFinancialPaymentCouponUpdate/", content).Result;

    ...
    public class CrudeFinancialCostcentreController : Controller {
        ...
        public string CrudeFinancialCostcentreCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialCostcentre/CrudeFinancialCostcentreCreate/", content).Result;
        ...
        public string CrudeFinancialCostcentreUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialCostcentre/CrudeFinancialCostcentreUpdate/", content).Result;

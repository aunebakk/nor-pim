    ...
    public class CrudeFinancialPaymentController : Controller {
        ...
        public string CrudeFinancialPaymentCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialPayment/CrudeFinancialPaymentCreate/", content).Result;
        ...
        public string CrudeFinancialPaymentUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialPayment/CrudeFinancialPaymentUpdate/", content).Result;

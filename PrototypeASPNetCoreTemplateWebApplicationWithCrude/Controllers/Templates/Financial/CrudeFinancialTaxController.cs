    ...
    public class CrudeFinancialTaxController : Controller {
        ...
        public string CrudeFinancialTaxCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialTax/CrudeFinancialTaxCreate/", content).Result;
        ...
        public string CrudeFinancialTaxUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialTax/CrudeFinancialTaxUpdate/", content).Result;

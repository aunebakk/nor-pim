    ...
    public class CrudeFinancialOrderIdentifierTypeRefController : Controller {
        ...
        public string CrudeFinancialOrderIdentifierTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialOrderIdentifierTypeRef/CrudeFinancialOrderIdentifierTypeRefCreate/", content).Result;
        ...
        public string CrudeFinancialOrderIdentifierTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialOrderIdentifierTypeRef/CrudeFinancialOrderIdentifierTypeRefUpdate/", content).Result;

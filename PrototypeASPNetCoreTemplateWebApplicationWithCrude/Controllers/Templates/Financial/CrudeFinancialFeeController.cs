    ...
    public class CrudeFinancialFeeController : Controller {
        ...
        public string CrudeFinancialFeeCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialFee/CrudeFinancialFeeCreate/", content).Result;
        ...
        public string CrudeFinancialFeeUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialFee/CrudeFinancialFeeUpdate/", content).Result;

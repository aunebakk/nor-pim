    ...
    public class CrudeFinancialAdjustmentTypeRefController : Controller {
        ...
        public string CrudeFinancialAdjustmentTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialAdjustmentTypeRef/CrudeFinancialAdjustmentTypeRefCreate/", content).Result;
        ...
        public string CrudeFinancialAdjustmentTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialAdjustmentTypeRef/CrudeFinancialAdjustmentTypeRefUpdate/", content).Result;

    ...
    public class CrudeFinancialCardTypeRefController : Controller {
        ...
        public string CrudeFinancialCardTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialCardTypeRef/CrudeFinancialCardTypeRefCreate/", content).Result;
        ...
        public string CrudeFinancialCardTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialCardTypeRef/CrudeFinancialCardTypeRefUpdate/", content).Result;

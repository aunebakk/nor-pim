    ...
    public class CrudeFinancialCompanyController : Controller {
        ...
        public string CrudeFinancialCompanyCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialCompany/CrudeFinancialCompanyCreate/", content).Result;
        ...
        public string CrudeFinancialCompanyUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialCompany/CrudeFinancialCompanyUpdate/", content).Result;

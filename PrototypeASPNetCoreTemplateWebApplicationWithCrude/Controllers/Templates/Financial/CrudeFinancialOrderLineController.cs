/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 1/14/2020 10:47:52 AM
    ...
    public class CrudeFinancialOrderLineController : Controller {
        ...
        public string CrudeFinancialOrderLineCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/14/2020 10:47:52 AM" ) );
                ...
                // todo var response = client.PostAsync("http://NorSolutionPimCore.azurewebsites.net/api/1/CrudeFinancialOrderLine/CrudeFinancialOrderLineCreate/", content).Result;
        ...
        public string CrudeFinancialOrderLineUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://NorSolutionPimCore.azurewebsites.net/api/1/CrudeFinancialOrderLine/CrudeFinancialOrderLineUpdate/", content).Result;

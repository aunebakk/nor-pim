/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 3/13/2020 10:45:50 AM
    ...
    public class CrudeFinancialVoucherTypeRefController : Controller {
        ...
        public string CrudeFinancialVoucherTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "3/13/2020 10:45:50 AM" ) );
                ...
                // todo var response = client.PostAsync("http://NorSolutionPimCore.azurewebsites.net/api/1/CrudeFinancialVoucherTypeRef/CrudeFinancialVoucherTypeRefCreate/", content).Result;
        ...
        public string CrudeFinancialVoucherTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://NorSolutionPimCore.azurewebsites.net/api/1/CrudeFinancialVoucherTypeRef/CrudeFinancialVoucherTypeRefUpdate/", content).Result;

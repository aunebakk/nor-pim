    ...
    public class CrudeFinancialOrderTransactionTypeRefController : Controller {
        ...
        public string CrudeFinancialOrderTransactionTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialOrderTransactionTypeRef/CrudeFinancialOrderTransactionTypeRefCreate/", content).Result;
        ...
        public string CrudeFinancialOrderTransactionTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialOrderTransactionTypeRef/CrudeFinancialOrderTransactionTypeRefUpdate/", content).Result;

    ...
    public class CrudeFinancialFeeTypeRefController : Controller {
        ...
        public string CrudeFinancialFeeTypeRefCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialFeeTypeRef/CrudeFinancialFeeTypeRefCreate/", content).Result;
        ...
        public string CrudeFinancialFeeTypeRefUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialFeeTypeRef/CrudeFinancialFeeTypeRefUpdate/", content).Result;

    ...
    public class CrudeFinancialVoucherController : Controller {
        ...
        public string CrudeFinancialVoucherCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ValidFromDateTime" , "4/25/2020 8:22:59 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidUntilDateTime" , "4/25/2020 8:22:59 AM" ) );

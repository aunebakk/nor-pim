    ...
    public class CrudeFinancialVoucherController : Controller {
        ...
        public string CrudeFinancialVoucherCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ValidFromDateTime" , "4/23/2020 11:50:18 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidUntilDateTime" , "4/23/2020 11:50:18 AM" ) );

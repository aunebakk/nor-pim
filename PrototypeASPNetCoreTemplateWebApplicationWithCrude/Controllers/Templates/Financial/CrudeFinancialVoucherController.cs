/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 3/11/2020 9:32:13 PM
    ...
    public class CrudeFinancialVoucherController : Controller {
        ...
        public string CrudeFinancialVoucherCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "3/11/2020 9:32:13 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidFromDateTime" , "3/11/2020 9:32:13 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidUntilDateTime" , "3/11/2020 9:32:13 PM" ) );

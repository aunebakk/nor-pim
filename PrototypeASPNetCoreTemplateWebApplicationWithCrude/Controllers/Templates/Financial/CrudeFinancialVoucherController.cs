    ...
    public class CrudeFinancialVoucherController : Controller {
        ...
        public string CrudeFinancialVoucherCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ValidFromDateTime" , "4/16/2020 8:35:21 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidUntilDateTime" , "4/16/2020 8:35:21 PM" ) );

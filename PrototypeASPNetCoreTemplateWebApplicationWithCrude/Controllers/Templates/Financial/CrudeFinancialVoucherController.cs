    ...
    public class CrudeFinancialVoucherController : Controller {
        ...
        public string CrudeFinancialVoucherCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "3/12/2020 12:44:08 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidFromDateTime" , "3/12/2020 12:44:08 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidUntilDateTime" , "3/12/2020 12:44:08 PM" ) );

    ...
    public class CrudeFinancialPaymentAccountingController : Controller {
        ...
        public string CrudeFinancialPaymentAccountingCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialPaymentAccounting/CrudeFinancialPaymentAccountingCreate/", content).Result;
        ...
        public string CrudeFinancialPaymentAccountingUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialPaymentAccounting/CrudeFinancialPaymentAccountingUpdate/", content).Result;

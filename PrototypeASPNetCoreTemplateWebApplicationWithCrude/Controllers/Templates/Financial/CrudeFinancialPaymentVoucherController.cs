    ...
    public class CrudeFinancialPaymentVoucherController : Controller {
        ...
        public string CrudeFinancialPaymentVoucherCreateTest() {
            ...
            try {
                ...
                // todo var response = client.PostAsync("http://localhost:5000/api/1/CrudeFinancialPaymentVoucher/CrudeFinancialPaymentVoucherCreate/", content).Result;
        ...
        public string CrudeFinancialPaymentVoucherUpdateTest() {
            ...
            try {
                ...
                // todo var response = client.PutAsync("http://localhost:5000/api/1/CrudeFinancialPaymentVoucher/CrudeFinancialPaymentVoucherUpdate/", content).Result;

                ...
                DatabaseScriptBatch = new DatabaseScriptBatch {
                    Script = @"
                        insert into default_system_setting_ref (default_system_setting_rcd, default_system_setting_name, default_user_id, date_time) 
	                        values ('EFOLINK', 'Elektroforeningen web link', '{FFFFFFFF-5555-5555-5555-FFFFFFFFFFFF}', getutcdate());
                        ...
                        insert into default_system_setting(default_system_setting_id, default_system_setting_rcd, default_system_setting_value, default_user_id, date_time )
	                        values (newid(), dbo.ref('default_system_setting_ref.EFOLINK'), 'http://efobasen.efo.no/produkt/23/', '{FFFFFFFF-5555-5555-5555-FFFFFFFFFFFF}', getutcdate());

                        insert into default_system_setting_ref (default_system_setting_rcd, default_system_setting_name, default_user_id, date_time) 
	                        values ('FDVLINK', 'FDV web link', '{FFFFFFFF-5555-5555-5555-FFFFFFFFFFFF}', getutcdate());

                        insert into default_system_setting(default_system_setting_id, default_system_setting_rcd, default_system_setting_value, default_user_id, date_time )
	                        values (newid(), dbo.ref('default_system_setting_ref.FDVLINK'), 'http://www.nexans.no/eservice/DirectToProductPdf.nx?CZ=Norway&language=no_NO&REFERENCE=', '{FFFFFFFF-5555-5555-5555-FFFFFFFFFFFF}', getutcdate());
                            ",
                    BreakUpToBatches = true
                }
                #endregion

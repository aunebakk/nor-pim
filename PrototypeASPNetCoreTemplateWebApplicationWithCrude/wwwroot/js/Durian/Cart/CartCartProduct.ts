...
// SQL2X Version: 1.0
// http://sql2x.org/
// Generated Date: 3/13/2020 10:54:44 AM
...
module SQL2XTemplateCrudeTableGetCartProduct {
    ...
    // declaration
    declare var getCartProductList: GetCartProductType[];
    ...
    window.onload = () => {
        ...
        var dashboard: GetCartProductTileList = new GetCartProductTileList(contentElement);
        dashboard.start();
    };
    ...
    class GetCartProductTileList {
        ...
        start(): void {
            ...
            // resize canvas to hold all getCartProductList
            this.resizeCanvas(45);
            GetCartProductTileList.clearCanvas("white");
            ...
            GetCartProductTileList.tiles.push(header);

            // remaining getCartProductList
            let lastTile: Tile;

            for (let i: number = 0; i < getCartProductList.length; i++) {
                line++;
                ...
                lastTile =
                    new Tile(
                             getCartProductList [i].firstName
                          + " " + getCartProductList [i].middleName
                          + " " + getCartProductList [i].lastName
                          + " " + getCartProductList [i].productName
                          + " " + getCartProductList [i].imageBlobFilename
                          + " " + getCartProductList [i].dateTime
                        ,40,
                        line,
                        getCartProductList [i].cartProductId,
                        getCartProductList.length,
                        45,
                        15,
                        2,
            ...
            // resize
            const thisThat: GetCartProductTileList = this;
                        ...
                        if (tile.hitTest(event.offsetX, event.offsetY)) {
                            if (tile.url !== "") {
                                ...
                                try {
                                    ...
                                    const dashboard: GetCartProductTileList = new GetCartProductTileList(contentElement);
                                    dashboard.start();
                                } catch (Error) { ; }
                            }
                        }
    ...
    class Tile {
        ...
        constructor(
            ...
            private getCartProduct: GetCartProductType
        ) {
        ...
        drawDurian(): void {
            ...
            canvas.height = window.scrollY + 220 + 15;
            ...
            context.fillText(
                "First Name: " + this.getCartProduct.firstName,
                20,
                window.scrollY + 40
            );
            context.fillStyle = "white";
            context.fillText(
                "Middle Name: " + this.getCartProduct.middleName,
                20,
                window.scrollY + 60
            );
            context.fillStyle = "lightgray";
            context.fillText(
                "Last Name: " + this.getCartProduct.lastName,
                20,
                window.scrollY + 80
            );
            context.fillStyle = "white";
            context.fillText(
                "Product Name: " + this.getCartProduct.productName,
                20,
                window.scrollY + 100
            );
            context.fillStyle = "lightgray";
            context.fillText(
                "Image Blob Filename: " + this.getCartProduct.imageBlobFilename,
                20,
                window.scrollY + 120
            );
            context.fillStyle = "white";
            context.fillText(
                "Financial Currency Type Name: " + this.getCartProduct.financialCurrencyTypeName,
                20,
                window.scrollY + 140
            );
            context.fillStyle = "lightgray";
            context.fillText(
                "Default User Name: " + this.getCartProduct.defaultUserName,
                20,
                window.scrollY + 160
            );
            context.fillStyle = "white";
            context.fillText(
                "Financial Currency Type Code: " + this.getCartProduct.financialCurrencyTypeCode,
                20,
                window.scrollY + 180
            );
            context.fillStyle = "lightgray";
            context.fillText(
                "Date Time: " + this.getCartProduct.dateTime,
                20,
                window.scrollY + 200
            );

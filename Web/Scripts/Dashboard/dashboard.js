    ...
    var Dashboard = /** @class */ (function () {
        ...
        Dashboard.prototype.start = function () {
            ...
            try {
                ...
                true, false));
                Dashboard.tiles.push(new Tile("USER", "Klubok", "Product", 6, 40, 220, sizeFactor, false, "../ProductSearchByCategoryCodeLive/ProductSearchByCategoryCodeIndex?productCategoryCode=010101&onParent=true", // http
                true, false));
                Dashboard.tiles.push(new Tile("USER", "box", "Cart", 6, 260, 0, sizeFactor, false, "../CartProduct/CartProductIndexLive", true, false));

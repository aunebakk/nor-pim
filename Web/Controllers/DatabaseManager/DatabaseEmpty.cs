/*
  ...
  Origin: SQL2XExtensionV3.SQL2XExtensionCreatorNorSolutionQueue.Content_DatabaseEmptyDOTcs
  Documentation:
    Scripts for emptying a database
    Remove Tables, Stored Procedures, Functions, Views and Constraints
*/
using System;

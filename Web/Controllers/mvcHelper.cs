                ...
                if (string.IsNullOrEmpty(UserIdentity.GetUserId())) {
                    ...
                    if (user == null || user.DefaultUserId == Guid.Empty) {
                        ...
                        user = new CrudeDefaultUserContract {
                            DefaultUserId = Guid.Parse(UserIdentity.GetUserId()),
                            DefaultUserCode = UserIdentity.GetUserName().Substring(0, 19),
                            DefaultUserName = UserIdentity.GetUserName(),
                            Password = UserIdentity.GetUserName(),
                            Email = UserIdentity.GetUserName(),
                            DefaultStateRcd = DefaultStateRef.Created,
                            CreatedByDefaultUserId = new Guid("{FFFFFFFF-5555-5555-5555-FFFFFFFFFFFF}"),

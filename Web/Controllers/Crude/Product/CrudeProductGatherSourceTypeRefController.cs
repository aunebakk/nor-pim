/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 10/16/2020 5:54:38 PM
...
namespace SolutionNorSolutionPim.AspMvc.Controllers {
    ...
    public class CrudeProductGatherSourceTypeRefController : Controller {
        ...
        [HttpGet]
        public ActionResult CrudeProductGatherSourceTypeRefDetails(string productGatherSourceTypeRcd) {
        ...
        public ActionResult CrudeProductGatherSourceTypeRefEdit(
            string productGatherSourceTypeRcd
            ) {

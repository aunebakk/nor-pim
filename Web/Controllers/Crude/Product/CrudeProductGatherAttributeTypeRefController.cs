/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 10/16/2020 5:54:35 PM
...
namespace SolutionNorSolutionPim.AspMvc.Controllers {
    ...
    public class CrudeProductGatherAttributeTypeRefController : Controller {
        ...
        [HttpGet]
        public ActionResult CrudeProductGatherAttributeTypeRefDetails(string productGatherAttributeTypeRcd) {
        ...
        public ActionResult CrudeProductGatherAttributeTypeRefEdit(
            string productGatherAttributeTypeRcd
            ) {

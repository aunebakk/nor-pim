/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 1/24/2021 8:45:28 AM
...
namespace SolutionNorSolutionPim.BusinessLogicLayer {
    ...
    public interface ICartSearchServiceClient {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICartSearchServiceChannel : ICartSearchServiceClient, System.ServiceModel.IClientChannel {
    }
    
    public class CartSearchServiceClient : System.ServiceModel.ClientBase<ICartSearchServiceClient>, ICartSearchServiceClient {
        // returns a list of GetCartProductWithFilter contracts from CartSearchService
        // links:
        //  docLink: http://sql2x.org/documentationLink/ca70bf3f-58a1-476b-8441-3946d79cbe03
        ...
        public CartSearchServiceClient() {
        }
        
        public CartSearchServiceClient(string endpointConfigurationName) : 
                base(endpointConfigurationName) {
        }
        
        public CartSearchServiceClient(string endpointConfigurationName, string remoteAddress) : 
                base(endpointConfigurationName, remoteAddress) {
        }
        
        public CartSearchServiceClient(string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(endpointConfigurationName, remoteAddress) {
        }
        
        public CartSearchServiceClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 

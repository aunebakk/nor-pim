...
namespace norpim.DataAccessLayer {
    ...
    public partial class ProductHistory {
        ...
        public void Populate(IDataReader reader, ProductHistoryOrdinals ordinals) {
    ...
    public partial class ProductHistoryOrdinals {
        ...
        public ProductHistoryOrdinals(IDataReader reader) {

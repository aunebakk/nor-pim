...
namespace norpim.DataAccessLayer {
    ...
    [Serializable()]
    public partial class ProductSearchById {
        ...
        public void Populate(IDataReader reader, ProductSearchByIdOrdinals ordinals) {
    ...
    public partial class ProductSearchByIdOrdinals {
        ...
        public ProductSearchByIdOrdinals(IDataReader reader) {

...
namespace norpim.DataAccessLayer {
    ...
    public partial class ProductSearchByName {
        ...
        public void Populate(IDataReader reader, ProductSearchByNameOrdinals ordinals) {
    ...
    public partial class ProductSearchByNameOrdinals {
        ...
        public ProductSearchByNameOrdinals(IDataReader reader) {

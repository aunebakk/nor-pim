...
namespace norpim.DataAccessLayer {
    ...
    public class Category {
        ...
        public Category(Guid productCategoryId) {
            ...
            ProductCategoryImage = crudeImage.FetchByProductCategoryId(productCategoryId);

            // category documentation
            var crudeDocumentation = new CrudeProductCategoryDocumentationData();
            ProductCategoryDocumentation = crudeDocumentation.FetchByProductCategoryId(productCategoryId);
        }
    }

...
namespace norpim.DataAccessLayer {
    ...
    public partial class CrudeProductExposedSelectionData {
        ...
        public List<CrudeProductExposedSelectionData> FetchByProductExposeId(System.Guid productExposeId) {
        ...
        public List<CrudeProductExposedSelectionData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeProductExposedSelectionData>();
        ...
        public List<CrudeProductExposedSelectionData> FetchAll() {
            var dataList = new List<CrudeProductExposedSelectionData>();
        ...
        public List<CrudeProductExposedSelectionData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeProductExposedSelectionData>();
        ...
        public List<CrudeProductExposedSelectionData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeProductExposedSelectionData>();
        ...
        public List<CrudeProductExposedSelectionData> FetchWithFilter(System.Guid productExposedSelectionId, System.Guid productExposeId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeProductExposedSelectionData>();
        ...
        public void Insert() {
            ...
            using (var connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    command.Parameters.Add("@product_exposed_selection_id",SqlDbType.UniqueIdentifier).Value = (ProductExposedSelectionId == Guid.Empty ? (object)DBNull.Value : (System.Guid)ProductExposedSelectionId);
        ...
        public void Delete(System.Guid id) {
            ...
            using (var conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    command.Parameters.Add("@product_exposed_selection_id",SqlDbType.UniqueIdentifier).Value = id;
                    command.ExecuteNonQuery();
                }
            }
        }

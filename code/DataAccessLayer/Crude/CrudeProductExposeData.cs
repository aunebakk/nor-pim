...
namespace norpim.DataAccessLayer {
    ...
    public partial class CrudeProductExposeData {
        ...
        public List<CrudeProductExposeData> FetchByProductExposeSetId(System.Guid productExposeSetId) {
        ...
        public List<CrudeProductExposeData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeProductExposeData>();
        ...
        public List<CrudeProductExposeData> FetchAll() {
            var dataList = new List<CrudeProductExposeData>();
        ...
        public List<CrudeProductExposeData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeProductExposeData>();
        ...
        public List<CrudeProductExposeData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeProductExposeData>();
        ...
        public List<CrudeProductExposeData> FetchWithFilter(System.Guid productExposeId, System.Guid productExposeSetId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeProductExposeData>();
        ...
        public void Insert() {
            ...
            using (var connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    command.Parameters.Add("@product_expose_id",SqlDbType.UniqueIdentifier).Value = (ProductExposeId == Guid.Empty ? (object)DBNull.Value : (System.Guid)ProductExposeId);
                    command.Parameters.Add("@expose_product_id",SqlDbType.UniqueIdentifier).Value = (ExposeProductId == Guid.Empty ? (object)DBNull.Value : (System.Guid)ExposeProductId);
                    command.Parameters.Add("@expose_based_on_product_id",SqlDbType.UniqueIdentifier).Value = (ExposeBasedOnProductId == Guid.Empty ? (object)DBNull.Value : (System.Guid)ExposeBasedOnProductId);
        ...
        public void Delete(System.Guid id) {
            ...
            using (var conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    command.Parameters.Add("@product_expose_id",SqlDbType.UniqueIdentifier).Value = id;
                    command.ExecuteNonQuery();
                }
            }
        }

...
namespace norpim.DataAccessLayer {
    ...
    public partial class CrudeProductGatherData {
        ...
        public List<CrudeProductGatherData> FetchByUserId(System.Guid userId) {
        ...
        public List<CrudeProductGatherData> FetchAll() {
            var dataList = new List<CrudeProductGatherData>();
        ...
        public List<CrudeProductGatherData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeProductGatherData>();
        ...
        public List<CrudeProductGatherData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeProductGatherData>();
        ...
        public List<CrudeProductGatherData> FetchWithFilter(System.Guid productGatherId, System.DateTime startDateTime, System.DateTime finishDateTime, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeProductGatherData>();
        ...
        public void Insert() {
            ...
            using (var connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@start_date_time",SqlDbType.DateTime).Value = (StartDateTime == DateTime.MinValue ? (object)DBNull.Value : (System.DateTime)StartDateTime);
        ...
        public void Delete(System.Guid id) {
            ...
            using (var conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    command.Parameters.Add("@product_gather_id",SqlDbType.UniqueIdentifier).Value = id;
                    command.ExecuteNonQuery();
                }
            }
        }

...
namespace norpim.DataAccessLayer {
    ...
    public partial class CrudeProductGatherSourceTypeRefData {
        ...
        public List<CrudeProductGatherSourceTypeRefData> FetchByUserId(System.Guid userId) {
        ...
        public List<CrudeProductGatherSourceTypeRefData> FetchAll() {
            var dataList = new List<CrudeProductGatherSourceTypeRefData>();
        ...
        public List<CrudeProductGatherSourceTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeProductGatherSourceTypeRefData>();
        ...
        public List<CrudeProductGatherSourceTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeProductGatherSourceTypeRefData>();
        ...
        public List<CrudeProductGatherSourceTypeRefData> FetchWithFilter(string productGatherSourceTypeRcd, string productGatherSourceTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeProductGatherSourceTypeRefData>();
            ...
            using (var conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (productGatherSourceTypeName != "") {
        ...
        public void Insert() {
            ...
            using (var connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_gather_source_type_name",SqlDbType.NVarChar).Value = (ProductGatherSourceTypeName == null ? (object)DBNull.Value : (System.String)ProductGatherSourceTypeName);
        ...
        public void Delete(System.Guid id) {
            ...
            using (var conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    command.Parameters.Add("@product_gather_source_type_rcd",SqlDbType.NVarChar).Value = id;
                    command.ExecuteNonQuery();
                }
            }
        }

    ...
    public partial class CrudeProductCategoryData {
        ...
        public void FetchByProductCategoryId(System.Guid productCategoryId) {
            string sql = @" select top 1 product_category_id, product_category_became_id, product_category_parent_id, product_category_code, product_category_name, product_category_position, state_rcd, user_id, date_time
                            ...
                            order by product_category_position";
        ...
        public List<CrudeProductCategoryData> FetchByUserId(System.Guid userId) {
        ...
        public void FetchByProductCategoryCode(string productCategoryCode) {
            string sql = @" select top 1 product_category_id, product_category_became_id, product_category_parent_id, product_category_code, product_category_name, product_category_position, state_rcd, user_id, date_time
                            from [product_category]
                            where product_category_code like '%' + @productCategoryCode + '%'
                              and product_category_became_id is null";
        ...
        public List<CrudeProductCategoryData> FetchAll() {
            var dataList = new List<CrudeProductCategoryData>();
        ...
        public List<CrudeProductCategoryData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeProductCategoryData>();
        ...
        public List<CrudeProductCategoryData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeProductCategoryData>();
        ...
        public List<CrudeProductCategoryData> FetchWithFilter(System.Guid productCategoryId, string productCategoryCode, string productCategoryName, int productCategoryPosition, string stateRcd, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeProductCategoryData>();
            ...
            using (var conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    sql += " order by product_category_position";
        ...
        public void Insert() {
            ...
            using (var connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_category_parent_id",SqlDbType.UniqueIdentifier).Value = (ProductCategoryParentId == Guid.Empty ? (object)DBNull.Value : (System.Guid)ProductCategoryParentId);
                    command.Parameters.Add("@product_category_code",SqlDbType.NVarChar).Value = (ProductCategoryCode == null ? (object)DBNull.Value : (System.String)ProductCategoryCode);
                    command.Parameters.Add("@product_category_name",SqlDbType.NVarChar).Value = (ProductCategoryName == null ? (object)DBNull.Value : (System.String)ProductCategoryName);
                    command.Parameters.Add("@product_category_position",SqlDbType.Int).Value = (ProductCategoryPosition == 0 ? (object)DBNull.Value : (System.Int32)ProductCategoryPosition);
        ...
        public void Delete(System.Guid id) {
            ...
            using (var conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    command.Parameters.Add("@product_category_id",SqlDbType.UniqueIdentifier).Value = id;
                    command.ExecuteNonQuery();
                }
            }
        }

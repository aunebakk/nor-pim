...
namespace norpim.DataAccessLayer {
    ...
    public partial class CrudeProductDocumentationTypeRefData {
        ...
        public List<CrudeProductDocumentationTypeRefData> FetchByUserId(System.Guid userId) {
        ...
        public List<CrudeProductDocumentationTypeRefData> FetchAll() {
            var dataList = new List<CrudeProductDocumentationTypeRefData>();
        ...
        public List<CrudeProductDocumentationTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeProductDocumentationTypeRefData>();
        ...
        public List<CrudeProductDocumentationTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeProductDocumentationTypeRefData>();
        ...
        public List<CrudeProductDocumentationTypeRefData> FetchWithFilter(string productDocumentationTypeRcd, string productDocumentationTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeProductDocumentationTypeRefData>();
            ...
            using (var conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (productDocumentationTypeName != "") {
        ...
        public void Insert() {
            ...
            using (var connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_documentation_type_name",SqlDbType.NVarChar).Value = (ProductDocumentationTypeName == null ? (object)DBNull.Value : (System.String)ProductDocumentationTypeName);
        ...
        public void Delete(System.Guid id) {
            ...
            using (var conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    command.Parameters.Add("@product_documentation_type_rcd",SqlDbType.NVarChar).Value = id;
                    command.ExecuteNonQuery();
                }
            }
        }

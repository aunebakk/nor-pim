...
namespace norpim.DataAccessLayer {
    ...
    public partial class CrudeProductCategoryImageTypeRefData {
        ...
        public List<CrudeProductCategoryImageTypeRefData> FetchByUserId(System.Guid userId) {
        ...
        public List<CrudeProductCategoryImageTypeRefData> FetchAll() {
            var dataList = new List<CrudeProductCategoryImageTypeRefData>();
        ...
        public List<CrudeProductCategoryImageTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeProductCategoryImageTypeRefData>();
        ...
        public List<CrudeProductCategoryImageTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeProductCategoryImageTypeRefData>();
        ...
        public List<CrudeProductCategoryImageTypeRefData> FetchWithFilter(string productCategoryImageTypeRcd, string productCategoryImageTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeProductCategoryImageTypeRefData>();
            ...
            using (var conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (productCategoryImageTypeName != "") {
        ...
        public void Insert() {
            ...
            using (var connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_category_image_type_name",SqlDbType.NVarChar).Value = (ProductCategoryImageTypeName == null ? (object)DBNull.Value : (System.String)ProductCategoryImageTypeName);
        ...
        public void Delete(System.Guid id) {
            ...
            using (var conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    command.Parameters.Add("@product_category_image_type_rcd",SqlDbType.NVarChar).Value = id;
                    command.ExecuteNonQuery();
                }
            }
        }

...
namespace norpim.DataAccessLayer {
    ...
    public partial class CrudeProductChangeSetData {
        ...
        public List<CrudeProductChangeSetData> FetchByProductId(System.Guid productId) {
        ...
        public List<CrudeProductChangeSetData> FetchByProductGatherKeyId(System.Guid productGatherKeyId) {
            var dataList = new List<CrudeProductChangeSetData>();
        ...
        public List<CrudeProductChangeSetData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeProductChangeSetData>();
        ...
        public List<CrudeProductChangeSetData> FetchAll() {
            var dataList = new List<CrudeProductChangeSetData>();
        ...
        public List<CrudeProductChangeSetData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeProductChangeSetData>();
        ...
        public List<CrudeProductChangeSetData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeProductChangeSetData>();
        ...
        public List<CrudeProductChangeSetData> FetchWithFilter(System.Guid productChangeSetId, System.Guid productId, System.Guid productGatherKeyId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeProductChangeSetData>();
        ...
        public void Insert() {
            ...
            using (var connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    command.Parameters.Add("@product_change_set_id",SqlDbType.UniqueIdentifier).Value = (ProductChangeSetId == Guid.Empty ? (object)DBNull.Value : (System.Guid)ProductChangeSetId);
        ...
        public void Delete(System.Guid id) {
            ...
            using (var conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    command.Parameters.Add("@product_change_set_id",SqlDbType.UniqueIdentifier).Value = id;
                    command.ExecuteNonQuery();
                }
            }
        }

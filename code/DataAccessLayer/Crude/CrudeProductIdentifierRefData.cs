...
namespace norpim.DataAccessLayer {
    ...
    public partial class CrudeProductIdentifierRefData {
        ...
        public List<CrudeProductIdentifierRefData> FetchByUserId(System.Guid userId) {
        ...
        public List<CrudeProductIdentifierRefData> FetchAll() {
            var dataList = new List<CrudeProductIdentifierRefData>();
        ...
        public List<CrudeProductIdentifierRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeProductIdentifierRefData>();
        ...
        public List<CrudeProductIdentifierRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeProductIdentifierRefData>();
        ...
        public List<CrudeProductIdentifierRefData> FetchWithFilter(string productIdentifierRcd, string productIdentifierName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeProductIdentifierRefData>();
        ...
        public void Insert() {
            ...
            using (var connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_identifier_name",SqlDbType.NVarChar).Value = (ProductIdentifierName == null ? (object)DBNull.Value : (System.String)ProductIdentifierName);
        ...
        public void Delete(System.Guid id) {
            ...
            using (var conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    command.Parameters.Add("@product_identifier_rcd",SqlDbType.NVarChar).Value = id;
                    command.ExecuteNonQuery();
                }
            }
        }

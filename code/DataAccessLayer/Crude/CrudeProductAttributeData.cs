...
namespace norpim.DataAccessLayer {
    ...
    public partial class CrudeProductAttributeData {
        ...
        public List<CrudeProductAttributeData> FetchByProductId(System.Guid productId) {
        ...
        public List<CrudeProductAttributeData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeProductAttributeData>();
        ...
        public List<CrudeProductAttributeData> FetchAll() {
            var dataList = new List<CrudeProductAttributeData>();
        ...
        public List<CrudeProductAttributeData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeProductAttributeData>();
        ...
        public List<CrudeProductAttributeData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeProductAttributeData>();
        ...
        public List<CrudeProductAttributeData> FetchWithFilter(System.Guid productAttributeId, System.Guid productId, string productAttributeRcd, string productAttributeUnitRcd, string value, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeProductAttributeData>();
        ...
        public void Insert() {
            ...
            using (var connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    command.Parameters.Add("@product_attribute_id",SqlDbType.UniqueIdentifier).Value = (ProductAttributeId == Guid.Empty ? (object)DBNull.Value : (System.Guid)ProductAttributeId);
                    ...
                    command.Parameters.Add("@value",SqlDbType.NVarChar).Value = (Value == null ? (object)DBNull.Value : (System.String)Value);
        ...
        public void Delete(System.Guid id) {
            ...
            using (var conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    command.Parameters.Add("@product_attribute_id",SqlDbType.UniqueIdentifier).Value = id;
                    command.ExecuteNonQuery();
                }
            }
        }

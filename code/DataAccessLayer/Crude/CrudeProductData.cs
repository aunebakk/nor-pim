...
namespace norpim.DataAccessLayer {
    ...
    public partial class CrudeProductData {
        ...
        public List<CrudeProductData> FetchByUserId(System.Guid userId) {
        ...
        public List<CrudeProductData> FetchAll() {
            var dataList = new List<CrudeProductData>();
        ...
        public List<CrudeProductData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeProductData>();
        ...
        public List<CrudeProductData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeProductData>();
        ...
        public List<CrudeProductData> FetchWithFilter(System.Guid productId, string productName, string stateRcd, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeProductData>();
        ...
        public void Insert() {
            ...
            using (var connection = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@product_name",SqlDbType.NVarChar).Value = (ProductName == null ? (object)DBNull.Value : (System.String)ProductName);
        ...
        public void Delete(System.Guid id) {
            ...
            using (var conn = new SqlConnection(ConfigurationManager.AppSettings["Conn"])) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    command.Parameters.Add("@product_id",SqlDbType.UniqueIdentifier).Value = id;
                    command.ExecuteNonQuery();
                }
            }
        }

...
(function (DashboardInfo) {
    ...
    var ProductTiles = /** @class */ (function () {
        ...
        ProductTiles.prototype.start = function () {
            ...
            var lastTile;
            line++;
            lastTile = new Tile('Architecture', 40, line, 'https://sql2coreredone.azurewebsites.net/api/1/dashboard/DashboardArchitectureFramework', 15, Tile.tileFontSize() + 30, 15, 2, 7);
